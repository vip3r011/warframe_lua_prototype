...
; Command line was: -dis C:\war2\raw\EE\Interface\Components\ScrollBar.lua 
...
; Max Stack Size:  14
 ...
 60 [-]: SETTABLE  R5 K27 R2    ; R5["mHeight"] := R2
 61 [-]: SETTABLE  R5 K28 R3    ; R5["mVisibleProp"] := R3
 62 [-]: SETTABLE  R5 K29 K16   ; R5["mScrollValueChangedCallback"] := nil
 63 [-]: SETTABLE  R5 K30 K16   ; R5["mScrubStartDragCallback"] := nil
 64 [-]: SETTABLE  R5 K31 K16   ; R5["mScrubStopDragCallback"] := nil
 65 [-]: SETTABLE  R5 K32 K33   ; R5["mScrollStep"] := 0.10000000149012
 66 [-]: SETTABLE  R5 K34 K10   ; R5["mHookedUpCallbacks"] := "0x0"
 67 [-]: SETTABLE  R5 K35 K14   ; R5["mCondensedScrub"] := "0x1"
 68 [-]: SETTABLE  R5 K36 R4    ; R5["mHorizontal"] := R4
 69 [-]: SELF      R6 R0 K38    ; R7 := R0; R6 := R0["0x458F27A9"]
 70 [-]: LOADK     R8 K39       ; R8 := "SupportsThemes"
 71 [-]: LOADK     R9 K40       ; R9 := ""
 72 [-]: CALL      R6 4 2       ; R6 := R6(R7,R8,R9)
 73 [-]: SETTABLE  R5 K37 R6    ; R5["mApplyThemes"] := R6
 74 [-]: LOADK     R6 K42       ; R6 := "ScrollBar("
 75 [-]: MOVE      R7 R1        ; R7 := R1
 76 [-]: LOADK     R8 K43       ; R8 := ")::"
 77 [-]: CONCAT    R6 R6 R8     ; R6 := R6 .. R7 .. R8
 78 [-]: SETTABLE  R5 K41 R6    ; R5["mPrefix"] := R6
 79 [-]: CLOSURE   R6 0         ; R6 := closure(Function #1.1)
 80 [-]: SETTABLE  R5 K44 R6    ; R5["GetParentEnv"] := R6
 81 [-]: CLOSURE   R6 1         ; R6 := closure(Function #1.2)
 82 [-]: SETTABLE  R5 K45 R6    ; R5["GetScrollValue"] := R6
 83 [-]: CLOSURE   R6 2         ; R6 := closure(Function #1.3)
 84 [-]: SETTABLE  R5 K46 R6    ; R5["GetTargetScrollValue"] := R6
 85 [-]: CLOSURE   R6 3         ; R6 := closure(Function #1.4)
 86 [-]: SETTABLE  R5 K47 R6    ; R5["SetScrollValue"] := R6
 87 [-]: CLOSURE   R6 4         ; R6 := closure(Function #1.5)
 88 [-]: SETTABLE  R5 K48 R6    ; R5["SetHeight"] := R6
 89 [-]: CLOSURE   R6 5         ; R6 := closure(Function #1.6)
 90 [-]: SETTABLE  R5 K45 R6    ; R5["GetScrollValue"] := R6
 91 [-]: CLOSURE   R6 6         ; R6 := closure(Function #1.7)
 92 [-]: SETTABLE  R5 K49 R6    ; R5["Initialize"] := R6
 93 [-]: CLOSURE   R6 7         ; R6 := closure(Function #1.8)
 94 [-]: SETTABLE  R5 K50 R6    ; R5["UpdateScrollPos"] := R6
 95 [-]: CLOSURE   R6 8         ; R6 := closure(Function #1.9)
 96 [-]: SETTABLE  R5 K51 R6    ; R5["Update"] := R6
 97 [-]: CLOSURE   R6 9         ; R6 := closure(Function #1.10)
 98 [-]: GETUPVAL  R0 U1        ; R0 := U1
 99 [-]: GETUPVAL  R0 U0        ; R0 := U0
100 [-]: SETTABLE  R5 K52 R6    ; R5["GetScrubHeight"] := R6
101 [-]: CLOSURE   R6 10        ; R6 := closure(Function #1.11)
102 [-]: GETUPVAL  R0 U2        ; R0 := U2
103 [-]: SETTABLE  R5 K53 R6    ; R5["UpdateColors"] := R6
104 [-]: CLOSURE   R6 11        ; R6 := closure(Function #1.12)
105 [-]: GETUPVAL  R0 U1        ; R0 := U1
106 [-]: SETTABLE  R5 K54 R6    ; R5["RedrawScrollBar"] := R6
107 [-]: CLOSURE   R6 12        ; R6 := closure(Function #1.13)
108 [-]: SETTABLE  R5 K55 R6    ; R5["GetDragRange"] := R6
109 [-]: CLOSURE   R6 13        ; R6 := closure(Function #1.14)
110 [-]: SETTABLE  R5 K56 R6    ; R5["StartDrag"] := R6
111 [-]: CLOSURE   R6 14        ; R6 := closure(Function #1.15)
112 [-]: SETTABLE  R5 K57 R6    ; R5["StopDrag"] := R6
113 [-]: CLOSURE   R6 15        ; R6 := closure(Function #1.16)
114 [-]: SETTABLE  R5 K58 R6    ; R5["ScrubRollOver"] := R6
115 [-]: CLOSURE   R6 16        ; R6 := closure(Function #1.17)
116 [-]: SETTABLE  R5 K59 R6    ; R5["ScrubRollOut"] := R6
117 [-]: CLOSURE   R6 17        ; R6 := closure(Function #1.18)
118 [-]: SETTABLE  R5 K60 R6    ; R5["ScrollBarRollOver"] := R6
119 [-]: CLOSURE   R6 18        ; R6 := closure(Function #1.19)
120 [-]: SETTABLE  R5 K61 R6    ; R5["ScrollBarRollOut"] := R6
121 [-]: CLOSURE   R6 19        ; R6 := closure(Function #1.20)
122 [-]: GETUPVAL  R0 U1        ; R0 := U1
123 [-]: SETTABLE  R5 K62 R6    ; R5["ClickScrollBar"] := R6
124 [-]: CLOSURE   R6 20        ; R6 := closure(Function #1.21)
125 [-]: SETTABLE  R5 K63 R6    ; R5["SetVisibleProp"] := R6
126 [-]: CLOSURE   R6 21        ; R6 := closure(Function #1.22)
127 [-]: SETTABLE  R5 K64 R6    ; R5["ScrollBy"] := R6
128 [-]: CLOSURE   R6 22        ; R6 := closure(Function #1.23)
129 [-]: SETTABLE  R5 K65 R6    ; R5["ScrollByStep"] := R6
130 [-]: CLOSURE   R6 23        ; R6 := closure(Function #1.24)
131 [-]: SETTABLE  R5 K66 R6    ; R5["ScrollUp"] := R6
132 [-]: CLOSURE   R6 24        ; R6 := closure(Function #1.25)
133 [-]: SETTABLE  R5 K67 R6    ; R5["ScrollDown"] := R6
134 [-]: CLOSURE   R6 25        ; R6 := closure(Function #1.26)
135 [-]: SETTABLE  R5 K68 R6    ; R5["HookUpCallbacks"] := R6
136 [-]: CLOSURE   R6 26        ; R6 := closure(Function #1.27)
137 [-]: SETTABLE  R5 K69 R6    ; R5["SetEnabled"] := R6
138 [-]: CLOSURE   R6 27        ; R6 := closure(Function #1.28)
139 [-]: GETUPVAL  R0 U1        ; R0 := U1
140 [-]: SETTABLE  R5 K70 R6    ; R5["SetActive"] := R6
141 [-]: CLOSURE   R6 28        ; R6 := closure(Function #1.29)
142 [-]: SETTABLE  R5 K71 R6    ; R5["SetVisibleRangeMaterial"] := R6
143 [-]: GETTABLE  R6 R5 K36    ; R6 := R5["mHorizontal"]
144 [-]: TEST      R6 0         ; if not R6 then PC := 157
145 [-]: JMP       157          ; PC := 157
146 [-]: SELF      R6 R0 K72    ; R7 := R0; R6 := R0["0x1C19D966"]
147 [-]: MOVE      R8 R1        ; R8 := R1
148 [-]: LOADK     R9 K73       ; R9 := "_yscale"
149 [-]: GETUPVAL  R10 U1       ; R10 := U1
150 [-]: GETTABLE  R10 R10 K74  ; R10 := R10["0xF81722A2"]
151 [-]: GETTABLE  R11 R5 K37   ; R11 := R5["mApplyThemes"]
152 [-]: LOADK     R12 K75      ; R12 := 75
153 [-]: LOADK     R13 K76      ; R13 := 100
154 [-]: CALL      R10 4 0      ; R10,... := R10(R11,R12,R13)
155 [-]: CALL      R6 0 1       ; R6(R7,...)
156 [-]: JMP       167          ; PC := 167
157 [-]: SELF      R6 R0 K72    ; R7 := R0; R6 := R0["0x1C19D966"]
158 [-]: MOVE      R8 R1        ; R8 := R1
159 [-]: LOADK     R9 K77       ; R9 := "_xscale"
160 [-]: GETUPVAL  R10 U1       ; R10 := U1
161 [-]: GETTABLE  R10 R10 K74  ; R10 := R10["0xF81722A2"]
162 [-]: GETTABLE  R11 R5 K37   ; R11 := R5["mApplyThemes"]
163 [-]: LOADK     R12 K75      ; R12 := 75
164 [-]: LOADK     R13 K76      ; R13 := 100
165 [-]: CALL      R10 4 0      ; R10,... := R10(R11,R12,R13)
166 [-]: CALL      R6 0 1       ; R6(R7,...)
