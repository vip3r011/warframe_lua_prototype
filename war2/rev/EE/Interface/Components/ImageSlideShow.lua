...
; Command line was: -dis C:\war2\raw\EE\Interface\Components\ImageSlideShow.lua 
...
; Max Stack Size:  9
  ...
  4 [-]: EQ        0 R3 K2      ; if R3 ~= nil then PC := 54
  5 [-]: JMP       54           ; PC := 54
 ...
 27 [-]: EQ        0 R3 R4      ; if R3 ~= R4 then PC := 45
 28 [-]: JMP       45           ; PC := 45
 29 [-]: NEWTABLE  R3 1 0       ; R3 := {}
 30 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 31 [-]: SELF      R4 R4 K7     ; R5 := R4; R4 := R4["0xF3E132E0"]
 32 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 33 [-]: GETTABLE  R5 R0 K3     ; R5 := R0["mMovie"]
 34 [-]: SELF      R5 R5 K8     ; R6 := R5; R5 := R5["0x68998E7D"]
 35 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 36 [-]: SETLIST   R3 0 1       ; R3[(1-1)*FPF+i] := R(3+i), 1 <= i <= 0
 37 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 38 [-]: SELF      R4 R4 K10    ; R5 := R4; R4 := R4["0x931A1C95"]
 39 [-]: MOVE      R6 R3        ; R6 := R3
 40 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
 41 [-]: MOVE      R3 R4        ; R3 := R4
 42 [-]: GETTABLE  R1 R3 K11    ; R1 := R3[1]
 43 [-]: GETTABLE  R2 R3 K12    ; R2 := R3[2]
 44 [-]: JMP       70           ; PC := 70
 45 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 46 [-]: SELF      R4 R4 K13    ; R5 := R4; R4 := R4["0xF595D5E1"]
 47 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 48 [-]: MOVE      R1 R4        ; R1 := R4
 49 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 50 [-]: SELF      R4 R4 K14    ; R5 := R4; R4 := R4["0xEE069D65"]
 51 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 52 [-]: MOVE      R2 R4        ; R2 := R4
 53 [-]: JMP       70           ; PC := 70
 54 [-]: GETGLOBAL R4 K15       ; R4 := 0xF595ADDE
 55 [-]: GETTABLE  R5 R0 K3     ; R5 := R0["mMovie"]
 56 [-]: SELF      R5 R5 K16    ; R6 := R5; R5 := R5["0x6B7B470B"]
 57 [-]: GETTABLE  R7 R0 K1     ; R7 := R0["mStageClipName"]
 58 [-]: LOADK     R8 K17       ; R8 := "_width"
 59 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 60 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 61 [-]: MOVE      R1 R4        ; R1 := R4
 62 [-]: GETGLOBAL R4 K15       ; R4 := 0xF595ADDE
 63 [-]: GETTABLE  R5 R0 K3     ; R5 := R0["mMovie"]
 64 [-]: SELF      R5 R5 K16    ; R6 := R5; R5 := R5["0x6B7B470B"]
 65 [-]: GETTABLE  R7 R0 K1     ; R7 := R0["mStageClipName"]
 66 [-]: LOADK     R8 K18       ; R8 := "_height"
 67 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 68 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 69 [-]: MOVE      R2 R4        ; R2 := R4
 70 [-]: MOVE      R4 R1        ; R4 := R1
 71 [-]: MOVE      R5 R2        ; R5 := R2
 72 [-]: RETURN    R4 3         ; return R4,R5
...
; Max Stack Size:  14
 ...
 14 [-]: EQ        0 R5 R6      ; if R5 ~= R6 then PC := 26
 15 [-]: JMP       26           ; PC := 26
 16 [-]: NEWTABLE  R6 2 0       ; R6 := {}
 17 [-]: LOADK     R7 K3        ; R7 := 0
 18 [-]: MOVE      R8 R1        ; R8 := R1
 19 [-]: SETLIST   R6 2 1       ; R6[(1-1)*FPF+i] := R(6+i), 1 <= i <= 2
 20 [-]: GETTABLE  R7 R0 K0     ; R7 := R0["mMovie"]
 21 [-]: SELF      R7 R7 K7     ; R8 := R7; R7 := R7["0x931A1C95"]
 22 [-]: MOVE      R9 R6        ; R9 := R6
 23 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 24 [-]: MOVE      R6 R7        ; R6 := R7
 25 [-]: GETTABLE  R1 R6 K8     ; R1 := R6[2]
 26 [-]: GETGLOBAL R7 K5        ; R7 := UISys
 27 [-]: GETTABLE  R7 R7 K9     ; R7 := R7["VB_ScaleToViewport"]
 28 [-]: EQ        1 R5 R7      ; if R5 == R7 then PC := 32
 29 [-]: JMP       32           ; PC := 32
 30 [-]: LT        1 R1 R2      ; if R1 < R2 then PC := 36
 31 [-]: JMP       36           ; PC := 36
 32 [-]: GETGLOBAL R7 K5        ; R7 := UISys
 33 [-]: GETTABLE  R7 R7 K6     ; R7 := R7["VB_ProportionalScale"]
 34 [-]: EQ        0 R5 R7      ; if R5 ~= R7 then PC := 85
 35 [-]: JMP       85           ; PC := 85
 36 [-]: GETTABLE  R7 R0 K0     ; R7 := R0["mMovie"]
 37 [-]: SELF      R7 R7 K10    ; R8 := R7; R7 := R7["0x784AF8F1"]
 38 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 39 [-]: SUB       R8 R2 R1     ; R8 := R2 - R1
 40 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 41 [-]: GETTABLE  R9 R9 K12    ; R9 := R9["VAP_TOP_LEFT"]
 42 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 52
 43 [-]: JMP       52           ; PC := 52
 44 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 45 [-]: GETTABLE  R9 R9 K13    ; R9 := R9["VAP_TOP"]
 46 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 52
 47 [-]: JMP       52           ; PC := 52
 48 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 49 [-]: GETTABLE  R9 R9 K14    ; R9 := R9["VAP_TOP_RIGHT"]
 50 [-]: EQ        0 R7 R9      ; if R7 ~= R9 then PC := 55
 51 [-]: JMP       55           ; PC := 55
 52 [-]: MUL       R3 R8 K15    ; R3 := R8 * 0.5
 53 [-]: MOVE      R4 R8        ; R4 := R8
 54 [-]: JMP       85           ; PC := 85
 55 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 56 [-]: GETTABLE  R9 R9 K16    ; R9 := R9["VAP_LEFT"]
 57 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 67
 58 [-]: JMP       67           ; PC := 67
 59 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 60 [-]: GETTABLE  R9 R9 K17    ; R9 := R9["VAP_CENTER"]
 61 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 67
 62 [-]: JMP       67           ; PC := 67
 63 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 64 [-]: GETTABLE  R9 R9 K18    ; R9 := R9["VAP_RIGHT"]
 65 [-]: EQ        0 R7 R9      ; if R7 ~= R9 then PC := 70
 66 [-]: JMP       70           ; PC := 70
 67 [-]: LOADK     R3 K3        ; R3 := 0
 68 [-]: MUL       R4 R8 K15    ; R4 := R8 * 0.5
 69 [-]: JMP       85           ; PC := 85
 70 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 71 [-]: GETTABLE  R9 R9 K19    ; R9 := R9["VAP_BOTTOM_LEFT"]
 72 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 82
 73 [-]: JMP       82           ; PC := 82
 74 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 75 [-]: GETTABLE  R9 R9 K20    ; R9 := R9["VAP_BOTTOM"]
 76 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 82
 77 [-]: JMP       82           ; PC := 82
 78 [-]: GETGLOBAL R9 K11       ; R9 := Engine
 79 [-]: GETTABLE  R9 R9 K21    ; R9 := R9["VAP_BOTTOM_RIGHT"]
 80 [-]: EQ        0 R7 R9      ; if R7 ~= R9 then PC := 85
 81 [-]: JMP       85           ; PC := 85
 82 [-]: UNM       R9 R8        ; R9 := - R8
 83 [-]: MUL       R3 R9 K15    ; R3 := R9 * 0.5
 84 [-]: LOADK     R4 K3        ; R4 := 0
 85 [-]: GETTABLE  R9 R0 K0     ; R9 := R0["mMovie"]
 86 [-]: SELF      R9 R9 K22    ; R10 := R9; R9 := R9["0x1C19D966"]
 87 [-]: GETTABLE  R11 R0 K23   ; R11 := R0["mClipName"]
 88 [-]: LOADK     R12 K24      ; R12 := "_y"
 89 [-]: GETTABLE  R13 R0 K25   ; R13 := R0["mInitialY"]
 90 [-]: ADD       R13 R13 R3   ; R13 := R13 + R3
 91 [-]: CALL      R9 5 1       ; R9(R10,R11,R12,R13)
 92 [-]: GETTABLE  R9 R0 K0     ; R9 := R0["mMovie"]
 93 [-]: SELF      R9 R9 K22    ; R10 := R9; R9 := R9["0x1C19D966"]
 94 [-]: GETTABLE  R11 R0 K26   ; R11 := R0["mSecondClipName"]
 95 [-]: LOADK     R12 K24      ; R12 := "_y"
 96 [-]: GETTABLE  R13 R0 K25   ; R13 := R0["mInitialY"]
 97 [-]: ADD       R13 R13 R3   ; R13 := R13 + R3
 98 [-]: CALL      R9 5 1       ; R9(R10,R11,R12,R13)
 99 [-]: GETTABLE  R9 R0 K0     ; R9 := R0["mMovie"]
100 [-]: SELF      R9 R9 K22    ; R10 := R9; R9 := R9["0x1C19D966"]
101 [-]: GETTABLE  R11 R0 K27   ; R11 := R0["mControlsClipName"]
102 [-]: LOADK     R12 K24      ; R12 := "_y"
103 [-]: GETTABLE  R13 R0 K28   ; R13 := R0["mInitialControlsY"]
104 [-]: ADD       R13 R13 R4   ; R13 := R13 + R4
