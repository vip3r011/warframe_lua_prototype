...
; Command line was: -dis C:\war2\raw\EE\Interface\Components\List.lua 
...
; Max Stack Size:  9
 ...
 38 [-]: SETTABLE  R3 K34 K35   ; R3["mInitialDepth"] := 1000
 39 [-]: SETTABLE  R3 K36 K37   ; R3["mDepthDirection"] := -1
 40 [-]: SETTABLE  R3 K38 K39   ; R3["mElementTransitionTime"] := 0.20000000298023
 41 [-]: SETTABLE  R3 K40 K2    ; R3["mElementDelayTime"] := 0
 42 [-]: SETTABLE  R3 K41 K7    ; R3["mWrapAroundNavigation"] := "0x1"
 43 [-]: GETGLOBAL R4 K43       ; R4 := 0xF595ADDE
 44 [-]: SELF      R5 R0 K44    ; R6 := R0; R5 := R0["0x6B7B470B"]
 45 [-]: MOVE      R7 R1        ; R7 := R1
 46 [-]: LOADK     R8 K45       ; R8 := "_x"
 47 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 48 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 49 [-]: SETTABLE  R3 K42 R4    ; R3["mInitialX"] := R4
 50 [-]: GETGLOBAL R4 K43       ; R4 := 0xF595ADDE
 51 [-]: SELF      R5 R0 K44    ; R6 := R0; R5 := R0["0x6B7B470B"]
 52 [-]: MOVE      R7 R1        ; R7 := R1
 53 [-]: LOADK     R8 K47       ; R8 := "_y"
 54 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 55 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 56 [-]: SETTABLE  R3 K46 R4    ; R3["mInitialY"] := R4
 57 [-]: SETTABLE  R3 K48 R2    ; R3["mVisibleElements"] := R2
 58 [-]: SETTABLE  R3 K49 K10   ; R3["mScroll"] := nil
 59 [-]: SETTABLE  R3 K50 K10   ; R3["mScrollBarClipName"] := nil
 60 [-]: SETTABLE  R3 K51 K10   ; R3["mRedrawFromScrollBar"] := nil
 61 [-]: SETTABLE  R3 K52 K31   ; R3["mSmoothScroll"] := "0x0"
 62 [-]: SETTABLE  R3 K53 K31   ; R3["mScrollAlwaysVisible"] := "0x0"
 63 [-]: GETGLOBAL R4 K43       ; R4 := 0xF595ADDE
 64 [-]: SELF      R5 R0 K44    ; R6 := R0; R5 := R0["0x6B7B470B"]
 65 [-]: MOVE      R7 R1        ; R7 := R1
 66 [-]: LOADK     R8 K55       ; R8 := ".Btn"
 67 [-]: CONCAT    R7 R7 R8     ; R7 := R7 .. R8
 68 [-]: LOADK     R8 K56       ; R8 := "_height"
 69 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 70 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 71 [-]: SETTABLE  R3 K54 R4    ; R3["mOriginalButtonHeight"] := R4
 72 [-]: LOADK     R4 K58       ; R4 := "List("
 73 [-]: MOVE      R5 R1        ; R5 := R1
 74 [-]: LOADK     R6 K59       ; R6 := ")::"
 75 [-]: CONCAT    R4 R4 R6     ; R4 := R4 .. R5 .. R6
 76 [-]: SETTABLE  R3 K57 R4    ; R3["mPrefix"] := R4
 77 [-]: GETGLOBAL R4 K61       ; R4 := UISys
 78 [-]: GETTABLE  R4 R4 K62    ; R4 := R4["FlashInstance_EASE_IN_OUT_BACK"]
 79 [-]: SETTABLE  R3 K60 R4    ; R3["mEasing"] := R4
 80 [-]: SETTABLE  R3 K63 K2    ; R3["mLowerBoundBuffer"] := 0
 81 [-]: SETTABLE  R3 K64 K2    ; R3["mUpperBoundBuffer"] := 0
 82 [-]: SETTABLE  R3 K65 K31   ; R3["mIgnoreFiller"] := "0x0"
 83 [-]: NEWTABLE  R4 0 0       ; R4 := {}
 84 [-]: SETTABLE  R3 K66 R4    ; R3["mClickDrag"] := R4
 85 [-]: SETTABLE  R3 K67 K68   ; R3["UP"] := 1
 86 [-]: SETTABLE  R3 K69 K70   ; R3["RIGHT"] := 2
 87 [-]: SETTABLE  R3 K71 K72   ; R3["DOWN"] := 3
 88 [-]: SETTABLE  R3 K73 K74   ; R3["LEFT"] := 4
 89 [-]: SELF      R4 R0 K0     ; R5 := R0; R4 := R0["0x1C19D966"]
 90 [-]: MOVE      R6 R1        ; R6 := R1
 91 [-]: LOADK     R7 K75       ; R7 := "enabled"
 92 [-]: MOVE      R8 R0        ; R8 := R0
 93 [-]: CALL      R4 5 2       ; R4 := R4(R5,R6,R7,R8)
 94 [-]: CLOSURE   R5 0         ; R5 := closure(Function #1.1)
 95 [-]: SETTABLE  R3 K76 R5    ; R3["Print"] := R5
 96 [-]: CLOSURE   R5 1         ; R5 := closure(Function #1.2)
 97 [-]: SETTABLE  R3 K77 R5    ; R3["GetHowManyElements"] := R5
 98 [-]: CLOSURE   R5 2         ; R5 := closure(Function #1.3)
 99 [-]: SETTABLE  R3 K78 R5    ; R3["GetHowManyVisibleElements"] := R5
100 [-]: CLOSURE   R5 3         ; R5 := closure(Function #1.4)
101 [-]: SETTABLE  R3 K79 R5    ; R3["GetFocusedElement"] := R5
102 [-]: CLOSURE   R5 4         ; R5 := closure(Function #1.5)
103 [-]: SETTABLE  R3 K80 R5    ; R3["GetFocusedElementIndex"] := R5
104 [-]: CLOSURE   R5 5         ; R5 := closure(Function #1.6)
105 [-]: SETTABLE  R3 K81 R5    ; R3["GetElementInIndex"] := R5
106 [-]: CLOSURE   R5 6         ; R5 := closure(Function #1.7)
107 [-]: SETTABLE  R3 K82 R5    ; R3["GetElementIndexById"] := R5
108 [-]: CLOSURE   R5 7         ; R5 := closure(Function #1.8)
109 [-]: SETTABLE  R3 K83 R5    ; R3["UpdateElementInIndex"] := R5
110 [-]: CLOSURE   R5 8         ; R5 := closure(Function #1.9)
111 [-]: SETTABLE  R3 K84 R5    ; R3["UpdateElementById"] := R5
112 [-]: CLOSURE   R5 9         ; R5 := closure(Function #1.10)
113 [-]: SETTABLE  R3 K85 R5    ; R3["GetElementById"] := R5
114 [-]: CLOSURE   R5 10        ; R5 := closure(Function #1.11)
115 [-]: SETTABLE  R3 K86 R5    ; R3["GetClipName"] := R5
116 [-]: CLOSURE   R5 11        ; R5 := closure(Function #1.12)
117 [-]: SETTABLE  R3 K87 R5    ; R3["GetScroll"] := R5
118 [-]: CLOSURE   R5 12        ; R5 := closure(Function #1.13)
119 [-]: SETTABLE  R3 K88 R5    ; R3["CalculateX"] := R5
120 [-]: CLOSURE   R5 13        ; R5 := closure(Function #1.14)
121 [-]: SETTABLE  R3 K89 R5    ; R3["CalculateY"] := R5
122 [-]: CLOSURE   R5 14        ; R5 := closure(Function #1.15)
123 [-]: SETTABLE  R3 K90 R5    ; R3["SetCallbacks"] := R5
124 [-]: CLOSURE   R5 15        ; R5 := closure(Function #1.16)
125 [-]: SETTABLE  R3 K91 R5    ; R3["InsertElement"] := R5
126 [-]: CLOSURE   R5 16        ; R5 := closure(Function #1.17)
127 [-]: SETTABLE  R3 K92 R5    ; R3["AddElement"] := R5
128 [-]: CLOSURE   R5 17        ; R5 := closure(Function #1.18)
129 [-]: SETTABLE  R3 K93 R5    ; R3["RemoveElement"] := R5
130 [-]: CLOSURE   R5 18        ; R5 := closure(Function #1.19)
131 [-]: SETTABLE  R3 K94 R5    ; R3["RemoveElementById"] := R5
132 [-]: CLOSURE   R5 19        ; R5 := closure(Function #1.20)
133 [-]: SETTABLE  R3 K95 R5    ; R3["RemoveElements"] := R5
134 [-]: CLOSURE   R5 20        ; R5 := closure(Function #1.21)
135 [-]: SETTABLE  R3 K96 R5    ; R3["Remove"] := R5
136 [-]: CLOSURE   R5 21        ; R5 := closure(Function #1.22)
137 [-]: SETTABLE  R3 K97 R5    ; R3["OnUnfocused"] := R5
138 [-]: CLOSURE   R5 22        ; R5 := closure(Function #1.23)
139 [-]: SETTABLE  R3 K98 R5    ; R3["UnfocusElement"] := R5
140 [-]: CLOSURE   R5 23        ; R5 := closure(Function #1.24)
141 [-]: SETTABLE  R3 K99 R5    ; R3["UnfocusElementById"] := R5
142 [-]: CLOSURE   R5 24        ; R5 := closure(Function #1.25)
143 [-]: SETTABLE  R3 K100 R5   ; R3["OnFocused"] := R5
144 [-]: CLOSURE   R5 25        ; R5 := closure(Function #1.26)
145 [-]: SETTABLE  R3 K101 R5   ; R3["FocusElement"] := R5
146 [-]: CLOSURE   R5 26        ; R5 := closure(Function #1.27)
147 [-]: SETTABLE  R3 K102 R5   ; R3["FocusElementById"] := R5
148 [-]: CLOSURE   R5 27        ; R5 := closure(Function #1.28)
149 [-]: SETTABLE  R3 K103 R5   ; R3["GetIndexInDirection"] := R5
150 [-]: CLOSURE   R5 28        ; R5 := closure(Function #1.29)
151 [-]: SETTABLE  R3 K104 R5   ; R3["ToggleFocusedElement"] := R5
152 [-]: CLOSURE   R5 29        ; R5 := closure(Function #1.30)
153 [-]: SETTABLE  R3 K105 R5   ; R3["FocusNextElement"] := R5
154 [-]: CLOSURE   R5 30        ; R5 := closure(Function #1.31)
155 [-]: SETTABLE  R3 K106 R5   ; R3["FocusPreviousElement"] := R5
156 [-]: CLOSURE   R5 31        ; R5 := closure(Function #1.32)
157 [-]: SETTABLE  R3 K107 R5   ; R3["PressedElement"] := R5
158 [-]: CLOSURE   R5 32        ; R5 := closure(Function #1.33)
159 [-]: SETTABLE  R3 K108 R5   ; R3["PressedElementById"] := R5
160 [-]: CLOSURE   R5 33        ; R5 := closure(Function #1.34)
161 [-]: SETTABLE  R3 K109 R5   ; R3["PressCurrentElement"] := R5
162 [-]: CLOSURE   R5 34        ; R5 := closure(Function #1.35)
163 [-]: SETTABLE  R3 K110 R5   ; R3["OnSelected"] := R5
164 [-]: CLOSURE   R5 35        ; R5 := closure(Function #1.36)
165 [-]: SETTABLE  R3 K111 R5   ; R3["SelectElement"] := R5
166 [-]: CLOSURE   R5 36        ; R5 := closure(Function #1.37)
167 [-]: SETTABLE  R3 K112 R5   ; R3["SelectElementById"] := R5
168 [-]: CLOSURE   R5 37        ; R5 := closure(Function #1.38)
169 [-]: SETTABLE  R3 K113 R5   ; R3["SelectCurrentElement"] := R5
170 [-]: CLOSURE   R5 38        ; R5 := closure(Function #1.39)
171 [-]: SETTABLE  R3 K114 R5   ; R3["SelectElementInDirection"] := R5
172 [-]: CLOSURE   R5 39        ; R5 := closure(Function #1.40)
173 [-]: SETTABLE  R3 K115 R5   ; R3["RepositionButton"] := R5
174 [-]: CLOSURE   R5 40        ; R5 := closure(Function #1.41)
175 [-]: SETTABLE  R3 K116 R5   ; R3["OnDraw"] := R5
176 [-]: CLOSURE   R5 41        ; R5 := closure(Function #1.42)
177 [-]: SETTABLE  R3 K117 R5   ; R3["OnElementTransitionStarted"] := R5
178 [-]: CLOSURE   R5 42        ; R5 := closure(Function #1.43)
179 [-]: SETTABLE  R3 K118 R5   ; R3["OnElementTransitionEnded"] := R5
180 [-]: CLOSURE   R5 43        ; R5 := closure(Function #1.44)
181 [-]: SETTABLE  R3 K119 R5   ; R3["SetupPreInterpolationValues"] := R5
182 [-]: CLOSURE   R5 44        ; R5 := closure(Function #1.45)
183 [-]: SETTABLE  R3 K120 R5   ; R3["GetInterpolationProperties"] := R5
184 [-]: CLOSURE   R5 45        ; R5 := closure(Function #1.46)
185 [-]: SETTABLE  R3 K121 R5   ; R3["GetBounds"] := R5
186 [-]: CLOSURE   R5 46        ; R5 := closure(Function #1.47)
187 [-]: SETTABLE  R3 K122 R5   ; R3["OnFirstRedraw"] := R5
188 [-]: CLOSURE   R5 47        ; R5 := closure(Function #1.48)
189 [-]: SETTABLE  R3 K123 R5   ; R3["Redraw"] := R5
190 [-]: CLOSURE   R5 48        ; R5 := closure(Function #1.49)
191 [-]: SETTABLE  R3 K124 R5   ; R3["SetScroll"] := R5
192 [-]: CLOSURE   R5 49        ; R5 := closure(Function #1.50)
193 [-]: SETTABLE  R3 K125 R5   ; R3["RunForAllElements"] := R5
194 [-]: CLOSURE   R5 50        ; R5 := closure(Function #1.51)
195 [-]: SETTABLE  R3 K126 R5   ; R3["RunForAllVisibleElements"] := R5
196 [-]: CLOSURE   R5 51        ; R5 := closure(Function #1.52)
197 [-]: SETTABLE  R3 K127 R5   ; R3["CalculateScrollBarHeight"] := R5
198 [-]: CLOSURE   R5 52        ; R5 := closure(Function #1.53)
199 [-]: SETTABLE  R3 K128 R5   ; R3["ScrollValueChangedCallback"] := R5
200 [-]: CLOSURE   R5 53        ; R5 := closure(Function #1.54)
201 [-]: SETTABLE  R3 K129 R5   ; R3["CanUseScrollBar"] := R5
202 [-]: CLOSURE   R5 54        ; R5 := closure(Function #1.55)
203 [-]: SETTABLE  R3 K130 R5   ; R3["AttachScrollBar"] := R5
204 [-]: CLOSURE   R5 55        ; R5 := closure(Function #1.56)
205 [-]: SETTABLE  R3 K131 R5   ; R3["RedrawScrollBar"] := R5
206 [-]: CLOSURE   R5 56        ; R5 := closure(Function #1.57)
207 [-]: SETTABLE  R3 K132 R5   ; R3["EnableSmoothScroll"] := R5
208 [-]: CLOSURE   R5 57        ; R5 := closure(Function #1.58)
209 [-]: SETTABLE  R3 K133 R5   ; R3["StopDragging"] := R5
210 [-]: CLOSURE   R5 58        ; R5 := closure(Function #1.59)
211 [-]: SETTABLE  R3 K134 R5   ; R3["EnableDrag"] := R5
212 [-]: CLOSURE   R5 59        ; R5 := closure(Function #1.60)
213 [-]: SETTABLE  R3 K135 R5   ; R3["CreateDragClip"] := R5
214 [-]: CLOSURE   R5 60        ; R5 := closure(Function #1.61)
215 [-]: SETTABLE  R3 K136 R5   ; R3["Update"] := R5
