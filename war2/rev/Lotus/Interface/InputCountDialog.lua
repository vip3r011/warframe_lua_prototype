...
; Command line was: -dis C:\war2\raw\Lotus\Interface\InputCountDialog.lua 
...
280 [-]: EQ        1 R9 K29     ; if R9 == nil then PC := 298
281 [-]: JMP       298          ; PC := 298
...
287 [-]: NEWTABLE  R12 0 1      ; R12 := {}
288 [-]: SETTABLE  R12 K89 K21  ; R12["GetVisibilityMaterial"] := "0x1"
289 [-]: LOADNIL   R13 R14      ; R13 := R14 := nil
290 [-]: MOVE      R15 R1       ; R15 := R1
291 [-]: CALL      R9 7 2       ; R9 := R9(R10,R11,R12,R13,R14,R15)
292 [-]: EQ        1 R9 K29     ; if R9 == nil then PC := 298
293 [-]: JMP       298          ; PC := 298
294 [-]: SELF      R10 R6 K90   ; R11 := R6; R10 := R6["0xA77DA8EE"]
295 [-]: MOVE      R12 R9       ; R12 := R9
296 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
297 [-]: MOVE      R7 R10       ; R7 := R10
298 [-]: EQ        1 R7 K29     ; if R7 == nil then PC := 315
299 [-]: JMP       315          ; PC := 315
300 [-]: GETUPVAL  R10 U2       ; R10 := U2
301 [-]: GETTABLE  R10 R10 K91  ; R10 := R10["0x3B9C2B24"]
302 [-]: GETGLOBAL R11 K6       ; R11 := mMovie
303 [-]: MOVE      R12 R6       ; R12 := R6
304 [-]: LOADK     R13 K64      ; R13 := "Popup.Content.Grid.Item"
305 [-]: CALL      R10 4 1      ; R10(R11,R12,R13)
306 [-]: GETUPVAL  R10 U2       ; R10 := U2
307 [-]: GETTABLE  R10 R10 K92  ; R10 := R10["0x59A3B972"]
308 [-]: GETGLOBAL R11 K6       ; R11 := mMovie
309 [-]: MOVE      R12 R6       ; R12 := R6
310 [-]: MOVE      R13 R7       ; R13 := R7
311 [-]: NEWTABLE  R14 0 2      ; R14 := {}
312 [-]: SETTABLE  R14 K93 K21  ; R14["DisableSaturation"] := "0x1"
313 [-]: SETTABLE  R14 K94 R0   ; R14["IsFocused"] := R0
314 [-]: CALL      R10 5 1      ; R10(R11,R12,R13,R14)
315 [-]: TEST      R0 0         ; if not R0 then PC := 320
316 [-]: JMP       320          ; PC := 320
317 [-]: LOADK     R10 K16      ; R10 := 100
318 [-]: TEST      R10 1        ; if R10 then PC := 321
319 [-]: JMP       321          ; PC := 321
320 [-]: LOADK     R10 K12      ; R10 := 0
321 [-]: MOVE      R10 R12      ; R10 := R12
322 [-]: GETUPVAL  R10 U13      ; R10 := U13
323 [-]: CALL      R10 1 1      ; R10()
