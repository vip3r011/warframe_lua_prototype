...
; Command line was: -dis C:\war2\raw\Lotus\Interface\DiegeticArtifactCards.lua 
...
; Max Stack Size:  12
  ...
  8 [-]: GETTABLE  R4 R0 K6     ; R4 := R0["statValue"]
  9 [-]: SETTABLE  R3 K5 R4     ; R3["StatValue"] := R4
 10 [-]: SETTABLE  R2 K4 R3     ; R2["Previous"] := R3
 11 [-]: NEWTABLE  R3 0 1       ; R3 := {}
 12 [-]: GETTABLE  R4 R0 K6     ; R4 := R0["statValue"]
 13 [-]: SETTABLE  R3 K5 R4     ; R3["StatValue"] := R4
 14 [-]: SETTABLE  R2 K7 R3     ; R2["Current"] := R3
 15 [-]: GETGLOBAL R3 K8        ; R3 := 0x9FAED6BC
 16 [-]: GETUPVAL  R4 U0        ; R4 := U0
 17 [-]: GETTABLE  R4 R4 K9     ; R4 := R4["0xF81722A2"]
 18 [-]: GETTABLE  R5 R0 K10    ; R5 := R0["displayAbsValue"]
 19 [-]: EQ        1 R5 K11     ; if R5 == nil then PC := 24
 20 [-]: JMP       24           ; PC := 24
 21 [-]: GETTABLE  R5 R0 K10    ; R5 := R0["displayAbsValue"]
 22 [-]: EQ        1 R5 K12     ; if R5 == "0x1" then PC := 25
 23 [-]: JMP       25           ; PC := 25
 24 [-]: MOVE      R5 R0        ; R5 := R0
 25 [-]: MOVE      R5 R1        ; R5 := R1
 26 [-]: GETGLOBAL R6 K13       ; R6 := math
 27 [-]: GETTABLE  R6 R6 K14    ; R6 := R6["0xF93F7CC8"]
 28 [-]: GETTABLE  R7 R0 K6     ; R7 := R0["statValue"]
 29 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 30 [-]: GETTABLE  R7 R0 K6     ; R7 := R0["statValue"]
 31 [-]: CALL      R4 4 0       ; R4,... := R4(R5,R6,R7)
 32 [-]: CALL      R3 0 2       ; R3 := R3(R4,...)
 33 [-]: LOADK     R4 K15       ; R4 := 2
 34 [-]: CLOSURE   R5 0         ; R5 := closure(Function #14.1)
 35 [-]: GETUPVAL  R0 U0        ; R0 := U0
 36 [-]: GETTABLE  R6 R0 K16    ; R6 := R0["reverseValueSymbol"]
 37 [-]: EQ        1 R6 K11     ; if R6 == nil then PC := 43
 38 [-]: JMP       43           ; PC := 43
 39 [-]: MOVE      R6 R5        ; R6 := R5
 40 [-]: MOVE      R7 R0        ; R7 := R0
 41 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 42 [-]: MOVE      R3 R6        ; R3 := R6
 43 [-]: SELF      R6 R3 K17    ; R7 := R3; R6 := R3["0xDE44F664"]
 44 [-]: LOADK     R8 K18       ; R8 := "%."
 45 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 46 [-]: TEST      R6 0         ; if not R6 then PC := 56
 47 [-]: JMP       56           ; PC := 56
 48 [-]: LEN       R7 R3        ; R7 := # R3
 49 [-]: LT        0 R6 R7      ; if R6 >= R7 then PC := 56
 50 [-]: JMP       56           ; PC := 56
 51 [-]: SELF      R7 R3 K19    ; R8 := R3; R7 := R3["0x7B782033"]
 52 [-]: LOADK     R9 K20       ; R9 := 0
 53 [-]: ADD       R10 R6 R4    ; R10 := R6 + R4
 54 [-]: CALL      R7 4 2       ; R7 := R7(R8,R9,R10)
 55 [-]: MOVE      R3 R7        ; R3 := R7
 56 [-]: GETTABLE  R7 R0 K21    ; R7 := R0["displayAsPercent"]
 57 [-]: TEST      R7 0         ; if not R7 then PC := 62
 58 [-]: JMP       62           ; PC := 62
 59 [-]: MOVE      R7 R3        ; R7 := R3
 60 [-]: LOADK     R8 K22       ; R8 := "%"
 61 [-]: CONCAT    R3 R7 R8     ; R3 := R7 .. R8
 62 [-]: GETTABLE  R7 R2 K4     ; R7 := R2["Previous"]
 63 [-]: SETTABLE  R7 K23 R3    ; R7["DisplayValue"] := R3
 64 [-]: GETUPVAL  R7 U1        ; R7 := U1
 65 [-]: GETTABLE  R7 R7 K24    ; R7 := R7["mLevel"]
 66 [-]: LT        0 K20 R7     ; if 0 >= R7 then PC := 118
 67 [-]: JMP       118          ; PC := 118
 68 [-]: GETTABLE  R7 R2 K7     ; R7 := R2["Current"]
 69 [-]: GETTABLE  R8 R1 K6     ; R8 := R1["statValue"]
 70 [-]: SETTABLE  R7 K5 R8     ; R7["StatValue"] := R8
 71 [-]: GETGLOBAL R7 K8        ; R7 := 0x9FAED6BC
 72 [-]: GETUPVAL  R8 U0        ; R8 := U0
 73 [-]: GETTABLE  R8 R8 K9     ; R8 := R8["0xF81722A2"]
 74 [-]: GETTABLE  R9 R1 K10    ; R9 := R1["displayAbsValue"]
 75 [-]: EQ        1 R9 K11     ; if R9 == nil then PC := 80
 76 [-]: JMP       80           ; PC := 80
 77 [-]: GETTABLE  R9 R1 K10    ; R9 := R1["displayAbsValue"]
 78 [-]: EQ        1 R9 K12     ; if R9 == "0x1" then PC := 81
 79 [-]: JMP       81           ; PC := 81
 80 [-]: MOVE      R9 R0        ; R9 := R0
 81 [-]: MOVE      R9 R1        ; R9 := R1
 82 [-]: GETGLOBAL R10 K13      ; R10 := math
 83 [-]: GETTABLE  R10 R10 K14  ; R10 := R10["0xF93F7CC8"]
 84 [-]: GETTABLE  R11 R1 K6    ; R11 := R1["statValue"]
 85 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 86 [-]: GETTABLE  R11 R1 K6    ; R11 := R1["statValue"]
 87 [-]: CALL      R8 4 0       ; R8,... := R8(R9,R10,R11)
 88 [-]: CALL      R7 0 2       ; R7 := R7(R8,...)
 89 [-]: MOVE      R3 R7        ; R3 := R7
 90 [-]: GETTABLE  R7 R1 K16    ; R7 := R1["reverseValueSymbol"]
 91 [-]: EQ        1 R7 K11     ; if R7 == nil then PC := 97
 92 [-]: JMP       97           ; PC := 97
 93 [-]: MOVE      R7 R5        ; R7 := R5
 94 [-]: MOVE      R8 R1        ; R8 := R1
 95 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 96 [-]: MOVE      R3 R7        ; R3 := R7
 97 [-]: SELF      R7 R3 K17    ; R8 := R3; R7 := R3["0xDE44F664"]
 98 [-]: LOADK     R9 K18       ; R9 := "%."
 99 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
100 [-]: TEST      R7 0         ; if not R7 then PC := 110
101 [-]: JMP       110          ; PC := 110
102 [-]: LEN       R8 R3        ; R8 := # R3
103 [-]: LT        0 R7 R8      ; if R7 >= R8 then PC := 110
104 [-]: JMP       110          ; PC := 110
105 [-]: SELF      R8 R3 K19    ; R9 := R3; R8 := R3["0x7B782033"]
106 [-]: LOADK     R10 K20      ; R10 := 0
107 [-]: ADD       R11 R7 R4    ; R11 := R7 + R4
108 [-]: CALL      R8 4 2       ; R8 := R8(R9,R10,R11)
109 [-]: MOVE      R3 R8        ; R3 := R8
110 [-]: GETTABLE  R8 R1 K21    ; R8 := R1["displayAsPercent"]
111 [-]: TEST      R8 0         ; if not R8 then PC := 116
112 [-]: JMP       116          ; PC := 116
113 [-]: MOVE      R8 R3        ; R8 := R3
114 [-]: LOADK     R9 K22       ; R9 := "%"
115 [-]: CONCAT    R3 R8 R9     ; R3 := R8 .. R9
116 [-]: GETTABLE  R8 R2 K7     ; R8 := R2["Current"]
117 [-]: SETTABLE  R8 K23 R3    ; R8["DisplayValue"] := R3
