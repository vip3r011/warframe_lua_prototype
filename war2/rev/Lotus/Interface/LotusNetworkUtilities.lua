...
; Command line was: -dis C:\war2\raw\Lotus\Interface\LotusNetworkUtilities.lua 
...
228 [-]: EQ        0 R17 R18    ; if R17 ~= R18 then PC := 383
229 [-]: JMP       383          ; PC := 383
...
247 [-]: EQ        0 R18 K9     ; if R18 ~= 0 then PC := 319
248 [-]: JMP       319          ; PC := 319
...
257 [-]: EQ        0 R18 R19    ; if R18 ~= R19 then PC := 319
258 [-]: JMP       319          ; PC := 319
...
286 [-]: TEST      R18 1        ; if R18 then PC := 319
287 [-]: JMP       319          ; PC := 319
...
292 [-]: TEST      R18 1        ; if R18 then PC := 319
293 [-]: JMP       319          ; PC := 319
...
307 [-]: TEST      R18 1        ; if R18 then PC := 319
308 [-]: JMP       319          ; PC := 319
309 [-]: GETTABLE  R18 R12 K39  ; R18 := R12["mission"]
310 [-]: TEST      R18 0        ; if not R18 then PC := 318
311 [-]: JMP       318          ; PC := 318
312 [-]: GETTABLE  R18 R12 K39  ; R18 := R12["mission"]
313 [-]: GETTABLE  R18 R18 K40  ; R18 := R18["missionType"]
314 [-]: GETGLOBAL R19 K41      ; R19 := Lotus_Game
315 [-]: GETTABLE  R19 R19 K84  ; R19 := R19["MT_RAILJACK"]
316 [-]: EQ        1 R18 R19    ; if R18 == R19 then PC := 319
317 [-]: JMP       319          ; PC := 319
318 [-]: SETTABLE  R6 K85 K86   ; R6["allowJoinInProgress"] := "0x0"
319 [-]: GETGLOBAL R18 K21      ; R18 := _G
320 [-]: GETTABLE  R18 R18 K80  ; R18 := R18["CachedGoalInfo"]
321 [-]: GETTABLE  R18 R18 R10  ; R18 := R18[R10]
322 [-]: TEST      R18 0        ; if not R18 then PC := 370
323 [-]: JMP       370          ; PC := 370
324 [-]: GETGLOBAL R18 K21      ; R18 := _G
325 [-]: GETTABLE  R18 R18 K80  ; R18 := R18["CachedGoalInfo"]
326 [-]: GETTABLE  R18 R18 R10  ; R18 := R18[R10]
327 [-]: GETTABLE  R18 R18 K87  ; R18 := R18["mMaxConclave"]
328 [-]: LT        1 K9 R18     ; if 0 < R18 then PC := 342
329 [-]: JMP       342          ; PC := 342
330 [-]: GETGLOBAL R18 K21      ; R18 := _G
331 [-]: GETTABLE  R18 R18 K80  ; R18 := R18["CachedGoalInfo"]
332 [-]: GETTABLE  R18 R18 R10  ; R18 := R18[R10]
333 [-]: GETTABLE  R18 R18 K88  ; R18 := R18["mBonusActive"]
334 [-]: TEST      R18 0        ; if not R18 then PC := 370
335 [-]: JMP       370          ; PC := 370
336 [-]: GETGLOBAL R18 K21      ; R18 := _G
337 [-]: GETTABLE  R18 R18 K80  ; R18 := R18["CachedGoalInfo"]
338 [-]: GETTABLE  R18 R18 R10  ; R18 := R18[R10]
339 [-]: GETTABLE  R18 R18 K89  ; R18 := R18["mBonusMaxConclave"]
340 [-]: LT        0 K9 R18     ; if 0 >= R18 then PC := 370
341 [-]: JMP       370          ; PC := 370
342 [-]: GETUPVAL  R18 U3       ; R18 := U3
343 [-]: GETTABLE  R18 R18 K90  ; R18 := R18["0xF81722A2"]
344 [-]: GETGLOBAL R19 K21      ; R19 := _G
345 [-]: GETTABLE  R19 R19 K80  ; R19 := R19["CachedGoalInfo"]
346 [-]: GETTABLE  R19 R19 R10  ; R19 := R19[R10]
347 [-]: GETTABLE  R19 R19 K88  ; R19 := R19["mBonusActive"]
348 [-]: TEST      R19 0        ; if not R19 then PC := 358
349 [-]: JMP       358          ; PC := 358
350 [-]: GETGLOBAL R19 K21      ; R19 := _G
351 [-]: GETTABLE  R19 R19 K80  ; R19 := R19["CachedGoalInfo"]
352 [-]: GETTABLE  R19 R19 R10  ; R19 := R19[R10]
353 [-]: GETTABLE  R19 R19 K89  ; R19 := R19["mBonusMaxConclave"]
354 [-]: LT        1 K9 R19     ; if 0 < R19 then PC := 357
355 [-]: JMP       357          ; PC := 357
356 [-]: MOVE      R19 R0       ; R19 := R0
357 [-]: MOVE      R19 R1       ; R19 := R1
358 [-]: GETGLOBAL R20 K21      ; R20 := _G
359 [-]: GETTABLE  R20 R20 K80  ; R20 := R20["CachedGoalInfo"]
360 [-]: GETTABLE  R20 R20 R10  ; R20 := R20[R10]
361 [-]: GETTABLE  R20 R20 K89  ; R20 := R20["mBonusMaxConclave"]
362 [-]: GETGLOBAL R21 K21      ; R21 := _G
363 [-]: GETTABLE  R21 R21 K80  ; R21 := R21["CachedGoalInfo"]
364 [-]: GETTABLE  R21 R21 R10  ; R21 := R21[R10]
365 [-]: GETTABLE  R21 R21 K87  ; R21 := R21["mMaxConclave"]
366 [-]: CALL      R18 4 2      ; R18 := R18(R19,R20,R21)
367 [-]: SETTABLE  R6 K47 R18   ; R6["eloRating"] := R18
368 [-]: SETTABLE  R6 K49 K9    ; R6["maxEloDifference"] := 0
369 [-]: SETTABLE  R6 K50 K33   ; R6["enforceElo"] := "0x1"
370 [-]: GETGLOBAL R18 K5       ; R18 := 0x93B1256B
371 [-]: LOADK     R19 K91      ; R19 := "Client gameModeId="
372 [-]: GETTABLE  R20 R6 K18   ; R20 := R6["gameModeId"]
373 [-]: LOADK     R21 K92      ; R21 := ", ELO="
374 [-]: GETTABLE  R22 R6 K47   ; R22 := R6["eloRating"]
375 [-]: LOADK     R23 K93      ; R23 := ", range "
376 [-]: GETTABLE  R24 R6 K49   ; R24 := R6["maxEloDifference"]
377 [-]: LOADK     R25 K94      ; R25 := ", allowJoinInProgress="
378 [-]: GETGLOBAL R26 K95      ; R26 := 0x9FAED6BC
379 [-]: GETTABLE  R27 R6 K85   ; R27 := R6["allowJoinInProgress"]
380 [-]: CALL      R26 2 2      ; R26 := R26(R27)
381 [-]: CONCAT    R19 R19 R26  ; R19 := R19 .. R20 .. R21 .. R22 .. R23 .. R24 .. R25 .. R26
382 [-]: CALL      R18 2 1      ; R18(R19)
383 [-]: GETUPVAL  R18 U0       ; R18 := U0
384 [-]: GETTABLE  R18 R18 K96  ; R18 := R18["0x3D9B0320"]
385 [-]: GETTABLE  R19 R6 K18   ; R19 := R6["gameModeId"]
386 [-]: CALL      R18 2 2      ; R18 := R18(R19)
387 [-]: GETGLOBAL R19 K44      ; R19 := _T
388 [-]: GETTABLE  R19 R19 K97  ; R19 := R19["REGION_ID_DERELICT"]
389 [-]: EQ        0 R18 R19    ; if R18 ~= R19 then PC := 393
390 [-]: JMP       393          ; PC := 393
391 [-]: MOVE      R19 R0       ; R19 := R0
392 [-]: RETURN    R19 2        ; return R19
393 [-]: SELF      R19 R4 K98   ; R20 := R4; R19 := R4["0xE35DD9E2"]
394 [-]: CALL      R19 2 2      ; R19 := R19(R20)
395 [-]: LOADK     R20 K99      ; R20 := 1500
396 [-]: LT        0 R19 R20    ; if R19 >= R20 then PC := 399
397 [-]: JMP       399          ; PC := 399
398 [-]: SETTABLE  R6 K100 R19  ; R6["maxPing"] := R19
399 [-]: GETGLOBAL R21 K66      ; R21 := gFlashMgr
400 [-]: SELF      R21 R21 K67  ; R22 := R21; R21 := R21["0x1089D053"]
401 [-]: LOADK     R23 K101     ; R23 := "Multiplayer.DedicatedServersOnly"
402 [-]: CALL      R21 3 2      ; R21 := R21(R22,R23)
403 [-]: TEST      R21 0        ; if not R21 then PC := 406
404 [-]: JMP       406          ; PC := 406
405 [-]: SETTABLE  R6 K102 K33  ; R6["dedicatedServer"] := "0x1"
406 [-]: TEST      R2 0         ; if not R2 then PC := 416
407 [-]: JMP       416          ; PC := 416
408 [-]: GETGLOBAL R21 K5       ; R21 := 0x93B1256B
409 [-]: LOADK     R22 K103     ; R22 := "Incremental search ping limit: "
410 [-]: GETGLOBAL R23 K95      ; R23 := 0x9FAED6BC
411 [-]: MOVE      R24 R2       ; R24 := R2
412 [-]: CALL      R23 2 2      ; R23 := R23(R24)
413 [-]: CONCAT    R22 R22 R23  ; R22 := R22 .. R23
414 [-]: CALL      R21 2 1      ; R21(R22)
415 [-]: SETTABLE  R6 K104 R2   ; R6["incrementalPingLimit"] := R2
416 [-]: GETGLOBAL R21 K0       ; R21 := gMatchingService
417 [-]: SELF      R21 R21 K105 ; R22 := R21; R21 := R21["0x72741F97"]
418 [-]: MOVE      R23 R3       ; R23 := R3
419 [-]: MOVE      R24 R6       ; R24 := R6
420 [-]: MOVE      R25 R1       ; R25 := R1
421 [-]: CALL      R21 5 1      ; R21(R22,R23,R24,R25)
422 [-]: MOVE      R21 R1       ; R21 := R1
423 [-]: RETURN    R21 2        ; return R21
