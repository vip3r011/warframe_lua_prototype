...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ProjectionsCountdown.lua 
...
; Max Stack Size:  5
 ...
 29 [-]: LOADK     R3 K5        ; R3 := "Closing relic timer"
...
; Max Stack Size:  5
 ...
 12 [-]: TEST      R0 1         ; if R0 then PC := 29
 13 [-]: JMP       29           ; PC := 29
 14 [-]: GETGLOBAL R0 K2        ; R0 := gGameRules
 15 [-]: SELF      R0 R0 K3     ; R1 := R0; R0 := R0["0x8B598ED4"]
 16 [-]: GETGLOBAL R2 K4        ; R2 := gLotusGameRulesType
 17 [-]: CALL      R0 3 2       ; R0 := R0(R1,R2)
 18 [-]: TEST      R0 0         ; if not R0 then PC := 29
 19 [-]: JMP       29           ; PC := 29
 20 [-]: GETGLOBAL R0 K1        ; R0 := gRegion
 21 [-]: SELF      R0 R0 K5     ; R1 := R0; R0 := R0["0xA559F558"]
 22 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 23 [-]: TEST      R0 0         ; if not R0 then PC := 29
 24 [-]: JMP       29           ; PC := 29
 25 [-]: GETGLOBAL R0 K2        ; R0 := gGameRules
 26 [-]: SELF      R0 R0 K6     ; R1 := R0; R0 := R0["0x6CE7CC59"]
 27 [-]: MOVE      R2 R1        ; R2 := R1
 28 [-]: CALL      R0 3 1       ; R0(R1,R2)
 29 [-]: GETGLOBAL R0 K7        ; R0 := mMovie
 30 [-]: SELF      R0 R0 K8     ; R1 := R0; R0 := R0["0x4C52612B"]
 ...
 38 [-]: EQ        1 R1 K9      ; if R1 == nil then PC := 44
 39 [-]: JMP       44           ; PC := 44
