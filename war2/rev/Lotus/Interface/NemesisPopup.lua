...
; Command line was: -dis C:\war2\raw\Lotus\Interface\NemesisPopup.lua 
...
; Max Stack Size:  11
 ...
 13 [-]: GETTABLE  R2 R2 K5     ; R2 := R2["0xDDA3917C"]
 14 [-]: GETGLOBAL R3 K6        ; R3 := Lotus_Game
 15 [-]: GETTABLE  R3 R3 K7     ; R3 := R3["UIStyle_FloatingContent"]
 16 [-]: MOVE      R4 R1        ; R4 := R1
 17 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
 18 [-]: SETTABLE  R1 K4 R2     ; R1["FloatingContent"] := R2
 19 [-]: MOVE      R1 R2        ; R1 := R2
 20 [-]: GETUPVAL  R1 U4        ; R1 := U4
 21 [-]: GETTABLE  R1 R1 K8     ; R1 := R1["0x46FF1A3C"]
 22 [-]: GETGLOBAL R2 K9        ; R2 := mMovie
 23 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 24 [-]: MOVE      R1 R3        ; R1 := R3
 25 [-]: GETUPVAL  R1 U3        ; R1 := U3
 26 [-]: SELF      R1 R1 K10    ; R2 := R1; R1 := R1["0x99AA2516"]
 27 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 28 [-]: LOADK     R4 K11       ; R4 := "Convert"
 29 [-]: NEWTABLE  R5 2 0       ; R5 := {}
 30 [-]: GETUPVAL  R6 U3        ; R6 := U3
 31 [-]: GETTABLE  R6 R6 K12    ; R6 := R6["ANCHOR_V_CENTRE"]
 32 [-]: GETUPVAL  R7 U3        ; R7 := U3
 33 [-]: GETTABLE  R7 R7 K13    ; R7 := R7["ANCHOR_H_LEFT"]
 34 [-]: SETLIST   R5 2 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 2
 35 [-]: CALL      R1 5 1       ; R1(R2,R3,R4,R5)
 36 [-]: GETUPVAL  R1 U3        ; R1 := U3
 37 [-]: SELF      R1 R1 K10    ; R2 := R1; R1 := R1["0x99AA2516"]
 38 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 39 [-]: LOADK     R4 K14       ; R4 := "Kill"
 40 [-]: NEWTABLE  R5 2 0       ; R5 := {}
 41 [-]: GETUPVAL  R6 U3        ; R6 := U3
 42 [-]: GETTABLE  R6 R6 K12    ; R6 := R6["ANCHOR_V_CENTRE"]
 43 [-]: GETUPVAL  R7 U3        ; R7 := U3
 44 [-]: GETTABLE  R7 R7 K15    ; R7 := R7["ANCHOR_H_RIGHT"]
 45 [-]: SETLIST   R5 2 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 2
 46 [-]: CALL      R1 5 1       ; R1(R2,R3,R4,R5)
 47 [-]: GETUPVAL  R1 U3        ; R1 := U3
 48 [-]: SELF      R1 R1 K10    ; R2 := R1; R1 := R1["0x99AA2516"]
 49 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 50 [-]: LOADK     R4 K16       ; R4 := "Popup"
 51 [-]: NEWTABLE  R5 2 0       ; R5 := {}
 52 [-]: GETUPVAL  R6 U3        ; R6 := U3
 53 [-]: GETTABLE  R6 R6 K17    ; R6 := R6["ANCHOR_V_BOTTOM"]
 54 [-]: GETUPVAL  R7 U3        ; R7 := U3
 55 [-]: GETTABLE  R7 R7 K18    ; R7 := R7["ANCHOR_H_CENTRE"]
 56 [-]: SETLIST   R5 2 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 2
 57 [-]: CALL      R1 5 1       ; R1(R2,R3,R4,R5)
 58 [-]: GETUPVAL  R1 U3        ; R1 := U3
 59 [-]: SELF      R1 R1 K19    ; R2 := R1; R1 := R1["0x8C7099E9"]
 60 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 61 [-]: SELF      R3 R3 K20    ; R4 := R3; R3 := R3["0xF595D5E1"]
 62 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 63 [-]: GETGLOBAL R4 K9        ; R4 := mMovie
 64 [-]: SELF      R4 R4 K21    ; R5 := R4; R4 := R4["0xEE069D65"]
 65 [-]: CALL      R4 2 0       ; R4,... := R4(R5)
 66 [-]: CALL      R1 0 1       ; R1(R2,...)
 67 [-]: LOADK     R1 K22       ; R1 := ""
 68 [-]: LOADK     R2 K22       ; R2 := ""
 69 [-]: GETGLOBAL R3 K23       ; R3 := _G
 70 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 71 [-]: EQ        1 R3 K25     ; if R3 == nil then PC := 121
 72 [-]: JMP       121          ; PC := 121
 73 [-]: GETGLOBAL R3 K23       ; R3 := _G
 74 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 75 [-]: GETTABLE  R3 R3 K26    ; R3 := R3["IsCreationPopup"]
 76 [-]: EQ        1 R3 K25     ; if R3 == nil then PC := 82
 77 [-]: JMP       82           ; PC := 82
 78 [-]: GETGLOBAL R3 K23       ; R3 := _G
 79 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 80 [-]: GETTABLE  R3 R3 K26    ; R3 := R3["IsCreationPopup"]
 81 [-]: JMP       84           ; PC := 84
 82 [-]: MOVE      R3 R0        ; R3 := R0
 83 [-]: MOVE      R3 R1        ; R3 := R1
 84 [-]: MOVE      R3 R5        ; R3 := R5
 85 [-]: GETGLOBAL R3 K23       ; R3 := _G
 86 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 87 [-]: GETTABLE  R3 R3 K27    ; R3 := R3["IsChoice"]
 88 [-]: EQ        1 R3 K25     ; if R3 == nil then PC := 94
 89 [-]: JMP       94           ; PC := 94
 90 [-]: GETGLOBAL R3 K23       ; R3 := _G
 91 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 92 [-]: GETTABLE  R3 R3 K27    ; R3 := R3["IsChoice"]
 93 [-]: JMP       96           ; PC := 96
 94 [-]: MOVE      R3 R0        ; R3 := R0
 95 [-]: MOVE      R3 R1        ; R3 := R1
 96 [-]: MOVE      R3 R6        ; R3 := R6
 97 [-]: GETGLOBAL R3 K23       ; R3 := _G
 98 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
 99 [-]: GETTABLE  R3 R3 K28    ; R3 := R3["IsRankUp"]
100 [-]: EQ        1 R3 K25     ; if R3 == nil then PC := 106
101 [-]: JMP       106          ; PC := 106
102 [-]: GETGLOBAL R3 K23       ; R3 := _G
103 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
104 [-]: GETTABLE  R3 R3 K28    ; R3 := R3["IsRankUp"]
105 [-]: JMP       108          ; PC := 108
106 [-]: MOVE      R3 R0        ; R3 := R0
107 [-]: MOVE      R3 R1        ; R3 := R1
108 [-]: MOVE      R3 R7        ; R3 := R7
109 [-]: GETGLOBAL R3 K23       ; R3 := _G
110 [-]: GETTABLE  R3 R3 K24    ; R3 := R3["NemesisPopup_Info"]
111 [-]: GETTABLE  R1 R3 K29    ; R1 := R3["Header"]
112 [-]: GETUPVAL  R3 U8        ; R3 := U8
113 [-]: GETTABLE  R3 R3 K30    ; R3 := R3["0xF81722A2"]
114 [-]: GETUPVAL  R4 U6        ; R4 := U6
115 [-]: LOADK     R5 K22       ; R5 := ""
116 [-]: GETGLOBAL R6 K23       ; R6 := _G
117 [-]: GETTABLE  R6 R6 K24    ; R6 := R6["NemesisPopup_Info"]
118 [-]: GETTABLE  R6 R6 K31    ; R6 := R6["Name"]
119 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
120 [-]: MOVE      R2 R3        ; R2 := R3
121 [-]: GETUPVAL  R3 U5        ; R3 := U5
122 [-]: TEST      R3 0         ; if not R3 then PC := 134
123 [-]: JMP       134          ; PC := 134
124 [-]: GETGLOBAL R3 K32       ; R3 := 0x400E7765
125 [-]: GETGLOBAL R4 K33       ; R4 := creationSound
126 [-]: CALL      R3 2 2       ; R3 := R3(R4)
127 [-]: TEST      R3 1         ; if R3 then PC := 134
128 [-]: JMP       134          ; PC := 134
129 [-]: GETUPVAL  R3 U8        ; R3 := U8
130 [-]: GETTABLE  R3 R3 K34    ; R3 := R3["0x25992394"]
131 [-]: GETGLOBAL R4 K33       ; R4 := creationSound
132 [-]: CALL      R3 2 1       ; R3(R4)
133 [-]: JMP       157          ; PC := 157
134 [-]: GETUPVAL  R3 U6        ; R3 := U6
135 [-]: TEST      R3 0         ; if not R3 then PC := 157
136 [-]: JMP       157          ; PC := 157
137 [-]: GETGLOBAL R3 K32       ; R3 := 0x400E7765
138 [-]: GETGLOBAL R4 K35       ; R4 := choiceIntroSound
139 [-]: CALL      R3 2 2       ; R3 := R3(R4)
140 [-]: TEST      R3 1         ; if R3 then PC := 147
141 [-]: JMP       147          ; PC := 147
142 [-]: GETUPVAL  R3 U8        ; R3 := U8
143 [-]: GETTABLE  R3 R3 K34    ; R3 := R3["0x25992394"]
144 [-]: GETGLOBAL R4 K35       ; R4 := choiceIntroSound
145 [-]: CALL      R3 2 2       ; R3 := R3(R4)
146 [-]: MOVE      R3 R9        ; R3 := R9
147 [-]: GETGLOBAL R3 K32       ; R3 := 0x400E7765
148 [-]: GETGLOBAL R4 K36       ; R4 := choiceLoopSound
149 [-]: CALL      R3 2 2       ; R3 := R3(R4)
150 [-]: TEST      R3 1         ; if R3 then PC := 157
151 [-]: JMP       157          ; PC := 157
152 [-]: GETUPVAL  R3 U8        ; R3 := U8
153 [-]: GETTABLE  R3 R3 K34    ; R3 := R3["0x25992394"]
154 [-]: GETGLOBAL R4 K36       ; R4 := choiceLoopSound
155 [-]: CALL      R3 2 2       ; R3 := R3(R4)
156 [-]: MOVE      R3 R10       ; R3 := R10
157 [-]: GETGLOBAL R3 K32       ; R3 := 0x400E7765
158 [-]: GETGLOBAL R4 K37       ; R4 := creationUISound
159 [-]: CALL      R3 2 2       ; R3 := R3(R4)
160 [-]: TEST      R3 1         ; if R3 then PC := 166
161 [-]: JMP       166          ; PC := 166
162 [-]: GETUPVAL  R3 U8        ; R3 := U8
163 [-]: GETTABLE  R3 R3 K34    ; R3 := R3["0x25992394"]
164 [-]: GETGLOBAL R4 K37       ; R4 := creationUISound
165 [-]: CALL      R3 2 1       ; R3(R4)
166 [-]: GETUPVAL  R3 U6        ; R3 := U6
167 [-]: TEST      R3 0         ; if not R3 then PC := 173
168 [-]: JMP       173          ; PC := 173
169 [-]: GETUPVAL  R3 U11       ; R3 := U11
170 [-]: GETTABLE  R3 R3 K38    ; R3 := R3["0xB4BBB185"]
171 [-]: MOVE      R4 R1        ; R4 := R1
172 [-]: CALL      R3 2 1       ; R3(R4)
173 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
174 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
175 [-]: LOADK     R5 K40       ; R5 := "Popup.Rank"
176 [-]: LOADK     R6 K41       ; R6 := "_visible"
177 [-]: GETUPVAL  R7 U7        ; R7 := U7
178 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
179 [-]: GETUPVAL  R3 U7        ; R3 := U7
180 [-]: TEST      R3 0         ; if not R3 then PC := 210
181 [-]: JMP       210          ; PC := 210
182 [-]: GETGLOBAL R3 K42       ; R3 := _T
183 [-]: SETTABLE  R3 K43 K44   ; R3["NemesisPopup_RankUpVisible"] := "0x1"
184 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
185 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
186 [-]: LOADK     R5 K45       ; R5 := "Popup.Rank.Label"
187 [-]: LOADK     R6 K46       ; R6 := "text"
188 [-]: GETGLOBAL R7 K23       ; R7 := _G
189 [-]: GETTABLE  R7 R7 K24    ; R7 := R7["NemesisPopup_Info"]
190 [-]: GETTABLE  R7 R7 K47    ; R7 := R7["Rank"]
191 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
192 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
193 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
194 [-]: LOADK     R5 K48       ; R5 := "Popup.Rank.Leaf"
195 [-]: LOADK     R6 K49       ; R6 := "_color"
196 [-]: GETGLOBAL R7 K23       ; R7 := _G
197 [-]: GETTABLE  R7 R7 K50    ; R7 := R7["UIColor_Black"]
198 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
199 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
200 [-]: SELF      R3 R3 K51    ; R4 := R3; R3 := R3["0x7E1F26D7"]
201 [-]: LOADK     R5 K52       ; R5 := "Popup.Rank.Cloud"
202 [-]: GETGLOBAL R6 K53       ; R6 := smokeMaterial
203 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
204 [-]: GETUPVAL  R3 U8        ; R3 := U8
205 [-]: GETTABLE  R3 R3 K34    ; R3 := R3["0x25992394"]
206 [-]: GETGLOBAL R4 K54       ; R4 := rankUpSound
207 [-]: CALL      R3 2 1       ; R3(R4)
208 [-]: LOADK     R3 K55       ; R3 := 6
209 [-]: MOVE      R3 R12       ; R3 := R12
210 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
211 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
212 [-]: LOADK     R5 K56       ; R5 := "Popup.BottomText"
213 [-]: LOADK     R6 K57       ; R6 := "_alpha"
214 [-]: LOADK     R7 K58       ; R7 := 0
215 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
216 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
217 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
218 [-]: LOADK     R5 K56       ; R5 := "Popup.BottomText"
219 [-]: LOADK     R6 K59       ; R6 := "textColor"
220 [-]: GETUPVAL  R7 U2        ; R7 := U2
221 [-]: GETTABLE  R7 R7 K4     ; R7 := R7["FloatingContent"]
222 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
223 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
224 [-]: SELF      R3 R3 K60    ; R4 := R3; R3 := R3["0x17028E8F"]
225 [-]: LOADK     R5 K61       ; R5 := "Popup.BottomText.text"
226 [-]: LOADK     R6 K62       ; R6 := "/Lotus/Language/Kingpins/Choice_DecideLabel"
227 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
228 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
229 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
230 [-]: LOADK     R5 K63       ; R5 := "Popup.Name"
231 [-]: LOADK     R6 K64       ; R6 := "_y"
232 [-]: GETUPVAL  R7 U8        ; R7 := U8
233 [-]: GETTABLE  R7 R7 K30    ; R7 := R7["0xF81722A2"]
234 [-]: GETUPVAL  R8 U6        ; R8 := U6
235 [-]: LOADK     R9 K65       ; R9 := -25
236 [-]: LOADK     R10 K58      ; R10 := 0
237 [-]: CALL      R7 4 2       ; R7 := R7(R8,R9,R10)
238 [-]: ADD       R7 K66 R7    ; R7 := 62 + R7
239 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
240 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
241 [-]: SELF      R3 R3 K60    ; R4 := R3; R3 := R3["0x17028E8F"]
242 [-]: LOADK     R5 K67       ; R5 := "Popup.Name.Name.text"
243 [-]: MOVE      R6 R2        ; R6 := R2
244 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
245 [-]: GETGLOBAL R3 K68       ; R3 := 0x8C64AFA9
246 [-]: GETGLOBAL R4 K9        ; R4 := mMovie
247 [-]: LOADK     R5 K69       ; R5 := "Popup.Name.Name.setVertexColors"
248 [-]: LOADK     R6 K70       ; R6 := 16711680
249 [-]: LOADK     R7 K70       ; R7 := 16711680
250 [-]: LOADK     R8 K71       ; R8 := 11141120
251 [-]: LOADK     R9 K71       ; R9 := 11141120
252 [-]: CALL      R3 7 1       ; R3(R4,R5,R6,R7,R8,R9)
253 [-]: GETGLOBAL R3 K68       ; R3 := 0x8C64AFA9
254 [-]: GETGLOBAL R4 K9        ; R4 := mMovie
255 [-]: LOADK     R5 K72       ; R5 := "Popup.Play"
256 [-]: LOADK     R6 K22       ; R6 := ""
257 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
258 [-]: GETUPVAL  R3 U11       ; R3 := U11
259 [-]: GETTABLE  R3 R3 K73    ; R3 := R3["0x1E1D306E"]
260 [-]: GETGLOBAL R4 K9        ; R4 := mMovie
261 [-]: LOADK     R5 K74       ; R5 := "Popup.Name.Name"
262 [-]: CALL      R3 3 1       ; R3(R4,R5)
263 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
264 [-]: SELF      R3 R3 K75    ; R4 := R3; R3 := R3["0xDA6F41DE"]
265 [-]: GETUPVAL  R5 U6        ; R5 := U6
266 [-]: MOVE      R5 R5        ; R5 := R5
267 [-]: CALL      R3 3 1       ; R3(R4,R5)
268 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
269 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
270 [-]: LOADK     R5 K11       ; R5 := "Convert"
271 [-]: LOADK     R6 K41       ; R6 := "_visible"
272 [-]: GETUPVAL  R7 U6        ; R7 := U6
273 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
274 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
275 [-]: SELF      R3 R3 K39    ; R4 := R3; R3 := R3["0x1C19D966"]
276 [-]: LOADK     R5 K14       ; R5 := "Kill"
277 [-]: LOADK     R6 K41       ; R6 := "_visible"
...
284 [-]: GETGLOBAL R4 K77       ; R4 := convertIcon
285 [-]: SETTABLE  R3 K76 R4    ; R3["Icon"] := R4
286 [-]: SETTABLE  R3 K78 K79   ; R3["Label"] := "/Lotus/Language/Kingpins/Choice_ConvertDesc"
287 [-]: SETTABLE  R3 K80 K81   ; R3["BtnLabel"] := "/Lotus/Language/Kingpins/Choice_ConvertLabel"
288 [-]: GETUPVAL  R4 U13       ; R4 := U13
289 [-]: SETTABLE  R3 K82 R4    ; R3["BtnCallback"] := R4
290 [-]: GETGLOBAL R4 K84       ; R4 := convertChoiceSound
291 [-]: SETTABLE  R3 K83 R4    ; R3["BtnSound"] := R4
292 [-]: SETTABLE  R3 K85 K86   ; R3["BtnCallout"] := "<MENU_LEFT>"
293 [-]: SETTABLE  R3 K87 K88   ; R3["FxXOffset"] := 150
294 [-]: GETUPVAL  R4 U15       ; R4 := U15
295 [-]: LOADK     R5 K11       ; R5 := "Convert"
296 [-]: MOVE      R6 R3        ; R6 := R3
297 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
298 [-]: MOVE      R4 R14       ; R4 := R14
299 [-]: NEWTABLE  R4 0 7       ; R4 := {}
300 [-]: GETGLOBAL R5 K89       ; R5 := killIcon
301 [-]: SETTABLE  R4 K76 R5    ; R4["Icon"] := R5
302 [-]: SETTABLE  R4 K78 K90   ; R4["Label"] := "/Lotus/Language/Kingpins/Choice_KillDesc"
303 [-]: SETTABLE  R4 K80 K91   ; R4["BtnLabel"] := "/Lotus/Language/Kingpins/Choice_KillLabel"
304 [-]: GETUPVAL  R5 U16       ; R5 := U16
305 [-]: SETTABLE  R4 K82 R5    ; R4["BtnCallback"] := R5
306 [-]: GETGLOBAL R5 K92       ; R5 := killChoiceSound
307 [-]: SETTABLE  R4 K83 R5    ; R4["BtnSound"] := R5
308 [-]: SETTABLE  R4 K85 K93   ; R4["BtnCallout"] := "<MENU_RIGHT>"
309 [-]: SETTABLE  R4 K87 K94   ; R4["FxXOffset"] := -150
310 [-]: GETUPVAL  R5 U15       ; R5 := U15
311 [-]: LOADK     R6 K14       ; R6 := "Kill"
312 [-]: MOVE      R7 R4        ; R7 := R4
313 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
314 [-]: MOVE      R5 R17       ; R5 := R17
315 [-]: GETGLOBAL R5 K9        ; R5 := mMovie
316 [-]: SELF      R5 R5 K51    ; R6 := R5; R5 := R5["0x7E1F26D7"]
317 [-]: LOADK     R7 K95       ; R7 := "Popup.CloudTop"
318 [-]: GETGLOBAL R8 K53       ; R8 := smokeMaterial
319 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
320 [-]: GETGLOBAL R5 K9        ; R5 := mMovie
321 [-]: SELF      R5 R5 K51    ; R6 := R5; R5 := R5["0x7E1F26D7"]
322 [-]: LOADK     R7 K96       ; R7 := "Popup.CloudBottom"
323 [-]: GETGLOBAL R8 K53       ; R8 := smokeMaterial
324 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
325 [-]: GETGLOBAL R5 K9        ; R5 := mMovie
326 [-]: SELF      R5 R5 K51    ; R6 := R5; R5 := R5["0x7E1F26D7"]
327 [-]: LOADK     R7 K97       ; R7 := "Popup.CloudDots"
328 [-]: GETGLOBAL R8 K98       ; R8 := kuvaMaterial
329 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
330 [-]: GETGLOBAL R5 K9        ; R5 := mMovie
331 [-]: SELF      R5 R5 K39    ; R6 := R5; R5 := R5["0x1C19D966"]
332 [-]: LOADK     R7 K97       ; R7 := "Popup.CloudDots"
333 [-]: LOADK     R8 K49       ; R8 := "_color"
334 [-]: LOADK     R9 K70       ; R9 := 16711680
