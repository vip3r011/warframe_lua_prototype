...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ThemedButtonBar.lua 
...
; Max Stack Size:  11
 ...
 19 [-]: EQ        1 R1 K5      ; if R1 == nil then PC := 76
 20 [-]: JMP       76           ; PC := 76
 ...
 56 [-]: LOADK     R7 K22       ; R7 := -20
 57 [-]: LOADK     R8 K23       ; R8 := 10
 58 [-]: CALL      R2 7 1       ; R2(R3,R4,R5,R6,R7,R8)
 59 [-]: GETTABLE  R2 R1 K24    ; R2 := R1["Rect"]
 60 [-]: SETTABLE  R2 K25 K7    ; R2["BottomAnchor"] := "0x1"
 61 [-]: GETTABLE  R2 R1 K24    ; R2 := R1["Rect"]
 62 [-]: GETGLOBAL R3 K16       ; R3 := 0xF595ADDE
 63 [-]: GETGLOBAL R4 K11       ; R4 := mMovie
 64 [-]: SELF      R4 R4 K17    ; R5 := R4; R4 := R4["0x6B7B470B"]
 65 [-]: GETTABLE  R6 R0 K18    ; R6 := R0["mClipName"]
 66 [-]: LOADK     R7 K19       ; R7 := ".Btn"
 67 [-]: CONCAT    R6 R6 R7     ; R6 := R6 .. R7
 68 [-]: LOADK     R7 K27       ; R7 := "_width"
 69 [-]: CALL      R4 4 0       ; R4,... := R4(R5,R6,R7)
 70 [-]: CALL      R3 0 2       ; R3 := R3(R4,...)
 71 [-]: SETTABLE  R2 K26 R3    ; R2["ReverseXOffset"] := R3
 72 [-]: GETGLOBAL R2 K28       ; R2 := _T
 73 [-]: SETTABLE  R2 K29 K5    ; R2["InfoPopup_Grid"] := nil
 74 [-]: GETGLOBAL R2 K28       ; R2 := _T
 75 [-]: SETTABLE  R2 K30 R1    ; R2["InfoPopup_Data"] := R1
 76 [-]: RETURN    R0 1         ; return 
