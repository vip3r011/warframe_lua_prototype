...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ArenaGambling.lua 
...
; Max Stack Size:  4
  ...
  2 [-]: SETTABLE  R1 K1 K2     ; R1["MadeWagerChoice"] := "0x1"
  3 [-]: LE        0 K3 R0      ; if 0 > R0 then PC := 9
  4 [-]: JMP       9            ; PC := 9
  5 [-]: GETUPVAL  R1 U0        ; R1 := U0
  6 [-]: SELF      R1 R1 K4     ; R2 := R1; R1 := R1["0xBFC96FB0"]
  7 [-]: MOVE      R3 R0        ; R3 := R0
  8 [-]: CALL      R1 3 1       ; R1(R2,R3)
  9 [-]: MOVE      R0 R1        ; R0 := R1
...
; Max Stack Size:  10
  ...
  5 [-]: GETTABLE  R1 R1 K1     ; R1 := R1["0xB11F032"]
  6 [-]: LOADK     R2 K2        ; R2 := "/Lotus/Language/Menu/ArenaInsuffCredits"
  7 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  8 [-]: RETURN    R0 1         ; return 
  9 [-]: GETTABLE  R2 R0 K3     ; R2 := R0["tier"]
 10 [-]: TEST      R2 1         ; if R2 then PC := 13
 11 [-]: JMP       13           ; PC := 13
 12 [-]: GETTABLE  R2 R0 K4     ; R2 := R0["mIndex"]
 13 [-]: SUB       R2 R2 K5     ; R2 := R2 - 1
 14 [-]: MOVE      R2 R1        ; R2 := R1
 15 [-]: LOADK     R2 K6        ; R2 := ""
 16 [-]: GETTABLE  R3 R0 K7     ; R3 := R0["QuestStageIndex"]
 17 [-]: EQ        0 R3 K8      ; if R3 ~= nil then PC := 32
 18 [-]: JMP       32           ; PC := 32
 19 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 20 [-]: SELF      R3 R3 K10    ; R4 := R3; R3 := R3["0x5DB0BD4"]
 21 [-]: LOADK     R5 K11       ; R5 := "/Lotus/Language/Menu/ArenaInvestConfirm"
 22 [-]: MOVE      R6 R1        ; R6 := R1
 23 [-]: NEWTABLE  R7 0 1       ; R7 := {}
 24 [-]: GETUPVAL  R8 U0        ; R8 := U0
 25 [-]: GETTABLE  R8 R8 K13    ; R8 := R8["0x7E197415"]
 26 [-]: GETTABLE  R9 R0 K14    ; R9 := R0["BuyIn"]
 27 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 28 [-]: SETTABLE  R7 K12 R8    ; R7["BUYIN"] := R8
 29 [-]: CALL      R3 5 2       ; R3 := R3(R4,R5,R6,R7)
 30 [-]: MOVE      R2 R3        ; R2 := R3
 31 [-]: JMP       38           ; PC := 38
 32 [-]: GETGLOBAL R3 K9        ; R3 := mMovie
 33 [-]: SELF      R3 R3 K10    ; R4 := R3; R3 := R3["0x5DB0BD4"]
 34 [-]: LOADK     R5 K15       ; R5 := "/Lotus/Language/Menu/ArenaInvestQuestConfirm"
 35 [-]: MOVE      R6 R0        ; R6 := R0
 36 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 37 [-]: MOVE      R2 R3        ; R2 := R3
 38 [-]: GETUPVAL  R3 U0        ; R3 := U0
 39 [-]: GETTABLE  R3 R3 K16    ; R3 := R3["0x1C988750"]
 40 [-]: MOVE      R4 R2        ; R4 := R2
 41 [-]: LOADK     R5 K17       ; R5 := "OnInvestConfirm"
