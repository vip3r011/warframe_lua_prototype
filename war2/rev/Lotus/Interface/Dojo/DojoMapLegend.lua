...
; Command line was: -dis C:\war2\raw\Lotus\Interface\Dojo\DojoMapLegend.lua 
...
; Max Stack Size:  26
 ...
 90 [-]: GETGLOBAL R14 K31      ; R14 := 0x329BDC44
 91 [-]: LOADK     R15 K35      ; R15 := "Lotus.Interface.UIStyleUtilities"
 92 [-]: CALL      R14 2 2      ; R14 := R14(R15)
 93 [-]: GETGLOBAL R15 K31      ; R15 := 0x329BDC44
 94 [-]: LOADK     R16 K36      ; R16 := "Lotus.Interface.UIUtilities"
 95 [-]: CALL      R15 2 2      ; R15 := R15(R16)
 96 [-]: LOADNIL   R16 R20      ; R16 := R17 := R18 := R19 := R20 := nil
 97 [-]: LOADK     R21 K34      ; R21 := 0
 98 [-]: CLOSURE   R22 0        ; R22 := closure(Function #1)
 99 [-]: SETGLOBAL R22 K37      ; Shutdown := R22
100 [-]: SETGLOBAL R22 K38      ; 0x3C577FA3 := R22
101 [-]: CLOSURE   R22 1        ; R22 := closure(Function #2)
102 [-]: MOVE      R0 R7        ; R0 := R7
103 [-]: CLOSURE   R23 2        ; R23 := closure(Function #3)
104 [-]: MOVE      R0 R22       ; R0 := R22
105 [-]: SETGLOBAL R23 K39      ; TransitionOut := R23
106 [-]: SETGLOBAL R23 K40      ; 0x7097B1B4 := R23
107 [-]: CLOSURE   R23 3        ; R23 := closure(Function #4)
108 [-]: MOVE      R0 R9        ; R0 := R9
109 [-]: MOVE      R0 R3        ; R0 := R3
110 [-]: MOVE      R0 R22       ; R0 := R22
111 [-]: CLOSURE   R24 4        ; R24 := closure(Function #5)
...
123 [-]: CLOSURE   R25 5        ; R25 := closure(Function #6)
124 [-]: MOVE      R0 R6        ; R0 := R6
125 [-]: MOVE      R0 R23       ; R0 := R23
126 [-]: MOVE      R0 R10       ; R0 := R10
127 [-]: SETGLOBAL R25 K41      ; Update := R25
128 [-]: SETGLOBAL R25 K42      ; 0x8C7099E9 := R25
129 [-]: CLOSURE   R25 6        ; R25 := closure(Function #7)
...
143 [-]: SETGLOBAL R25 K43      ; Initialize := R25
144 [-]: SETGLOBAL R25 K44      ; 0x62648036 := R25
145 [-]: CLOSURE   R25 7        ; R25 := closure(Function #8)
146 [-]: MOVE      R0 R22       ; R0 := R22
147 [-]: SETGLOBAL R25 K45      ; Close := R25
148 [-]: SETGLOBAL R25 K46      ; 0xA58BB96C := R25
149 [-]: CLOSURE   R25 8        ; R25 := closure(Function #9)
150 [-]: MOVE      R0 R23       ; R0 := R23
151 [-]: SETGLOBAL R25 K47      ; ExitScreen := R25
152 [-]: SETGLOBAL R25 K48      ; 0xDFB70305 := R25
153 [-]: CLOSURE   R25 9        ; R25 := closure(Function #10)
154 [-]: MOVE      R0 R6        ; R0 := R6
155 [-]: MOVE      R0 R10       ; R0 := R10
156 [-]: MOVE      R0 R13       ; R0 := R13
157 [-]: SETGLOBAL R25 K49      ; ToggleShow := R25
158 [-]: SETGLOBAL R25 K50      ; 0x75043506 := R25
159 [-]: CLOSURE   R25 10       ; R25 := closure(Function #11)
160 [-]: MOVE      R0 R6        ; R0 := R6
161 [-]: MOVE      R0 R10       ; R0 := R10
162 [-]: MOVE      R0 R13       ; R0 := R13
163 [-]: SETGLOBAL R25 K51      ; Hide := R25
164 [-]: SETGLOBAL R25 K52      ; 0x79EA5337 := R25
165 [-]: CLOSURE   R25 11       ; R25 := closure(Function #12)
166 [-]: MOVE      R0 R6        ; R0 := R6
167 [-]: MOVE      R0 R13       ; R0 := R13
168 [-]: SETGLOBAL R25 K53      ; Show := R25
169 [-]: SETGLOBAL R25 K54      ; 0x7CC73200 := R25
170 [-]: CLOSURE   R25 12       ; R25 := closure(Function #13)
171 [-]: MOVE      R0 R5        ; R0 := R5
172 [-]: SETGLOBAL R25 K55      ; onViewportSizeChanged := R25
173 [-]: SETGLOBAL R25 K56      ; 0x3A900427 := R25
