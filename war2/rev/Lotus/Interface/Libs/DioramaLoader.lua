...
; Command line was: -dis C:\war2\raw\Lotus\Interface\Libs\DioramaLoader.lua 
...
293 [-]: LOADK     R34 K4       ; R34 := 1
294 [-]: LEN       R35 R33      ; R35 := # R33
295 [-]: LOADK     R36 K4       ; R36 := 1
296 [-]: FORPREP   R34 299      ; R34 -= R36; PC := 299
297 [-]: GETTABLE  R38 R33 R37  ; R38 := R33[R37]
298 [-]: GETTABLE  R39 R13 R37  ; R39 := R13[R37]
299 [-]: FORLOOP   R34 297      ; R34 += R36; if R34 <= R35 then begin PC := 297; R37 := R34 end
300 [-]: GETGLOBAL R40 K17      ; R40 := gBackgroundRegion
301 [-]: SELF      R40 R40 K37  ; R41 := R40; R40 := R40["0xA76F0612"]
302 [-]: GETGLOBAL R42 K38      ; R42 := 0xEC274B1A
303 [-]: LOADK     R43 K52      ; R43 := "Archwing"
304 [-]: CALL      R42 2 0      ; R42,... := R42(R43)
305 [-]: CALL      R40 0 2      ; R40 := R40(R41,...)
306 [-]: GETTABLE  R41 R0 K40   ; R41 := R0["mTraining"]
307 [-]: TEST      R41 1        ; if R41 then PC := 350
308 [-]: JMP       350          ; PC := 350
309 [-]: LEN       R41 R40      ; R41 := # R40
310 [-]: EQ        0 R41 K41    ; if R41 ~= 0 then PC := 350
311 [-]: JMP       350          ; PC := 350
312 [-]: NEWTABLE  R41 0 0      ; R41 := {}
313 [-]: MOVE      R40 R41      ; R40 := R41
314 [-]: MOVE      R41 R9       ; R41 := R9
315 [-]: MOVE      R42 R40      ; R42 := R40
316 [-]: GETGLOBAL R43 K17      ; R43 := gBackgroundRegion
317 [-]: SELF      R43 R43 K37  ; R44 := R43; R43 := R43["0xA76F0612"]
318 [-]: GETGLOBAL R45 K38      ; R45 := 0xEC274B1A
319 [-]: LOADK     R46 K53      ; R46 := "Archwing1"
320 [-]: CALL      R45 2 0      ; R45,... := R45(R46)
321 [-]: CALL      R43 0 0      ; R43,... := R43(R44,...)
322 [-]: CALL      R41 0 1      ; R41(R42,...)
323 [-]: MOVE      R41 R9       ; R41 := R9
324 [-]: MOVE      R42 R40      ; R42 := R40
325 [-]: GETGLOBAL R43 K17      ; R43 := gBackgroundRegion
326 [-]: SELF      R43 R43 K37  ; R44 := R43; R43 := R43["0xA76F0612"]
327 [-]: GETGLOBAL R45 K38      ; R45 := 0xEC274B1A
328 [-]: LOADK     R46 K54      ; R46 := "Archwing2"
329 [-]: CALL      R45 2 0      ; R45,... := R45(R46)
330 [-]: CALL      R43 0 0      ; R43,... := R43(R44,...)
331 [-]: CALL      R41 0 1      ; R41(R42,...)
332 [-]: MOVE      R41 R9       ; R41 := R9
333 [-]: MOVE      R42 R40      ; R42 := R40
334 [-]: GETGLOBAL R43 K17      ; R43 := gBackgroundRegion
335 [-]: SELF      R43 R43 K37  ; R44 := R43; R43 := R43["0xA76F0612"]
336 [-]: GETGLOBAL R45 K38      ; R45 := 0xEC274B1A
337 [-]: LOADK     R46 K55      ; R46 := "Archwing3"
338 [-]: CALL      R45 2 0      ; R45,... := R45(R46)
339 [-]: CALL      R43 0 0      ; R43,... := R43(R44,...)
340 [-]: CALL      R41 0 1      ; R41(R42,...)
341 [-]: MOVE      R41 R9       ; R41 := R9
342 [-]: MOVE      R42 R40      ; R42 := R40
343 [-]: GETGLOBAL R43 K17      ; R43 := gBackgroundRegion
344 [-]: SELF      R43 R43 K37  ; R44 := R43; R43 := R43["0xA76F0612"]
345 [-]: GETGLOBAL R45 K38      ; R45 := 0xEC274B1A
346 [-]: LOADK     R46 K56      ; R46 := "Archwing4"
347 [-]: CALL      R45 2 0      ; R45,... := R45(R46)
348 [-]: CALL      R43 0 0      ; R43,... := R43(R44,...)
349 [-]: CALL      R41 0 1      ; R41(R42,...)
350 [-]: LOADK     R41 K4       ; R41 := 1
351 [-]: LEN       R42 R40      ; R42 := # R40
352 [-]: LOADK     R43 K4       ; R43 := 1
353 [-]: FORPREP   R41 382      ; R41 -= R43; PC := 382
354 [-]: GETTABLE  R45 R40 R44  ; R45 := R40[R44]
355 [-]: GETTABLE  R46 R13 R44  ; R46 := R13[R44]
356 [-]: GETGLOBAL R47 K2       ; R47 := 0x400E7765
357 [-]: MOVE      R48 R46      ; R48 := R46
358 [-]: CALL      R47 2 2      ; R47 := R47(R48)
359 [-]: TEST      R47 0        ; if not R47 then PC := 366
360 [-]: JMP       366          ; PC := 366
361 [-]: SELF      R47 R45 K57  ; R48 := R45; R47 := R45["0x7DBDDA0B"]
362 [-]: MOVE      R49 R0       ; R49 := R0
363 [-]: MOVE      R50 R1       ; R50 := R1
364 [-]: CALL      R47 4 1      ; R47(R48,R49,R50)
365 [-]: JMP       382          ; PC := 382
366 [-]: SELF      R47 R46 K58  ; R48 := R46; R47 := R46["0x8DB5D01F"]
367 [-]: CALL      R47 2 2      ; R47 := R47(R48)
368 [-]: SELF      R47 R47 K59  ; R48 := R47; R47 := R47["0xE81AC1B1"]
369 [-]: CALL      R47 2 2      ; R47 := R47(R48)
370 [-]: GETGLOBAL R48 K2       ; R48 := 0x400E7765
371 [-]: MOVE      R49 R47      ; R49 := R47
372 [-]: CALL      R48 2 2      ; R48 := R48(R49)
373 [-]: TEST      R48 1        ; if R48 then PC := 382
374 [-]: JMP       382          ; PC := 382
375 [-]: SELF      R48 R47 K60  ; R49 := R47; R48 := R47["0x8DD95738"]
376 [-]: MOVE      R50 R45      ; R50 := R45
377 [-]: CALL      R48 3 1      ; R48(R49,R50)
378 [-]: GETUPVAL  R48 U2       ; R48 := U2
379 [-]: MOVE      R49 R45      ; R49 := R45
380 [-]: MOVE      R50 R46      ; R50 := R46
381 [-]: CALL      R48 3 1      ; R48(R49,R50)
382 [-]: FORLOOP   R41 354      ; R41 += R43; if R41 <= R42 then begin PC := 354; R44 := R41 end
