...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ModularWeaponUtilities.lua 
...
155 [-]: LOADK     R8 K54       ; R8 := "/Lotus/Weapons/SolarisUnited/Primary/LotusModularPrimaryLauncher"
...
167 [-]: LOADK     R10 K56      ; R10 := "/Lotus/Weapons/SolarisUnited/Primary/LotusModularPrimarySniper"
...
173 [-]: LOADK     R11 K57      ; R11 := "/Lotus/Weapons/SolarisUnited/Secondary/LotusModularSecondary"
...
179 [-]: LOADK     R12 K58      ; R12 := "/Lotus/Weapons/SolarisUnited/Secondary/LotusModularSecondaryBeam"
...
185 [-]: LOADK     R13 K59      ; R13 := "/Lotus/Weapons/SolarisUnited/Secondary/LotusModularSecondaryShotgun"
186 [-]: CALL      R12 2 2      ; R12 := R12(R13)
187 [-]: SETTABLE  R11 K6 R12   ; R11["Type"] := R12
188 [-]: SETTABLE  R11 K51 K52  ; R11["Parts"] := 3
189 [-]: NEWTABLE  R12 0 2      ; R12 := {}
190 [-]: GETGLOBAL R13 K7       ; R13 := 0x2C00D429
191 [-]: LOADK     R14 K60      ; R14 := "/Lotus/Types/Vehicles/Hoverboard/HoverboardSuit"
192 [-]: CALL      R13 2 2      ; R13 := R13(R14)
193 [-]: SETTABLE  R12 K6 R13   ; R12["Type"] := R13
194 [-]: SETTABLE  R12 K51 K61  ; R12["Parts"] := 4
195 [-]: NEWTABLE  R13 0 2      ; R13 := {}
196 [-]: GETGLOBAL R14 K7       ; R14 := 0x2C00D429
197 [-]: LOADK     R15 K62      ; R15 := "/Lotus/Types/Friendly/Pets/MoaPets/MoaPetPowerSuit"
198 [-]: CALL      R14 2 2      ; R14 := R14(R15)
199 [-]: SETTABLE  R13 K6 R14   ; R13["Type"] := R14
200 [-]: SETTABLE  R13 K51 K61  ; R13["Parts"] := 4
201 [-]: NEWTABLE  R14 0 2      ; R14 := {}
202 [-]: GETGLOBAL R15 K7       ; R15 := 0x2C00D429
203 [-]: LOADK     R16 K63      ; R16 := "/Lotus/Powersuits/Archwing/ModularJetPack/ModularJetPack"
204 [-]: CALL      R15 2 2      ; R15 := R15(R16)
205 [-]: SETTABLE  R14 K6 R15   ; R14["Type"] := R15
206 [-]: SETTABLE  R14 K51 K52  ; R14["Parts"] := 3
207 [-]: SETLIST   R3 11 1      ; R3[(1-1)*FPF+i] := R(3+i), 1 <= i <= 11
208 [-]: CLOSURE   R4 0         ; R4 := closure(Function #1)
209 [-]: MOVE      R0 R2        ; R0 := R2
210 [-]: CLOSURE   R5 1         ; R5 := closure(Function #2)
211 [-]: MOVE      R0 R1        ; R0 := R1
212 [-]: MOVE      R0 R0        ; R0 := R0
213 [-]: MOVE      R0 R4        ; R0 := R4
214 [-]: SETGLOBAL R5 K64       ; GetPartsText := R5
215 [-]: SETGLOBAL R5 K65       ; 0xC1F4383F := R5
216 [-]: CLOSURE   R5 2         ; R5 := closure(Function #3)
217 [-]: MOVE      R0 R3        ; R0 := R3
218 [-]: SETGLOBAL R5 K66       ; GetModularType := R5
219 [-]: SETGLOBAL R5 K67       ; 0x3D862A96 := R5
