...
; Command line was: -dis C:\war2\raw\Lotus\Interface\LoadoutUtilities.lua 
...
; Max Stack Size:  16
 ...
 46 [-]: GETGLOBAL R4 K9        ; R4 := 0x2C00D429
 47 [-]: LOADK     R5 K19       ; R5 := "/Lotus/Types/Game/PowerSuits/PlayerPowerSuit"
 48 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 49 [-]: GETGLOBAL R5 K9        ; R5 := 0x2C00D429
 50 [-]: LOADK     R6 K20       ; R6 := "/Lotus/Weapons/Tenno/LotusLongGun"
 51 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 52 [-]: GETGLOBAL R6 K9        ; R6 := 0x2C00D429
 53 [-]: LOADK     R7 K21       ; R7 := "/Lotus/Weapons/Tenno/Pistol/LotusPistol"
 54 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 55 [-]: GETGLOBAL R7 K9        ; R7 := 0x2C00D429
 56 [-]: LOADK     R8 K22       ; R8 := "/Lotus/Types/Game/KubrowPet/KubrowPetPowerSuit"
 57 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 58 [-]: GETGLOBAL R8 K9        ; R8 := 0x2C00D429
 59 [-]: LOADK     R9 K23       ; R9 := "/Lotus/Types/Game/CatbrowPet/CatbrowPetPowerSuit"
 60 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 61 [-]: NEWTABLE  R9 0 5       ; R9 := {}
 62 [-]: SETTABLE  R9 K25 K26   ; R9["NORMAL"] := 8
 63 [-]: SETTABLE  R9 K27 K28   ; R9["STANCE_INDEX"] := 9
 64 [-]: SETTABLE  R9 K29 K28   ; R9["AURA_INDEX"] := 9
 65 [-]: SETTABLE  R9 K30 K31   ; R9["UTILITY_INDEX"] := 10
 66 [-]: SETTABLE  R9 K32 K33   ; R9["IMMORTAL_INDEX"] := 4
 67 [-]: SETGLOBAL R9 K24       ; MOD_SLOTS := R9
 68 [-]: NEWTABLE  R9 6 0       ; R9 := {}
 69 [-]: LOADK     R10 K35      ; R10 := "A"
 70 [-]: LOADK     R11 K36      ; R11 := "B"
 71 [-]: LOADK     R12 K37      ; R12 := "C"
 72 [-]: LOADK     R13 K38      ; R13 := "D"
 73 [-]: LOADK     R14 K39      ; R14 := "E"
 74 [-]: LOADK     R15 K40      ; R15 := "F"
 75 [-]: SETLIST   R9 6 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 6
 76 [-]: SETGLOBAL R9 K34       ; CONFIG_TYPES := R9
 77 [-]: CLOSURE   R9 0         ; R9 := closure(Function #1)
 78 [-]: SETGLOBAL R9 K41       ; GetSwapOperation := R9
 79 [-]: SETGLOBAL R9 K42       ; 0xBE56ACC := R9
 80 [-]: CLOSURE   R9 1         ; R9 := closure(Function #2)
 81 [-]: CLOSURE   R10 2        ; R10 := closure(Function #3)
 82 [-]: MOVE      R0 R3        ; R0 := R3
 83 [-]: SETGLOBAL R10 K43      ; GetPolarizeOperationType := R10
 84 [-]: SETGLOBAL R10 K44      ; 0xB29A6E33 := R10
 85 [-]: CLOSURE   R10 3        ; R10 := closure(Function #4)
 86 [-]: MOVE      R0 R9        ; R0 := R9
 87 [-]: SETGLOBAL R10 K45      ; GetFeatureOperation := R10
 88 [-]: SETGLOBAL R10 K46      ; 0x5F37CE9F := R10
 89 [-]: CLOSURE   R10 4        ; R10 := closure(Function #5)
 90 [-]: MOVE      R0 R0        ; R0 := R0
 91 [-]: SETGLOBAL R10 K47      ; UnlockFeature := R10
 92 [-]: SETGLOBAL R10 K48      ; 0xAA6DD5AE := R10
 93 [-]: CLOSURE   R10 5        ; R10 := closure(Function #6)
 94 [-]: SETGLOBAL R10 K49      ; UnlockFeatureUpsell := R10
 95 [-]: SETGLOBAL R10 K50      ; 0x7498D7B := R10
 96 [-]: CLOSURE   R10 6        ; R10 := closure(Function #7)
 97 [-]: MOVE      R0 R3        ; R0 := R3
 98 [-]: SETGLOBAL R10 K51      ; GetPolarizeOperation := R10
 99 [-]: SETGLOBAL R10 K52      ; 0xF76FF1CB := R10
100 [-]: CLOSURE   R10 7        ; R10 := closure(Function #8)
101 [-]: SETGLOBAL R10 K53      ; GetPassiveDescription := R10
102 [-]: SETGLOBAL R10 K54      ; 0x690010ED := R10
103 [-]: CLOSURE   R10 8        ; R10 := closure(Function #9)
104 [-]: SETGLOBAL R10 K55      ; GetApertureLocalizedName := R10
105 [-]: SETGLOBAL R10 K56      ; 0x6D926939 := R10
106 [-]: CLOSURE   R10 9        ; R10 := closure(Function #10)
107 [-]: MOVE      R0 R4        ; R0 := R4
108 [-]: MOVE      R0 R5        ; R0 := R5
109 [-]: MOVE      R0 R6        ; R0 := R6
110 [-]: SETGLOBAL R10 K57      ; IsUtilitySlot := R10
111 [-]: SETGLOBAL R10 K58      ; 0xEC4D1B6F := R10
112 [-]: CLOSURE   R10 10       ; R10 := closure(Function #11)
113 [-]: CLOSURE   R11 11       ; R11 := closure(Function #12)
114 [-]: MOVE      R0 R10       ; R0 := R10
115 [-]: SETGLOBAL R11 K59      ; IsSpecialMeleeItem := R11
116 [-]: SETGLOBAL R11 K60      ; 0xF49B500F := R11
117 [-]: CLOSURE   R11 12       ; R11 := closure(Function #13)
118 [-]: MOVE      R0 R2        ; R0 := R2
119 [-]: SETGLOBAL R11 K61      ; GetConfigList := R11
120 [-]: SETGLOBAL R11 K62      ; 0x46521186 := R11
121 [-]: CLOSURE   R11 13       ; R11 := closure(Function #14)
122 [-]: SETGLOBAL R11 K63      ; GetInfosForLinking := R11
123 [-]: SETGLOBAL R11 K64      ; 0x34D6199 := R11
124 [-]: CLOSURE   R11 14       ; R11 := closure(Function #15)
125 [-]: MOVE      R0 R10       ; R0 := R10
126 [-]: SETGLOBAL R11 K65      ; GetCalculateXForInstallGrid := R11
127 [-]: SETGLOBAL R11 K66      ; 0x14F2E21D := R11
128 [-]: CLOSURE   R11 15       ; R11 := closure(Function #16)
129 [-]: MOVE      R0 R10       ; R0 := R10
130 [-]: SETGLOBAL R11 K67      ; GetCalculateYForInstallGrid := R11
131 [-]: SETGLOBAL R11 K68      ; 0xBE2B3302 := R11
132 [-]: CLOSURE   R11 16       ; R11 := closure(Function #17)
133 [-]: MOVE      R0 R7        ; R0 := R7
134 [-]: MOVE      R0 R8        ; R0 := R8
135 [-]: SETGLOBAL R11 K69      ; GetRowColumnForInstallGrid := R11
136 [-]: SETGLOBAL R11 K70      ; 0xB19223CD := R11
137 [-]: CLOSURE   R11 17       ; R11 := closure(Function #18)
138 [-]: MOVE      R0 R2        ; R0 := R2
139 [-]: MOVE      R0 R1        ; R0 := R1
140 [-]: SETGLOBAL R11 K71      ; GetDataKnifeCombination := R11
141 [-]: SETGLOBAL R11 K72      ; 0xF899B991 := R11
