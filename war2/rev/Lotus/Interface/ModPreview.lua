...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ModPreview.lua 
...
187 [-]: CLOSURE   R57 19       ; R57 := closure(Function #20)
...
194 [-]: CLOSURE   R58 20       ; R58 := closure(Function #21)
195 [-]: MOVE      R0 R0        ; R0 := R0
196 [-]: MOVE      R0 R12       ; R0 := R12
197 [-]: CLOSURE   R45 21       ; R45 := closure(Function #22)
...
213 [-]: CLOSURE   R60 23       ; R60 := closure(Function #24)
214 [-]: MOVE      R0 R42       ; R0 := R42
215 [-]: MOVE      R0 R21       ; R0 := R21
216 [-]: MOVE      R0 R1        ; R0 := R1
217 [-]: MOVE      R0 R0        ; R0 := R0
218 [-]: CLOSURE   R61 24       ; R61 := closure(Function #25)
219 [-]: MOVE      R0 R42       ; R0 := R42
220 [-]: MOVE      R0 R28       ; R0 := R28
221 [-]: MOVE      R0 R9        ; R0 := R9
222 [-]: CLOSURE   R62 25       ; R62 := closure(Function #26)
...
240 [-]: SETGLOBAL R62 K45      ; Initialize := R62
241 [-]: SETGLOBAL R62 K46      ; 0x62648036 := R62
242 [-]: CLOSURE   R62 26       ; R62 := closure(Function #27)
243 [-]: MOVE      R0 R17       ; R0 := R17
244 [-]: MOVE      R0 R38       ; R0 := R38
245 [-]: MOVE      R0 R49       ; R0 := R49
246 [-]: CLOSURE   R63 27       ; R63 := closure(Function #28)
247 [-]: MOVE      R0 R2        ; R0 := R2
248 [-]: CLOSURE   R64 28       ; R64 := closure(Function #29)
249 [-]: MOVE      R0 R18       ; R0 := R18
250 [-]: MOVE      R0 R17       ; R0 := R17
251 [-]: MOVE      R0 R62       ; R0 := R62
...
267 [-]: SETGLOBAL R64 K47      ; Update := R64
268 [-]: SETGLOBAL R64 K48      ; 0x8C7099E9 := R64
269 [-]: CLOSURE   R64 29       ; R64 := closure(Function #30)
270 [-]: MOVE      R0 R22       ; R0 := R22
271 [-]: SETGLOBAL R64 K49      ; onViewportSizeChanged := R64
272 [-]: SETGLOBAL R64 K50      ; 0x3A900427 := R64
273 [-]: CLOSURE   R64 30       ; R64 := closure(Function #31)
274 [-]: MOVE      R0 R0        ; R0 := R0
275 [-]: MOVE      R0 R21       ; R0 := R21
276 [-]: SETGLOBAL R64 K51      ; HintFocused := R64
277 [-]: SETGLOBAL R64 K52      ; 0x1D940BD1 := R64
278 [-]: CLOSURE   R64 31       ; R64 := closure(Function #32)
279 [-]: MOVE      R0 R21       ; R0 := R21
280 [-]: SETGLOBAL R64 K53      ; HintUnfocused := R64
281 [-]: SETGLOBAL R64 K54      ; 0x7006C8BC := R64
282 [-]: CLOSURE   R64 32       ; R64 := closure(Function #33)
283 [-]: MOVE      R0 R26       ; R0 := R26
284 [-]: MOVE      R0 R36       ; R0 := R36
285 [-]: SETGLOBAL R64 K55      ; ModPressed := R64
286 [-]: SETGLOBAL R64 K56      ; 0x1647B299 := R64
287 [-]: CLOSURE   R64 33       ; R64 := closure(Function #34)
288 [-]: MOVE      R0 R26       ; R0 := R26
289 [-]: MOVE      R0 R36       ; R0 := R36
290 [-]: SETGLOBAL R64 K57      ; ModSelected := R64
291 [-]: SETGLOBAL R64 K58      ; 0xF8649874 := R64
292 [-]: CLOSURE   R64 34       ; R64 := closure(Function #35)
293 [-]: MOVE      R0 R26       ; R0 := R26
294 [-]: MOVE      R0 R36       ; R0 := R36
295 [-]: SETGLOBAL R64 K59      ; ModFocused := R64
296 [-]: SETGLOBAL R64 K60      ; 0x91D7D7A6 := R64
297 [-]: CLOSURE   R64 35       ; R64 := closure(Function #36)
298 [-]: MOVE      R0 R26       ; R0 := R26
299 [-]: MOVE      R0 R36       ; R0 := R36
300 [-]: SETGLOBAL R64 K61      ; ModUnfocused := R64
301 [-]: SETGLOBAL R64 K62      ; 0xBED6256F := R64
302 [-]: CLOSURE   R64 36       ; R64 := closure(Function #37)
303 [-]: MOVE      R0 R26       ; R0 := R26
304 [-]: MOVE      R0 R42       ; R0 := R42
305 [-]: SETGLOBAL R64 K63      ; AbilityPressed := R64
306 [-]: SETGLOBAL R64 K64      ; 0xE38A04F9 := R64
307 [-]: CLOSURE   R64 37       ; R64 := closure(Function #38)
308 [-]: MOVE      R0 R42       ; R0 := R42
309 [-]: SETGLOBAL R64 K65      ; AbilityFocused := R64
310 [-]: SETGLOBAL R64 K66      ; 0x96C0FDA0 := R64
311 [-]: CLOSURE   R64 38       ; R64 := closure(Function #39)
312 [-]: MOVE      R0 R42       ; R0 := R42
313 [-]: SETGLOBAL R64 K67      ; AbilityUnfocused := R64
314 [-]: SETGLOBAL R64 K68      ; 0x70176F71 := R64
315 [-]: CLOSURE   R64 39       ; R64 := closure(Function #40)
316 [-]: MOVE      R0 R26       ; R0 := R26
317 [-]: MOVE      R0 R37       ; R0 := R37
318 [-]: SETGLOBAL R64 K69      ; onKeyDown_MENU_MOUSE_Z := R64
319 [-]: SETGLOBAL R64 K70      ; 0x56EAD3A9 := R64
320 [-]: CLOSURE   R64 40       ; R64 := closure(Function #41)
321 [-]: MOVE      R0 R56       ; R0 := R56
322 [-]: SETGLOBAL R64 K71      ; OnArcaneSlotFocused := R64
323 [-]: SETGLOBAL R64 K72      ; 0x9DFC8550 := R64
324 [-]: CLOSURE   R64 41       ; R64 := closure(Function #42)
325 [-]: MOVE      R0 R56       ; R0 := R56
326 [-]: SETGLOBAL R64 K73      ; OnArcaneSlotUnfocused := R64
327 [-]: SETGLOBAL R64 K74      ; 0x83B77825 := R64
328 [-]: CLOSURE   R64 42       ; R64 := closure(Function #43)
329 [-]: MOVE      R0 R24       ; R0 := R24
330 [-]: MOVE      R0 R51       ; R0 := R51
331 [-]: MOVE      R0 R47       ; R0 := R47
332 [-]: SETGLOBAL R64 K75      ; SetLink := R64
333 [-]: SETGLOBAL R64 K76      ; 0x98939A52 := R64
334 [-]: CLOSURE   R64 43       ; R64 := closure(Function #44)
335 [-]: MOVE      R0 R27       ; R0 := R27
336 [-]: SETGLOBAL R64 K77      ; SetOnCloseCallback := R64
337 [-]: SETGLOBAL R64 K78      ; 0x1C742315 := R64
338 [-]: CLOSURE   R64 44       ; R64 := closure(Function #45)
339 [-]: SETGLOBAL R64 K79      ; SupportsThemes := R64
340 [-]: SETGLOBAL R64 K80      ; 0xDBE73B9E := R64
...
; Max Stack Size:  19
 ...
 57 [-]: GETTABLE  R10 R3 K5    ; R10 := R3["Upgrade"]
 58 [-]: GETTABLE  R10 R10 K22  ; R10 := R10["mInstance"]
 59 [-]: SELF      R10 R10 K23  ; R11 := R10; R10 := R10["0x6F399EDE"]
 60 [-]: GETTABLE  R12 R3 K5    ; R12 := R3["Upgrade"]
 61 [-]: GETTABLE  R12 R12 K24  ; R12 := R12["mUpgradeFingerprint"]
 62 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 63 [-]: LOADK     R11 K15      ; R11 := "<font color=\"#FFFFFF\"><b>"
 64 [-]: GETUPVAL  R12 U2       ; R12 := U2
 65 [-]: GETTABLE  R12 R12 K25  ; R12 := R12["0x77A1FEE9"]
 66 [-]: MOVE      R13 R9       ; R13 := R9
 67 [-]: MOVE      R14 R10      ; R14 := R10
 68 [-]: GETGLOBAL R15 K11      ; R15 := mMovie
 69 [-]: NEWTABLE  R16 0 0      ; R16 := {}
 70 [-]: CALL      R12 5 2      ; R12 := R12(R13,R14,R15,R16)
 71 [-]: LOADK     R13 K18      ; R13 := "</b></font>"
 72 [-]: CONCAT    R6 R11 R13   ; R6 := R11 .. R12 .. R13
 73 [-]: GETUPVAL  R11 U3       ; R11 := U3
 74 [-]: GETTABLE  R11 R11 K27  ; R11 := R11["0x1B75557F"]
 75 [-]: GETGLOBAL R12 K11      ; R12 := mMovie
 76 [-]: MOVE      R13 R8       ; R13 := R8
 77 [-]: NEWTABLE  R14 0 1      ; R14 := {}
 78 [-]: GETTABLE  R15 R3 K5    ; R15 := R3["Upgrade"]
 79 [-]: SETTABLE  R14 K28 R15  ; R14["ItemInfo"] := R15
 80 [-]: CALL      R11 4 2      ; R11 := R11(R12,R13,R14)
 81 [-]: SETTABLE  R3 K26 R11   ; R3["StoreItemInfo"] := R11
 82 [-]: GETUPVAL  R11 U3       ; R11 := U3
 83 [-]: GETTABLE  R11 R11 K29  ; R11 := R11["0x323C4EEF"]
 84 [-]: GETGLOBAL R12 K11      ; R12 := mMovie
 85 [-]: MOVE      R13 R2       ; R13 := R2
 86 [-]: GETTABLE  R14 R3 K26   ; R14 := R3["StoreItemInfo"]
 87 [-]: CALL      R11 4 1      ; R11(R12,R13,R14)
 88 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
 89 [-]: SELF      R11 R11 K30  ; R12 := R11; R11 := R11["0x26581636"]
 90 [-]: MOVE      R13 R2       ; R13 := R2
 91 [-]: LOADK     R14 K31      ; R14 := ".Unowned"
 92 [-]: CONCAT    R13 R13 R14  ; R13 := R13 .. R14
 93 [-]: GETGLOBAL R14 K32      ; R14 := unownedIcon
 94 [-]: CALL      R11 4 1      ; R11(R12,R13,R14)
 95 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
 96 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
 97 [-]: MOVE      R13 R2       ; R13 := R2
 98 [-]: LOADK     R14 K34      ; R14 := "Unowned"
 99 [-]: LOADK     R15 K35      ; R15 := "_color"
100 [-]: GETUPVAL  R16 U4       ; R16 := U4
101 [-]: GETTABLE  R16 R16 K36  ; R16 := R16["Negative"]
102 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
103 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
104 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
105 [-]: MOVE      R13 R2       ; R13 := R2
106 [-]: LOADK     R14 K34      ; R14 := "Unowned"
107 [-]: LOADK     R15 K37      ; R15 := "_visible"
108 [-]: TEST      R4 1         ; if R4 then PC := 113
109 [-]: JMP       113          ; PC := 113
110 [-]: GETTABLE  R16 R3 K38   ; R16 := R3["Owned"]
111 [-]: MOVE      R16 R16      ; R16 := R16
112 [-]: JMP       115          ; PC := 115
113 [-]: MOVE      R16 R0       ; R16 := R0
114 [-]: MOVE      R16 R1       ; R16 := R1
115 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
116 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
117 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
118 [-]: MOVE      R13 R2       ; R13 := R2
119 [-]: LOADK     R14 K39      ; R14 := "Lock"
120 [-]: LOADK     R15 K37      ; R15 := "_visible"
121 [-]: MOVE      R16 R0       ; R16 := R0
122 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
123 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
124 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
125 [-]: MOVE      R13 R2       ; R13 := R2
126 [-]: LOADK     R14 K40      ; R14 := "Label"
127 [-]: LOADK     R15 K41      ; R15 := "text"
128 [-]: LOADK     R16 K42      ; R16 := "<p>"
129 [-]: MOVE      R17 R6       ; R17 := R6
130 [-]: LOADK     R18 K43      ; R18 := "</p>"
131 [-]: CONCAT    R16 R16 R18  ; R16 := R16 .. R17 .. R18
132 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
133 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
134 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
135 [-]: MOVE      R13 R2       ; R13 := R2
136 [-]: LOADK     R14 K40      ; R14 := "Label"
137 [-]: LOADK     R15 K44      ; R15 := "_alpha"
138 [-]: MOVE      R16 R7       ; R16 := R7
139 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
140 [-]: GETGLOBAL R11 K11      ; R11 := mMovie
141 [-]: SELF      R11 R11 K33  ; R12 := R11; R11 := R11["0x880196A7"]
142 [-]: MOVE      R13 R2       ; R13 := R2
143 [-]: LOADK     R14 K40      ; R14 := "Label"
144 [-]: LOADK     R15 K45      ; R15 := "_y"
145 [-]: LOADK     R16 K46      ; R16 := 30
146 [-]: CALL      R11 6 1      ; R11(R12,R13,R14,R15,R16)
147 [-]: GETUPVAL  R11 U5       ; R11 := U5
...
; Max Stack Size:  14
 ...
 31 [-]: CALL      R6 8 2       ; R6 := R6(R7,R8,R9,R10,R11,R12,R13)
 ...
 38 [-]: SELF      R7 R7 K9     ; R8 := R7; R7 := R7["0xA77DA8EE"]
 39 [-]: MOVE      R9 R6        ; R9 := R6
 40 [-]: MOVE      R10 R1       ; R10 := R1
 41 [-]: CALL      R7 4 1       ; R7(R8,R9,R10)
 42 [-]: FORLOOP   R2 22        ; R2 += R4; if R2 <= R3 then begin PC := 22; R5 := R2 end
 43 [-]: GETUPVAL  R7 U0        ; R7 := U0
 44 [-]: SELF      R7 R7 K10    ; R8 := R7; R7 := R7["0x6470BAF4"]
