...
; Command line was: -dis C:\war2\raw\Lotus\Interface\SpecialReticles\CollectorScanner.lua 
...
; Max Stack Size:  32
 ...
 31 [-]: NEWTABLE  R12 13 0     ; R12 := {}
 32 [-]: LOADK     R13 K22      ; R13 := "/Lotus/Language/Game/RK_NONE"
 33 [-]: LOADK     R14 K23      ; R14 := "/Lotus/Language/Game/RK_ARMOR"
 34 [-]: LOADK     R15 K24      ; R15 := "/Lotus/Language/Game/RK_CLONED_FLESH"
 35 [-]: LOADK     R16 K25      ; R16 := "/Lotus/Language/Game/RK_MACHINERY"
 36 [-]: LOADK     R17 K26      ; R17 := "/Lotus/Language/Game/RK_HULKING_ARMOR"
 37 [-]: LOADK     R18 K27      ; R18 := "/Lotus/Language/Game/RK_SHIELD"
 38 [-]: LOADK     R19 K28      ; R19 := "/Lotus/Language/Game/RK_FLESH"
 39 [-]: LOADK     R20 K29      ; R20 := "/Lotus/Language/Game/RK_ROBOTIC"
 40 [-]: LOADK     R21 K30      ; R21 := "/Lotus/Language/Game/RK_HEAVY_SHIELD"
 41 [-]: LOADK     R22 K31      ; R22 := "/Lotus/Language/Game/RK_INFESTED_FLESH"
 42 [-]: LOADK     R23 K32      ; R23 := "/Lotus/Language/Game/RK_INFESTED"
 43 [-]: LOADK     R24 K33      ; R24 := "/Lotus/Language/Game/RK_INFESTED_ARMOUR"
 44 [-]: LOADK     R25 K34      ; R25 := "/Lotus/Language/Game/RK_FOSSILIZED"
 45 [-]: SETLIST   R12 13 1     ; R12[(1-1)*FPF+i] := R(12+i), 1 <= i <= 13
 46 [-]: GETGLOBAL R13 K35      ; R13 := 0x70D42C02
 47 [-]: LOADK     R14 K36      ; R14 := 0
 48 [-]: LOADK     R15 K37      ; R15 := 0.050000000745058
 49 [-]: CALL      R13 3 2      ; R13 := R13(R14,R15)
 50 [-]: LOADNIL   R14 R16      ; R14 := R15 := R16 := nil
 51 [-]: GETGLOBAL R17 K38      ; R17 := 0xEC274B1A
 52 [-]: LOADK     R18 K39      ; R18 := "Reticle"
 53 [-]: CALL      R17 2 2      ; R17 := R17(R18)
 54 [-]: GETGLOBAL R18 K38      ; R18 := 0xEC274B1A
 55 [-]: LOADK     R19 K40      ; R19 := "CollectorTarget"
 56 [-]: CALL      R18 2 2      ; R18 := R18(R19)
 57 [-]: LOADNIL   R19 R21      ; R19 := R20 := R21 := nil
 58 [-]: NEWTABLE  R22 0 1      ; R22 := {}
 59 [-]: NEWTABLE  R23 0 0      ; R23 := {}
 60 [-]: SETTABLE  R22 K41 R23  ; R22["Resistances"] := R23
 61 [-]: NEWTABLE  R23 0 6      ; R23 := {}
 62 [-]: SETTABLE  R23 K42 K36  ; R23["mLastScans"] := 0
 63 [-]: SETTABLE  R23 K43 K44  ; R23["mPriorCanScan"] := "0x1"
 64 [-]: SETTABLE  R23 K45 K46  ; R23["mScanningTag"] := nil
 65 [-]: SETTABLE  R23 K47 K36  ; R23["Lerp"] := 0
 66 [-]: GETGLOBAL R24 K49      ; R24 := 0xB5A59043
 67 [-]: LOADK     R25 K50      ; R25 := 255
 68 [-]: LOADK     R26 K50      ; R26 := 255
 69 [-]: LOADK     R27 K50      ; R27 := 255
 70 [-]: CALL      R24 4 2      ; R24 := R24(R25,R26,R27)
 71 [-]: SETTABLE  R23 K48 R24  ; R23["ColorA"] := R24
 72 [-]: GETGLOBAL R24 K49      ; R24 := 0xB5A59043
 73 [-]: LOADK     R25 K50      ; R25 := 255
 74 [-]: LOADK     R26 K36      ; R26 := 0
 75 [-]: LOADK     R27 K36      ; R27 := 0
 76 [-]: CALL      R24 4 2      ; R24 := R24(R25,R26,R27)
 77 [-]: SETTABLE  R23 K51 R24  ; R23["ColorB"] := R24
 78 [-]: CLOSURE   R24 0        ; R24 := closure(Function #1)
 79 [-]: MOVE      R0 R0        ; R0 := R0
 80 [-]: CLOSURE   R25 1        ; R25 := closure(Function #2)
 81 [-]: MOVE      R0 R15       ; R0 := R15
 82 [-]: MOVE      R0 R24       ; R0 := R24
 83 [-]: CLOSURE   R26 2        ; R26 := closure(Function #3)
 84 [-]: MOVE      R0 R2        ; R0 := R2
 85 [-]: MOVE      R0 R6        ; R0 := R6
 86 [-]: MOVE      R0 R4        ; R0 := R4
 87 [-]: MOVE      R0 R7        ; R0 := R7
 ...
 89 [-]: MOVE      R0 R1        ; R0 := R1
 90 [-]: SETGLOBAL R26 K52      ; Update := R26
 91 [-]: SETGLOBAL R26 K53      ; 0x8C7099E9 := R26
 92 [-]: CLOSURE   R26 3        ; R26 := closure(Function #4)
 93 [-]: SETGLOBAL R26 K54      ; OnProfileSaved := R26
 94 [-]: SETGLOBAL R26 K55      ; 0xF048D49D := R26
 95 [-]: CLOSURE   R26 4        ; R26 := closure(Function #5)
 96 [-]: MOVE      R0 R14       ; R0 := R14
 97 [-]: MOVE      R0 R1        ; R0 := R1
 98 [-]: MOVE      R0 R15       ; R0 := R15
 99 [-]: CLOSURE   R27 5        ; R27 := closure(Function #6)
...
109 [-]: SETGLOBAL R28 K56      ; Initialize := R28
110 [-]: SETGLOBAL R28 K57      ; 0x62648036 := R28
111 [-]: CLOSURE   R28 7        ; R28 := closure(Function #8)
112 [-]: MOVE      R0 R5        ; R0 := R5
113 [-]: SETGLOBAL R28 K58      ; SetWeapon := R28
114 [-]: SETGLOBAL R28 K59      ; 0x7C377721 := R28
115 [-]: CLOSURE   R28 8        ; R28 := closure(Function #9)
116 [-]: MOVE      R0 R1        ; R0 := R1
117 [-]: MOVE      R0 R3        ; R0 := R3
118 [-]: MOVE      R0 R17       ; R0 := R17
119 [-]: MOVE      R0 R0        ; R0 := R0
120 [-]: MOVE      R0 R4        ; R0 := R4
121 [-]: CLOSURE   R29 9        ; R29 := closure(Function #10)
122 [-]: MOVE      R0 R28       ; R0 := R28
123 [-]: SETGLOBAL R29 K60      ; SetAiming := R29
124 [-]: SETGLOBAL R29 K61      ; 0xD51D3E81 := R29
125 [-]: CLOSURE   R29 10       ; R29 := closure(Function #11)
126 [-]: MOVE      R0 R4        ; R0 := R4
127 [-]: SETGLOBAL R29 K62      ; IsAiming := R29
128 [-]: SETGLOBAL R29 K63      ; 0x6E155CE3 := R29
129 [-]: CLOSURE   R29 11       ; R29 := closure(Function #12)
130 [-]: MOVE      R0 R28       ; R0 := R28
131 [-]: SETGLOBAL R29 K64      ; SetEnabled := R29
132 [-]: SETGLOBAL R29 K65      ; 0x91791A08 := R29
133 [-]: CLOSURE   R29 12       ; R29 := closure(Function #13)
134 [-]: SETGLOBAL R29 K66      ; OnFire := R29
135 [-]: SETGLOBAL R29 K67      ; 0x17804D85 := R29
136 [-]: CLOSURE   R29 13       ; R29 := closure(Function #14)
137 [-]: MOVE      R0 R13       ; R0 := R13
138 [-]: SETGLOBAL R29 K68      ; SetScanProgress := R29
139 [-]: SETGLOBAL R29 K69      ; 0xC123BCA3 := R29
140 [-]: CLOSURE   R29 14       ; R29 := closure(Function #15)
141 [-]: MOVE      R0 R25       ; R0 := R25
142 [-]: SETGLOBAL R29 K70      ; BonusScanProc := R29
143 [-]: SETGLOBAL R29 K71      ; 0x703EE770 := R29
144 [-]: CLOSURE   R29 15       ; R29 := closure(Function #16)
145 [-]: SETGLOBAL R29 K72      ; SetFloatingMarker := R29
146 [-]: SETGLOBAL R29 K73      ; 0x5CAE9C6F := R29
147 [-]: CLOSURE   R29 16       ; R29 := closure(Function #17)
148 [-]: MOVE      R0 R16       ; R0 := R16
149 [-]: SETGLOBAL R29 K74      ; SetFloatingMarkerPosition := R29
150 [-]: SETGLOBAL R29 K75      ; 0x4CE44038 := R29
151 [-]: CLOSURE   R29 17       ; R29 := closure(Function #18)
152 [-]: MOVE      R0 R0        ; R0 := R0
153 [-]: SETGLOBAL R29 K76      ; SetScanPointDestroyed := R29
154 [-]: SETGLOBAL R29 K77      ; 0xEDD2DDFE := R29
155 [-]: CLOSURE   R29 18       ; R29 := closure(Function #19)
156 [-]: MOVE      R0 R0        ; R0 := R0
157 [-]: SETGLOBAL R29 K78      ; SetScanTargetAlert := R29
158 [-]: SETGLOBAL R29 K79      ; 0x12E06BE4 := R29
159 [-]: CLOSURE   R29 19       ; R29 := closure(Function #20)
160 [-]: SETGLOBAL R29 K80      ; AnimateFloatingMarker := R29
161 [-]: SETGLOBAL R29 K81      ; 0x852C81F7 := R29
162 [-]: CLOSURE   R29 20       ; R29 := closure(Function #21)
163 [-]: MOVE      R0 R17       ; R0 := R17
164 [-]: SETGLOBAL R29 K82      ; ClearCustomReticleAiming := R29
165 [-]: SETGLOBAL R29 K83      ; 0x568C9EE := R29
166 [-]: CLOSURE   R29 21       ; R29 := closure(Function #22)
167 [-]: SETGLOBAL R29 K84      ; UpdateRangeFinder := R29
168 [-]: SETGLOBAL R29 K85      ; 0x37D0BA34 := R29
169 [-]: CLOSURE   R29 22       ; R29 := closure(Function #23)
170 [-]: MOVE      R0 R12       ; R0 := R12
171 [-]: CLOSURE   R30 23       ; R30 := closure(Function #24)
...
187 [-]: SETGLOBAL R31 K86      ; ScanUpdate := R31
188 [-]: SETGLOBAL R31 K87      ; 0x9981C6D0 := R31
189 [-]: CLOSURE   R31 25       ; R31 := closure(Function #26)
190 [-]: MOVE      R0 R27       ; R0 := R27
191 [-]: SETGLOBAL R31 K88      ; onViewportSizeChanged := R31
192 [-]: SETGLOBAL R31 K89      ; 0x3A900427 := R31
193 [-]: CLOSURE   R31 26       ; R31 := closure(Function #27)
194 [-]: MOVE      R0 R0        ; R0 := R0
195 [-]: SETGLOBAL R31 K90      ; Shutdown := R31
196 [-]: SETGLOBAL R31 K91      ; 0x3C577FA3 := R31
