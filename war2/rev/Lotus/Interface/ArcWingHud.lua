...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ArcWingHud.lua 
...
; Max Stack Size:  37
 ...
 83 [-]: EQ        0 R14 R3     ; if R14 ~= R3 then PC := 270
 84 [-]: JMP       270          ; PC := 270
...
120 [-]: TEST      R18 1        ; if R18 then PC := 270
121 [-]: JMP       270          ; PC := 270
...
129 [-]: EQ        1 R18 R19    ; if R18 == R19 then PC := 270
130 [-]: JMP       270          ; PC := 270
...
136 [-]: TEST      R19 1        ; if R19 then PC := 270
137 [-]: JMP       270          ; PC := 270
...
223 [-]: SELF      R27 R27 K57  ; R28 := R27; R27 := R27["0xA7A7CFDE"]
224 [-]: MOVE      R29 R14      ; R29 := R14
225 [-]: GETGLOBAL R30 K11      ; R30 := mMovie
226 [-]: CALL      R27 4 2      ; R27 := R27(R28,R29,R30)
227 [-]: GETUPVAL  R28 U5       ; R28 := U5
228 [-]: SELF      R28 R28 K58  ; R29 := R28; R28 := R28["0xFAF7FB0C"]
229 [-]: GETGLOBAL R30 K11      ; R30 := mMovie
230 [-]: MOVE      R31 R22      ; R31 := R22
231 [-]: MOVE      R32 R27      ; R32 := R27
232 [-]: GETTABLE  R33 R20 K49  ; R33 := R20["x"]
233 [-]: GETTABLE  R34 R20 K51  ; R34 := R20["y"]
234 [-]: MOVE      R35 R1       ; R35 := R1
235 [-]: CALL      R28 8 1      ; R28(R29,R30,R31,R32,R33,R34,R35)
236 [-]: GETGLOBAL R28 K11      ; R28 := mMovie
237 [-]: SELF      R28 R28 K53  ; R29 := R28; R28 := R28["0x880196A7"]
238 [-]: MOVE      R30 R22      ; R30 := R22
239 [-]: LOADK     R31 K59      ; R31 := "ScanRange"
240 [-]: LOADK     R32 K60      ; R32 := "text"
241 [-]: GETGLOBAL R33 K39      ; R33 := 0x9FAED6BC
242 [-]: MOVE      R34 R21      ; R34 := R21
243 [-]: CALL      R33 2 2      ; R33 := R33(R34)
244 [-]: LOADK     R34 K61      ; R34 := "m"
245 [-]: CONCAT    R33 R33 R34  ; R33 := R33 .. R34
246 [-]: CALL      R28 6 1      ; R28(R29,R30,R31,R32,R33)
247 [-]: GETGLOBAL R28 K11      ; R28 := mMovie
248 [-]: SELF      R28 R28 K47  ; R29 := R28; R28 := R28["0x1C19D966"]
249 [-]: MOVE      R30 R22      ; R30 := R22
250 [-]: LOADK     R31 K62      ; R31 := "_visible"
251 [-]: TESTSET   R32 R24 0    ; if not R24 then PC := 259 else R32 := R24
252 [-]: JMP       259          ; PC := 259
253 [-]: GETUPVAL  R32 U1       ; R32 := U1
254 [-]: GETTABLE  R32 R32 R13  ; R32 := R32[R13]
255 [-]: EQ        0 R32 R9     ; if R32 ~= R9 then PC := 258
256 [-]: JMP       258          ; PC := 258
...
261 [-]: JMP       265          ; PC := 265
262 [-]: TEST      R24 0        ; if not R24 then PC := 265
263 [-]: JMP       265          ; PC := 265
264 [-]: MOVE      R8 R1        ; R8 := R1
265 [-]: ADD       R1 R1 K9     ; R1 := R1 + 1
266 [-]: GETUPVAL  R28 U6       ; R28 := U6
267 [-]: LE        0 R28 R1     ; if R28 > R1 then PC := 270
268 [-]: JMP       270          ; PC := 270
269 [-]: JMP       271          ; PC := 271
270 [-]: FORLOOP   R10 65       ; R10 += R12; if R10 <= R11 then begin PC := 65; R13 := R10 end
271 [-]: ADD       R28 R1 K9    ; R28 := R1 + 1
272 [-]: GETUPVAL  R29 U6       ; R29 := U6
273 [-]: LOADK     R30 K9       ; R30 := 1
274 [-]: FORPREP   R28 285      ; R28 -= R30; PC := 285
275 [-]: GETGLOBAL R32 K11      ; R32 := mMovie
276 [-]: SELF      R32 R32 K47  ; R33 := R32; R32 := R32["0x1C19D966"]
277 [-]: MOVE      R34 R0       ; R34 := R0
278 [-]: GETGLOBAL R35 K39      ; R35 := 0x9FAED6BC
279 [-]: MOVE      R36 R31      ; R36 := R31
280 [-]: CALL      R35 2 2      ; R35 := R35(R36)
281 [-]: CONCAT    R34 R34 R35  ; R34 := R34 .. R35
282 [-]: LOADK     R35 K62      ; R35 := "_visible"
283 [-]: MOVE      R36 R0       ; R36 := R0
284 [-]: CALL      R32 5 1      ; R32(R33,R34,R35,R36)
285 [-]: FORLOOP   R28 275      ; R28 += R30; if R28 <= R29 then begin PC := 275; R31 := R28 end
