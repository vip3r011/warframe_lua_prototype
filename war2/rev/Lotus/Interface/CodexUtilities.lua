...
; Command line was: -dis C:\war2\raw\Lotus\Interface\CodexUtilities.lua 
...
; Max Stack Size:  18
 ...
 29 [-]: NEWTABLE  R3 13 0      ; R3 := {}
 30 [-]: LOADK     R4 K21       ; R4 := "/Lotus/Language/Game/RK_NONE"
 31 [-]: LOADK     R5 K22       ; R5 := "/Lotus/Language/Game/RK_ARMOR"
 32 [-]: LOADK     R6 K23       ; R6 := "/Lotus/Language/Game/RK_CLONED_FLESH"
 33 [-]: LOADK     R7 K24       ; R7 := "/Lotus/Language/Game/RK_MACHINERY"
 34 [-]: LOADK     R8 K25       ; R8 := "/Lotus/Language/Game/RK_HULKING_ARMOR"
 35 [-]: LOADK     R9 K26       ; R9 := "/Lotus/Language/Game/RK_SHIELD"
 36 [-]: LOADK     R10 K27      ; R10 := "/Lotus/Language/Game/RK_FLESH"
 37 [-]: LOADK     R11 K28      ; R11 := "/Lotus/Language/Game/RK_ROBOTIC"
 38 [-]: LOADK     R12 K29      ; R12 := "/Lotus/Language/Game/RK_HEAVY_SHIELD"
 39 [-]: LOADK     R13 K30      ; R13 := "/Lotus/Language/Game/RK_INFESTED_FLESH"
 40 [-]: LOADK     R14 K31      ; R14 := "/Lotus/Language/Game/RK_INFESTED"
 41 [-]: LOADK     R15 K32      ; R15 := "/Lotus/Language/Game/RK_INFESTED_ARMOUR"
 42 [-]: LOADK     R16 K33      ; R16 := "/Lotus/Language/Game/RK_FOSSILIZED"
 43 [-]: SETLIST   R3 13 1      ; R3[(1-1)*FPF+i] := R(3+i), 1 <= i <= 13
 44 [-]: NEWTABLE  R4 2 0       ; R4 := {}
 45 [-]: LOADK     R5 K19       ; R5 := "<DT_RADIANT>"
 46 [-]: LOADK     R6 K20       ; R6 := "<DT_SENTIENT>"
 47 [-]: SETLIST   R4 2 1       ; R4[(1-1)*FPF+i] := R(4+i), 1 <= i <= 2
 48 [-]: CLOSURE   R5 0         ; R5 := closure(Function #1)
 49 [-]: MOVE      R0 R0        ; R0 := R0
 50 [-]: CLOSURE   R6 1         ; R6 := closure(Function #2)
 51 [-]: MOVE      R0 R4        ; R0 := R4
 52 [-]: CLOSURE   R7 2         ; R7 := closure(Function #3)
 53 [-]: MOVE      R0 R5        ; R0 := R5
 54 [-]: MOVE      R0 R3        ; R0 := R3
 55 [-]: MOVE      R0 R2        ; R0 := R2
 56 [-]: MOVE      R0 R6        ; R0 := R6
 57 [-]: MOVE      R0 R0        ; R0 := R0
 58 [-]: MOVE      R0 R1        ; R0 := R1
 59 [-]: SETGLOBAL R7 K34       ; GetEnemyInfoText := R7
 60 [-]: SETGLOBAL R7 K35       ; 0xC72E17E2 := R7
 61 [-]: CLOSURE   R7 3         ; R7 := closure(Function #4)
 62 [-]: CLOSURE   R8 4         ; R8 := closure(Function #5)
 63 [-]: CLOSURE   R9 5         ; R9 := closure(Function #6)
 64 [-]: MOVE      R0 R8        ; R0 := R8
 65 [-]: SETGLOBAL R9 K36       ; GetLocalizedName := R9
 66 [-]: SETGLOBAL R9 K37       ; 0xF3F3A654 := R9
 67 [-]: CLOSURE   R9 6         ; R9 := closure(Function #7)
 68 [-]: MOVE      R0 R8        ; R0 := R8
 69 [-]: MOVE      R0 R7        ; R0 := R7
 70 [-]: CLOSURE   R10 7        ; R10 := closure(Function #8)
 71 [-]: MOVE      R0 R9        ; R0 := R9
 72 [-]: SETGLOBAL R10 K38      ; GetDropSources := R10
 73 [-]: SETGLOBAL R10 K39      ; 0x2AB3C4D4 := R10
 74 [-]: CLOSURE   R10 8        ; R10 := closure(Function #9)
 75 [-]: MOVE      R0 R9        ; R0 := R9
 76 [-]: MOVE      R0 R0        ; R0 := R0
 77 [-]: SETGLOBAL R10 K40      ; GetDropSourcesString := R10
 78 [-]: SETGLOBAL R10 K41      ; 0x325CED7F := R10
 79 [-]: CLOSURE   R10 9        ; R10 := closure(Function #10)
 80 [-]: SETGLOBAL R10 K42      ; OnStats := R10
 81 [-]: SETGLOBAL R10 K43      ; 0xB7B701B := R10
