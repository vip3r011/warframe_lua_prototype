...
; Command line was: -dis C:\war2\raw\Lotus\Interface\Components\ThemedCustomizationList.lua 
...
205 [-]: GETTABLE  R11 R11 K79  ; R11 := R11["mElementWidth"]
206 [-]: EQ        1 R11 K1     ; if R11 == nil then PC := 214
207 [-]: JMP       214          ; PC := 214
208 [-]: GETUPVAL  R11 U0       ; R11 := U0
209 [-]: GETTABLE  R11 R11 K79  ; R11 := R11["mElementWidth"]
210 [-]: SETTABLE  R10 K80 R11  ; R10["mMaxSize"] := R11
211 [-]: GETUPVAL  R11 U0       ; R11 := U0
212 [-]: GETTABLE  R11 R11 K79  ; R11 := R11["mElementWidth"]
213 [-]: SETTABLE  R10 K81 R11  ; R10["mMinSize"] := R11
214 [-]: GETTABLE  R11 R10 K40  ; R11 := R10["mType"]
215 [-]: GETUPVAL  R12 U0       ; R12 := U0
216 [-]: GETTABLE  R12 R12 K4   ; R12 := R12["mTypes"]
217 [-]: GETTABLE  R12 R12 K82  ; R12 := R12["COLOR"]
218 [-]: EQ        0 R11 R12    ; if R11 ~= R12 then PC := 226
219 [-]: JMP       226          ; PC := 226
220 [-]: GETTABLE  R11 R10 K42  ; R11 := R10["mColorRegions"]
221 [-]: EQ        0 R11 K1     ; if R11 ~= nil then PC := 226
222 [-]: JMP       226          ; PC := 226
223 [-]: GETUPVAL  R11 U0       ; R11 := U0
224 [-]: GETTABLE  R11 R11 K83  ; R11 := R11["mAllColors"]
225 [-]: SETTABLE  R10 K83 R11  ; R10["mAllColors"] := R11
226 [-]: MOVE      R11 R1       ; R11 := R1
227 [-]: GETTABLE  R12 R0 K84   ; R12 := R0["IsEnabledCheck"]
228 [-]: EQ        1 R12 K1     ; if R12 == nil then PC := 233
229 [-]: JMP       233          ; PC := 233
230 [-]: GETTABLE  R12 R0 K85   ; R12 := R0["0xC18A3E47"]
231 [-]: CALL      R12 1 2      ; R12 := R12()
232 [-]: MOVE      R11 R12      ; R11 := R12
233 [-]: SELF      R12 R10 K86  ; R13 := R10; R12 := R10["0xE2A2E3AC"]
234 [-]: MOVE      R14 R11      ; R14 := R11
235 [-]: CALL      R12 3 1      ; R12(R13,R14)
236 [-]: SELF      R12 R10 K87  ; R13 := R10; R12 := R10["0xA0107BF2"]
237 [-]: CALL      R12 2 1      ; R12(R13)
238 [-]: GETGLOBAL R12 K6       ; R12 := 0x400E7765
239 [-]: GETUPVAL  R13 U0       ; R13 := U0
240 [-]: GETTABLE  R13 R13 K88  ; R13 := R13["VisibleRangeMaterial"]
241 [-]: CALL      R12 2 2      ; R12 := R12(R13)
242 [-]: TEST      R12 1        ; if R12 then PC := 256
243 [-]: JMP       256          ; PC := 256
244 [-]: GETTABLE  R12 R0 K89   ; R12 := R0["IgnoreVisRange"]
245 [-]: TEST      R12 1        ; if R12 then PC := 256
246 [-]: JMP       256          ; PC := 256
247 [-]: SELF      R12 R10 K90  ; R13 := R10; R12 := R10["0xCF0F2D70"]
248 [-]: GETUPVAL  R14 U0       ; R14 := U0
249 [-]: GETTABLE  R14 R14 K88  ; R14 := R14["VisibleRangeMaterial"]
250 [-]: GETUPVAL  R15 U0       ; R15 := U0
251 [-]: GETTABLE  R15 R15 K91  ; R15 := R15["TextVisibleRangeMaterial"]
252 [-]: GETUPVAL  R16 U0       ; R16 := U0
253 [-]: GETTABLE  R16 R16 K92  ; R16 := R16["RectangleVisibleRangeMaterial"]
254 [-]: CALL      R12 5 1      ; R12(R13,R14,R15,R16)
255 [-]: JMP       258          ; PC := 258
256 [-]: SELF      R12 R10 K93  ; R13 := R10; R12 := R10["0x6470BAF4"]
257 [-]: CALL      R12 2 1      ; R12(R13)
258 [-]: GETTABLE  R12 R0 K94   ; R12 := R0["AlphaOverride"]
259 [-]: EQ        1 R12 K1     ; if R12 == nil then PC := 264
260 [-]: JMP       264          ; PC := 264
261 [-]: SELF      R12 R10 K95  ; R13 := R10; R12 := R10["0xE4BE5E57"]
262 [-]: GETTABLE  R14 R0 K94   ; R14 := R0["AlphaOverride"]
263 [-]: CALL      R12 3 1      ; R12(R13,R14)
264 [-]: GETGLOBAL R12 K96      ; R12 := 0x8C64AFA9
265 [-]: MOVE      R13 R2       ; R13 := R2
266 [-]: MOVE      R14 R1       ; R14 := R1
267 [-]: LOADK     R15 K97      ; R15 := ".RightInfo.gotoAndStop"
268 [-]: CONCAT    R14 R14 R15  ; R14 := R14 .. R15
269 [-]: LOADK     R15 K98      ; R15 := "Off"
270 [-]: CALL      R12 4 1      ; R12(R13,R14,R15)
271 [-]: GETTABLE  R12 R0 K30   ; R12 := R0["NameTag"]
272 [-]: MOVE      R13 R0       ; R13 := R0
273 [-]: LOADK     R14 K10      ; R14 := 100
274 [-]: MOVE      R15 R0       ; R15 := R0
275 [-]: GETTABLE  R16 R0 K3    ; R16 := R0["Type"]
276 [-]: GETUPVAL  R17 U0       ; R17 := U0
277 [-]: GETTABLE  R17 R17 K4   ; R17 := R17["mTypes"]
278 [-]: GETTABLE  R17 R17 K5   ; R17 := R17["ITEM_SELECTION"]
279 [-]: EQ        0 R16 R17    ; if R16 ~= R17 then PC := 381
280 [-]: JMP       381          ; PC := 381
281 [-]: GETGLOBAL R16 K6       ; R16 := 0x400E7765
282 [-]: GETTABLE  R17 R0 K7    ; R17 := R0["ItemSelectionData"]
283 [-]: CALL      R16 2 2      ; R16 := R16(R17)
284 [-]: TEST      R16 1        ; if R16 then PC := 381
285 [-]: JMP       381          ; PC := 381
286 [-]: GETTABLE  R16 R0 K7    ; R16 := R0["ItemSelectionData"]
287 [-]: GETTABLE  R16 R16 K99  ; R16 := R16["CustomName"]
288 [-]: EQ        1 R16 K1     ; if R16 == nil then PC := 298
289 [-]: JMP       298          ; PC := 298
290 [-]: GETTABLE  R16 R0 K7    ; R16 := R0["ItemSelectionData"]
291 [-]: GETTABLE  R16 R16 K99  ; R16 := R16["CustomName"]
292 [-]: EQ        1 R16 K100   ; if R16 == "" then PC := 298
293 [-]: JMP       298          ; PC := 298
294 [-]: MOVE      R13 R1       ; R13 := R1
295 [-]: GETTABLE  R16 R0 K7    ; R16 := R0["ItemSelectionData"]
296 [-]: GETTABLE  R12 R16 K99  ; R12 := R16["CustomName"]
297 [-]: JMP       343          ; PC := 343
298 [-]: GETGLOBAL R16 K6       ; R16 := 0x400E7765
299 [-]: GETTABLE  R17 R0 K7    ; R17 := R0["ItemSelectionData"]
300 [-]: GETTABLE  R17 R17 K8   ; R17 := R17["CurrSelection"]
301 [-]: CALL      R16 2 2      ; R16 := R16(R17)
302 [-]: TEST      R16 1        ; if R16 then PC := 342
303 [-]: JMP       342          ; PC := 342
304 [-]: LOADK     R16 K100     ; R16 := ""
305 [-]: GETUPVAL  R17 U0       ; R17 := U0
306 [-]: GETTABLE  R17 R17 K101 ; R17 := R17["mUseOverrideLoc"]
307 [-]: TEST      R17 0        ; if not R17 then PC := 320
308 [-]: JMP       320          ; PC := 320
309 [-]: SELF      R17 R2 K102  ; R18 := R2; R17 := R2["0x5DB0BD4"]
310 [-]: GETTABLE  R19 R0 K7    ; R19 := R0["ItemSelectionData"]
311 [-]: GETTABLE  R19 R19 K8   ; R19 := R19["CurrSelection"]
312 [-]: SELF      R19 R19 K103 ; R20 := R19; R19 := R19["0xFF82B3D"]
313 [-]: CALL      R19 2 2      ; R19 := R19(R20)
314 [-]: SELF      R19 R19 K104 ; R20 := R19; R19 := R19["0x5EC7A3D2"]
315 [-]: CALL      R19 2 2      ; R19 := R19(R20)
316 [-]: MOVE      R20 R1       ; R20 := R1
317 [-]: CALL      R17 4 2      ; R17 := R17(R18,R19,R20)
318 [-]: MOVE      R16 R17      ; R16 := R17
319 [-]: JMP       330          ; PC := 330
320 [-]: SELF      R17 R2 K102  ; R18 := R2; R17 := R2["0x5DB0BD4"]
321 [-]: GETTABLE  R19 R0 K7    ; R19 := R0["ItemSelectionData"]
322 [-]: GETTABLE  R19 R19 K8   ; R19 := R19["CurrSelection"]
323 [-]: SELF      R19 R19 K105 ; R20 := R19; R19 := R19["0x616C74B6"]
324 [-]: CALL      R19 2 2      ; R19 := R19(R20)
325 [-]: SELF      R19 R19 K104 ; R20 := R19; R19 := R19["0x5EC7A3D2"]
326 [-]: CALL      R19 2 2      ; R19 := R19(R20)
327 [-]: MOVE      R20 R1       ; R20 := R1
328 [-]: CALL      R17 4 2      ; R17 := R17(R18,R19,R20)
329 [-]: MOVE      R16 R17      ; R16 := R17
330 [-]: EQ        1 R16 K100   ; if R16 == "" then PC := 343
331 [-]: JMP       343          ; PC := 343
332 [-]: EQ        1 R16 K106   ; if R16 == " " then PC := 343
333 [-]: JMP       343          ; PC := 343
334 [-]: MOVE      R13 R1       ; R13 := R1
335 [-]: MOVE      R12 R16      ; R12 := R16
336 [-]: GETTABLE  R17 R0 K7    ; R17 := R0["ItemSelectionData"]
337 [-]: GETTABLE  R17 R17 K107 ; R17 := R17["IsPreview"]
338 [-]: TEST      R17 0        ; if not R17 then PC := 343
339 [-]: JMP       343          ; PC := 343
340 [-]: MOVE      R15 R1       ; R15 := R1
341 [-]: JMP       343          ; PC := 343
342 [-]: LOADK     R12 K108     ; R12 := "NONE"
343 [-]: EQ        1 R12 K100   ; if R12 == "" then PC := 347
344 [-]: JMP       347          ; PC := 347
345 [-]: EQ        0 R12 K108   ; if R12 ~= "NONE" then PC := 391
346 [-]: JMP       391          ; PC := 391
347 [-]: GETUPVAL  R17 U0       ; R17 := U0
348 [-]: GETTABLE  R17 R17 K109 ; R17 := R17["mNoneTextOverride"]
349 [-]: EQ        1 R17 K1     ; if R17 == nil then PC := 358
350 [-]: JMP       358          ; PC := 358
351 [-]: GETGLOBAL R17 K110     ; R17 := 0xE6DC43B0
352 [-]: GETUPVAL  R18 U0       ; R18 := U0
353 [-]: GETTABLE  R18 R18 K109 ; R18 := R18["mNoneTextOverride"]
354 [-]: MOVE      R19 R0       ; R19 := R0
355 [-]: CALL      R17 3 2      ; R17 := R17(R18,R19)
356 [-]: MOVE      R12 R17      ; R12 := R17
357 [-]: JMP       378          ; PC := 378
358 [-]: GETUPVAL  R17 U0       ; R17 := U0
359 [-]: GETTABLE  R17 R17 K111 ; R17 := R17["mTopTitleForNone"]
360 [-]: TEST      R17 0        ; if not R17 then PC := 368
361 [-]: JMP       368          ; PC := 368
362 [-]: GETGLOBAL R17 K110     ; R17 := 0xE6DC43B0
363 [-]: GETTABLE  R18 R0 K30   ; R18 := R0["NameTag"]
364 [-]: MOVE      R19 R0       ; R19 := R0
365 [-]: CALL      R17 3 2      ; R17 := R17(R18,R19)
366 [-]: MOVE      R12 R17      ; R12 := R17
367 [-]: JMP       378          ; PC := 378
368 [-]: GETGLOBAL R17 K110     ; R17 := 0xE6DC43B0
369 [-]: LOADK     R18 K112     ; R18 := "/Lotus/Language/Menu/Cosmetics_NoItem"
370 [-]: NEWTABLE  R19 0 1      ; R19 := {}
371 [-]: GETGLOBAL R20 K110     ; R20 := 0xE6DC43B0
372 [-]: GETTABLE  R21 R0 K30   ; R21 := R0["NameTag"]
373 [-]: MOVE      R22 R0       ; R22 := R0
374 [-]: CALL      R20 3 2      ; R20 := R20(R21,R22)
375 [-]: SETTABLE  R19 K113 R20 ; R19["ITEM"] := R20
376 [-]: CALL      R17 3 2      ; R17 := R17(R18,R19)
377 [-]: MOVE      R12 R17      ; R12 := R17
378 [-]: LOADK     R14 K114     ; R14 := 40
379 [-]: MOVE      R13 R1       ; R13 := R1
380 [-]: JMP       391          ; PC := 391
381 [-]: GETTABLE  R17 R0 K44   ; R17 := R0["BigButton"]
382 [-]: TEST      R17 0        ; if not R17 then PC := 391
383 [-]: JMP       391          ; PC := 391
384 [-]: GETTABLE  R17 R0 K3    ; R17 := R0["Type"]
385 [-]: GETUPVAL  R18 U0       ; R18 := U0
386 [-]: GETTABLE  R18 R18 K4   ; R18 := R18["mTypes"]
387 [-]: GETTABLE  R18 R18 K115 ; R18 := R18["BUTTON"]
388 [-]: EQ        0 R17 R18    ; if R17 ~= R18 then PC := 391
389 [-]: JMP       391          ; PC := 391
390 [-]: GETTABLE  R12 R0 K116  ; R12 := R0["Title"]
391 [-]: SELF      R17 R10 K117 ; R18 := R10; R17 := R10["0x81976046"]
392 [-]: MOVE      R19 R12      ; R19 := R12
393 [-]: GETTABLE  R20 R0 K30   ; R20 := R0["NameTag"]
394 [-]: CALL      R17 4 1      ; R17(R18,R19,R20)
