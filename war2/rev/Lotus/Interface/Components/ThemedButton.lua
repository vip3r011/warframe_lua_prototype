...
; Command line was: -dis C:\war2\raw\Lotus\Interface\Components\ThemedButton.lua 
...
; Max Stack Size:  24
 ...
 48 [-]: SETTABLE  R11 K48 K7   ; R11["mShowHighlight"] := "0x1"
 49 [-]: EQ        1 R5 K24     ; if R5 == nil then PC := 54
 50 [-]: JMP       54           ; PC := 54
 51 [-]: EQ        1 R5 K7      ; if R5 == "0x1" then PC := 54
 52 [-]: JMP       54           ; PC := 54
 53 [-]: MOVE      R12 R0       ; R12 := R0
 54 [-]: MOVE      R12 R1       ; R12 := R1
 55 [-]: SETTABLE  R11 K49 R12  ; R11["mShowCallout"] := R12
 56 [-]: SETTABLE  R11 K50 K24  ; R11["mShowIcon"] := nil
 57 [-]: SETTABLE  R11 K51 K52  ; R11["mEdgeAlpha"] := 4
 58 [-]: SETTABLE  R11 K53 K54  ; R11["mInnerAlpha"] := 60
 59 [-]: SETTABLE  R11 K55 K56  ; R11["mUnderlineAlpha"] := 30
 60 [-]: GETGLOBAL R12 K58      ; R12 := Lotus_Game
 61 [-]: GETTABLE  R12 R12 K59  ; R12 := R12["UIStyle_Background1"]
 62 [-]: SETTABLE  R11 K57 R12  ; R11["mUnfocusedEdgeColor"] := R12
 63 [-]: SETTABLE  R11 K60 K24  ; R11["mActiveColor"] := nil
 64 [-]: SETTABLE  R11 K61 K62  ; R11["mActiveAlpha"] := 100
 65 [-]: SETTABLE  R11 K63 K28  ; R11["mInactiveAlpha"] := 50
 66 [-]: SETTABLE  R11 K64 K24  ; R11["mInactiveColor"] := nil
 67 [-]: SETTABLE  R11 K65 K11  ; R11["mSilent"] := "0x0"
 68 [-]: SETTABLE  R11 K66 K11  ; R11["mSpecial"] := "0x0"
 69 [-]: SETTABLE  R11 K67 K24  ; R11["mVisRangeMaterials"] := nil
 70 [-]: SETTABLE  R11 K68 K24  ; R11["mBackerMaterial"] := nil
 71 [-]: SETTABLE  R11 K69 K24  ; R11["mPostText"] := nil
 72 [-]: CLOSURE   R12 0        ; R12 := closure(Function #1.1)
 73 [-]: SETTABLE  R11 K70 R12  ; R11["GetParentEnv"] := R12
 74 [-]: CLOSURE   R12 1        ; R12 := closure(Function #1.2)
 75 [-]: SETTABLE  R11 K71 R12  ; R11["HookUpCallbacks"] := R12
 76 [-]: CLOSURE   R12 2        ; R12 := closure(Function #1.3)
 77 [-]: SETTABLE  R11 K72 R12  ; R11["HookUpDragCallbacks"] := R12
 78 [-]: CLOSURE   R12 3        ; R12 := closure(Function #1.4)
 79 [-]: MOVE      R0 R9        ; R0 := R9
 80 [-]: SETTABLE  R11 K73 R12  ; R11["Interpolate"] := R12
 81 [-]: CLOSURE   R12 4        ; R12 := closure(Function #1.5)
 82 [-]: MOVE      R0 R9        ; R0 := R9
 83 [-]: SETTABLE  R11 K74 R12  ; R11["PlaySound"] := R12
 84 [-]: CLOSURE   R12 5        ; R12 := closure(Function #1.6)
 85 [-]: MOVE      R0 R9        ; R0 := R9
 86 [-]: SETTABLE  R11 K75 R12  ; R11["TrySetDrag"] := R12
 87 [-]: CLOSURE   R12 6        ; R12 := closure(Function #1.7)
 88 [-]: SETTABLE  R11 K76 R12  ; R11["SetDrag"] := R12
 89 [-]: CLOSURE   R12 7        ; R12 := closure(Function #1.8)
 90 [-]: SETTABLE  R11 K77 R12  ; R11["StopDrag"] := R12
 91 [-]: CLOSURE   R12 8        ; R12 := closure(Function #1.9)
 92 [-]: MOVE      R0 R9        ; R0 := R9
 93 [-]: SETTABLE  R11 K78 R12  ; R11["TrySetFocus"] := R12
 94 [-]: CLOSURE   R12 9        ; R12 := closure(Function #1.10)
 95 [-]: SETTABLE  R11 K79 R12  ; R11["SetFocus"] := R12
 96 [-]: CLOSURE   R12 10       ; R12 := closure(Function #1.11)
 97 [-]: MOVE      R0 R9        ; R0 := R9
 98 [-]: SETTABLE  R11 K80 R12  ; R11["TryPressed"] := R12
 99 [-]: CLOSURE   R12 11       ; R12 := closure(Function #1.12)
100 [-]: SETTABLE  R11 K81 R12  ; R11["Pressed"] := R12
101 [-]: CLOSURE   R12 12       ; R12 := closure(Function #1.13)
102 [-]: SETTABLE  R11 K82 R12  ; R11["OnGamepadTransition"] := R12
103 [-]: CLOSURE   R12 13       ; R12 := closure(Function #1.14)
104 [-]: MOVE      R0 R9        ; R0 := R9
105 [-]: SETTABLE  R11 K83 R12  ; R11["Resize"] := R12
106 [-]: CLOSURE   R12 14       ; R12 := closure(Function #1.15)
107 [-]: MOVE      R0 R10       ; R0 := R10
108 [-]: MOVE      R0 R9        ; R0 := R9
109 [-]: SETTABLE  R11 K84 R12  ; R11["UpdateColors"] := R12
110 [-]: CLOSURE   R12 15       ; R12 := closure(Function #1.16)
111 [-]: MOVE      R0 R9        ; R0 := R9
112 [-]: SETTABLE  R11 K85 R12  ; R11["Redraw"] := R12
113 [-]: CLOSURE   R12 16       ; R12 := closure(Function #1.17)
114 [-]: SETTABLE  R11 K86 R12  ; R11["SetText"] := R12
115 [-]: CLOSURE   R12 17       ; R12 := closure(Function #1.18)
116 [-]: SETTABLE  R11 K87 R12  ; R11["SetTextAlignment"] := R12
117 [-]: CLOSURE   R12 18       ; R12 := closure(Function #1.19)
118 [-]: SETTABLE  R11 K88 R12  ; R11["SetMinWidth"] := R12
119 [-]: CLOSURE   R12 19       ; R12 := closure(Function #1.20)
120 [-]: SETTABLE  R11 K89 R12  ; R11["SetWidth"] := R12
121 [-]: CLOSURE   R12 20       ; R12 := closure(Function #1.21)
122 [-]: SETTABLE  R11 K90 R12  ; R11["SetIconVisible"] := R12
123 [-]: CLOSURE   R12 21       ; R12 := closure(Function #1.22)
124 [-]: SETTABLE  R11 K91 R12  ; R11["SetVisible"] := R12
125 [-]: CLOSURE   R12 22       ; R12 := closure(Function #1.23)
126 [-]: SETTABLE  R11 K92 R12  ; R11["SetAlpha"] := R12
127 [-]: CLOSURE   R12 23       ; R12 := closure(Function #1.24)
128 [-]: MOVE      R0 R9        ; R0 := R9
129 [-]: SETTABLE  R11 K93 R12  ; R11["SetActive"] := R12
130 [-]: CLOSURE   R12 24       ; R12 := closure(Function #1.25)
131 [-]: SETTABLE  R11 K94 R12  ; R11["IsActive"] := R12
132 [-]: CLOSURE   R12 25       ; R12 := closure(Function #1.26)
133 [-]: MOVE      R0 R9        ; R0 := R9
134 [-]: SETTABLE  R11 K95 R12  ; R11["SetAnchor"] := R12
135 [-]: CLOSURE   R12 26       ; R12 := closure(Function #1.27)
136 [-]: SETTABLE  R11 K96 R12  ; R11["SetPosition"] := R12
137 [-]: CLOSURE   R12 27       ; R12 := closure(Function #1.28)
138 [-]: SETTABLE  R11 K97 R12  ; R11["IsPlayingWithController"] := R12
139 [-]: CLOSURE   R12 28       ; R12 := closure(Function #1.29)
140 [-]: SETTABLE  R11 K98 R12  ; R11["SetSpecialMode"] := R12
141 [-]: CLOSURE   R12 29       ; R12 := closure(Function #1.30)
142 [-]: SETTABLE  R11 K99 R12  ; R11["SetVisibleRangeMaterials"] := R12
143 [-]: CLOSURE   R12 30       ; R12 := closure(Function #1.31)
144 [-]: SETTABLE  R11 K100 R12 ; R11["ValueChanged"] := R12
145 [-]: CLOSURE   R12 31       ; R12 := closure(Function #1.32)
146 [-]: SETTABLE  R11 K101 R12 ; R11["SetPressedCallback"] := R12
147 [-]: GETGLOBAL R12 K102     ; R12 := 0xECFDD17
148 [-]: MOVE      R13 R8       ; R13 := R8
149 [-]: CALL      R12 2 4      ; R12,R13,R14 := R12(R13)
150 [-]: JMP       152          ; PC := 152
151 [-]: SETTABLE  R11 R15 R16  ; R11[R15] := R16
152 [-]: TFORLOOP  R12 2        ; R15,R16 :=  R12(R13,R14); if R15 ~= nil then begin PC = 151; R14 := R15 end
153 [-]: JMP       151          ; PC := 151
154 [-]: SELF      R17 R11 K103 ; R18 := R11; R17 := R11["0xEC183DDC"]
155 [-]: SELF      R19 R0 K104  ; R20 := R0; R19 := R0["0x6B7B470B"]
156 [-]: MOVE      R21 R1       ; R21 := R1
157 [-]: LOADK     R22 K105     ; R22 := "_x"
158 [-]: CALL      R19 4 2      ; R19 := R19(R20,R21,R22)
159 [-]: SELF      R20 R0 K104  ; R21 := R0; R20 := R0["0x6B7B470B"]
160 [-]: MOVE      R22 R1       ; R22 := R1
161 [-]: LOADK     R23 K106     ; R23 := "_y"
162 [-]: CALL      R20 4 0      ; R20,... := R20(R21,R22,R23)
163 [-]: CALL      R17 0 1      ; R17(R18,...)
164 [-]: SELF      R17 R11 K107 ; R18 := R11; R17 := R11["0x37AAD7A"]
165 [-]: MOVE      R19 R3       ; R19 := R3
166 [-]: CALL      R17 3 1      ; R17(R18,R19)
167 [-]: SELF      R17 R11 K108 ; R18 := R11; R17 := R11["0x6470BAF4"]
168 [-]: CALL      R17 2 1      ; R17(R18)
169 [-]: SELF      R17 R11 K109 ; R18 := R11; R17 := R11["0xCBF84FF"]
...
; Max Stack Size:  15
 ...
 61 [-]: TESTSET   R11 R5 0     ; if not R5 then PC := 64 else R11 := R5
 62 [-]: JMP       64           ; PC := 64
 63 [-]: GETTABLE  R11 R0 K15   ; R11 := R0["mShowUnderline"]
 64 [-]: CALL      R6 6 1       ; R6(R7,R8,R9,R10,R11)
 65 [-]: SELF      R6 R1 K5     ; R7 := R1; R6 := R1["0x880196A7"]
 66 [-]: MOVE      R8 R2        ; R8 := R2
 67 [-]: LOADK     R9 K18       ; R9 := "Callout"
 68 [-]: LOADK     R10 K10      ; R10 := "_visible"
 69 [-]: MOVE      R11 R4       ; R11 := R4
 70 [-]: CALL      R6 6 1       ; R6(R7,R8,R9,R10,R11)
 71 [-]: SELF      R6 R1 K5     ; R7 := R1; R6 := R1["0x880196A7"]
 72 [-]: MOVE      R8 R2        ; R8 := R2
 73 [-]: LOADK     R9 K18       ; R9 := "Callout"
 74 [-]: LOADK     R10 K19      ; R10 := "text"
 75 [-]: SELF      R11 R1 K20   ; R12 := R1; R11 := R1["0x5DB0BD4"]
 76 [-]: GETTABLE  R13 R0 K21   ; R13 := R0["mCallout"]
 77 [-]: MOVE      R14 R1       ; R14 := R1
 78 [-]: CALL      R11 4 0      ; R11,... := R11(R12,R13,R14)
 79 [-]: CALL      R6 0 1       ; R6(R7,...)
 80 [-]: GETTABLE  R6 R0 K22    ; R6 := R0["mShowIcon"]
 81 [-]: EQ        0 R6 K23     ; if R6 ~= nil then PC := 89
 82 [-]: JMP       89           ; PC := 89
 83 [-]: SELF      R6 R1 K5     ; R7 := R1; R6 := R1["0x880196A7"]
 84 [-]: MOVE      R8 R2        ; R8 := R2
 85 [-]: LOADK     R9 K24       ; R9 := "Icon"
 86 [-]: LOADK     R10 K10      ; R10 := "_visible"
 87 [-]: MOVE      R11 R4       ; R11 := R4
 88 [-]: CALL      R6 6 1       ; R6(R7,R8,R9,R10,R11)
 89 [-]: SELF      R6 R0 K25    ; R7 := R0; R6 := R0["0x81976046"]
 90 [-]: GETTABLE  R8 R0 K26    ; R8 := R0["mLabel"]
