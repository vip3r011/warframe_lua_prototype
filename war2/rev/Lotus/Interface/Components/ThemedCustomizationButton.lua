...
; Command line was: -dis C:\war2\raw\Lotus\Interface\Components\ThemedCustomizationButton.lua 
...
; Max Stack Size:  17
  ...
  2 [-]: MOVE      R4 R1        ; R4 := R1
  3 [-]: CALL      R2 3 1       ; R2(R3,R4)
  4 [-]: TEST      R1 0         ; if not R1 then PC := 137
  5 [-]: JMP       137          ; PC := 137
  6 [-]: GETTABLE  R2 R0 K1     ; R2 := R0["mShowInfoPopup"]
  7 [-]: EQ        1 R2 K2      ; if R2 == "0x0" then PC := 166
  8 [-]: JMP       166          ; PC := 166
 ...
 50 [-]: JMP       81           ; PC := 81
 51 [-]: GETGLOBAL R8 K15       ; R8 := 0xE40A882D
 52 [-]: LOADK     R9 K16       ; R9 := "missing current item selection data"
 53 [-]: CALL      R8 2 1       ; R8(R9)
 54 [-]: JMP       81           ; PC := 81
 55 [-]: GETTABLE  R8 R0 K7     ; R8 := R0["mType"]
 56 [-]: GETUPVAL  R9 U0        ; R9 := U0
 57 [-]: GETTABLE  R9 R9 K17    ; R9 := R9["BUTTON"]
 58 [-]: EQ        0 R8 R9      ; if R8 ~= R9 then PC := 75
 59 [-]: JMP       75           ; PC := 75
 60 [-]: GETGLOBAL R8 K18       ; R8 := 0x400E7765
 61 [-]: GETTABLE  R9 R0 K19    ; R9 := R0["mStoreItem"]
 62 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 63 [-]: TEST      R8 1         ; if R8 then PC := 75
 64 [-]: JMP       75           ; PC := 75
 65 [-]: GETUPVAL  R8 U1        ; R8 := U1
 66 [-]: GETTABLE  R8 R8 K11    ; R8 := R8["0x1B75557F"]
 67 [-]: GETTABLE  R9 R0 K12    ; R9 := R0["mMovie"]
 68 [-]: GETTABLE  R10 R0 K19   ; R10 := R0["mStoreItem"]
 ...
 73 [-]: MOVE      R2 R8        ; R2 := R8
 74 [-]: JMP       81           ; PC := 81
 75 [-]: EQ        1 R2 K4      ; if R2 == nil then PC := 81
 76 [-]: JMP       81           ; PC := 81
 77 [-]: GETTABLE  R8 R2 K5     ; R8 := R2["AppendInfo"]
 78 [-]: EQ        1 R8 K4      ; if R8 == nil then PC := 81
 79 [-]: JMP       81           ; PC := 81
 80 [-]: GETTABLE  R2 R2 K5     ; R2 := R2["AppendInfo"]
 81 [-]: EQ        1 R2 K4      ; if R2 == nil then PC := 166
 82 [-]: JMP       166          ; PC := 166
 83 [-]: GETUPVAL  R8 U2        ; R8 := U2
 84 [-]: EQ        1 R8 K4      ; if R8 == nil then PC := 89
 85 [-]: JMP       89           ; PC := 89
 86 [-]: GETUPVAL  R8 U2        ; R8 := U2
 87 [-]: GETTABLE  R8 R8 K20    ; R8 := R8["mUnequipItem"]
 88 [-]: SETTABLE  R2 K20 R8    ; R2["mUnequipItem"] := R8
 89 [-]: GETGLOBAL R8 K18       ; R8 := 0x400E7765
 90 [-]: GETUPVAL  R9 U3        ; R9 := U3
 91 [-]: GETTABLE  R9 R9 K21    ; R9 := R9["OnShowPopup"]
 92 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 93 [-]: TEST      R8 1         ; if R8 then PC := 100
 94 [-]: JMP       100          ; PC := 100
 95 [-]: GETUPVAL  R8 U3        ; R8 := U3
 96 [-]: SELF      R8 R8 K22    ; R9 := R8; R8 := R8["0x8E80B215"]
 97 [-]: GETUPVAL  R10 U2       ; R10 := U2
 98 [-]: MOVE      R11 R2       ; R11 := R2
 99 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
100 [-]: GETGLOBAL R8 K23       ; R8 := 0xF595ADDE
101 [-]: GETTABLE  R9 R0 K12    ; R9 := R0["mMovie"]
102 [-]: SELF      R9 R9 K24    ; R10 := R9; R9 := R9["0x6B7B470B"]
103 [-]: GETTABLE  R11 R0 K25   ; R11 := R0["mClipName"]
104 [-]: LOADK     R12 K26      ; R12 := "_screenX"
105 [-]: CALL      R9 4 0       ; R9,... := R9(R10,R11,R12)
106 [-]: CALL      R8 0 2       ; R8 := R8(R9,...)
107 [-]: GETGLOBAL R9 K23       ; R9 := 0xF595ADDE
108 [-]: GETTABLE  R10 R0 K12   ; R10 := R0["mMovie"]
109 [-]: SELF      R10 R10 K24  ; R11 := R10; R10 := R10["0x6B7B470B"]
110 [-]: GETTABLE  R12 R0 K25   ; R12 := R0["mClipName"]
111 [-]: LOADK     R13 K27      ; R13 := "_screenY"
112 [-]: CALL      R10 4 0      ; R10,... := R10(R11,R12,R13)
113 [-]: CALL      R9 0 2       ; R9 := R9(R10,...)
114 [-]: EQ        1 R8 K4      ; if R8 == nil then PC := 166
115 [-]: JMP       166          ; PC := 166
116 [-]: EQ        1 R9 K4      ; if R9 == nil then PC := 166
117 [-]: JMP       166          ; PC := 166
118 [-]: GETUPVAL  R10 U4       ; R10 := U4
119 [-]: GETTABLE  R10 R10 K28  ; R10 := R10["0x4C8FC6DC"]
120 [-]: GETTABLE  R11 R0 K12   ; R11 := R0["mMovie"]
121 [-]: MOVE      R12 R2       ; R12 := R2
122 [-]: GETTABLE  R13 R0 K29   ; R13 := R0["mWidth"]
123 [-]: DIV       R13 R13 K30  ; R13 := R13 / 2
124 [-]: ADD       R13 R8 R13   ; R13 := R8 + R13
125 [-]: GETTABLE  R14 R0 K31   ; R14 := R0["mHeight"]
126 [-]: DIV       R14 R14 K30  ; R14 := R14 / 2
127 [-]: ADD       R14 R9 R14   ; R14 := R9 + R14
128 [-]: GETTABLE  R15 R0 K29   ; R15 := R0["mWidth"]
129 [-]: GETTABLE  R16 R0 K31   ; R16 := R0["mHeight"]
130 [-]: CALL      R10 7 1      ; R10(R11,R12,R13,R14,R15,R16)
131 [-]: GETGLOBAL R10 K32      ; R10 := _T
132 [-]: SETTABLE  R10 K33 R2   ; R10["InfoPopup_Data"] := R2
133 [-]: GETGLOBAL R10 K32      ; R10 := _T
134 [-]: GETUPVAL  R11 U3       ; R11 := U3
135 [-]: SETTABLE  R10 K34 R11  ; R10["InfoPopup_Grid"] := R11
136 [-]: JMP       166          ; PC := 166
137 [-]: GETGLOBAL R10 K32      ; R10 := _T
138 [-]: SETTABLE  R10 K33 K4   ; R10["InfoPopup_Data"] := nil
139 [-]: GETGLOBAL R10 K35      ; R10 := Engine
140 [-]: GETTABLE  R10 R10 K36  ; R10 := R10["0x9490FE70"]
141 [-]: CALL      R10 1 2      ; R10 := R10()
142 [-]: TEST      R10 0        ; if not R10 then PC := 166
143 [-]: JMP       166          ; PC := 166
144 [-]: GETUPVAL  R10 U3       ; R10 := U3
145 [-]: GETTABLE  R10 R10 K37  ; R10 := R10["mVSId"]
146 [-]: GETTABLE  R11 R0 K38   ; R11 := R0["mId"]
147 [-]: EQ        0 R10 R11    ; if R10 ~= R11 then PC := 153
148 [-]: JMP       153          ; PC := 153
149 [-]: GETUPVAL  R10 U3       ; R10 := U3
150 [-]: SELF      R10 R10 K39  ; R11 := R10; R10 := R10["0xA33A2ECC"]
151 [-]: GETTABLE  R12 R0 K38   ; R12 := R0["mId"]
152 [-]: CALL      R10 3 1      ; R10(R11,R12)
153 [-]: GETTABLE  R10 R0 K7    ; R10 := R0["mType"]
154 [-]: GETUPVAL  R11 U0       ; R11 := U0
155 [-]: GETTABLE  R11 R11 K40  ; R11 := R11["DROP_DOWN"]
156 [-]: EQ        0 R10 R11    ; if R10 ~= R11 then PC := 166
157 [-]: JMP       166          ; PC := 166
158 [-]: GETTABLE  R10 R0 K41   ; R10 := R0["mDropDownMenu"]
159 [-]: EQ        1 R10 K4     ; if R10 == nil then PC := 166
160 [-]: JMP       166          ; PC := 166
161 [-]: GETTABLE  R10 R0 K41   ; R10 := R0["mDropDownMenu"]
162 [-]: SETTABLE  R10 K42 K43  ; R10["mHideSelectCallout"] := "0x1"
163 [-]: GETTABLE  R10 R0 K41   ; R10 := R0["mDropDownMenu"]
164 [-]: SELF      R10 R10 K44  ; R11 := R10; R10 := R10["0xDC99851"]
...
; Max Stack Size:  23
 ...
 28 [-]: LOADK     R13 K12      ; R13 := 44
 29 [-]: TEST      R3 1         ; if R3 then PC := 33
 30 [-]: JMP       33           ; PC := 33
 31 [-]: LOADK     R13 K13      ; R13 := 12
 32 [-]: JMP       37           ; PC := 37
 33 [-]: GETTABLE  R14 R0 K14   ; R14 := R0["mLabel"]
 ...
 42 [-]: SUB       R14 R14 K9   ; R14 := R14 - 2
 43 [-]: ADD       R15 R14 K18  ; R15 := R14 + 25
 44 [-]: TEST      R3 0         ; if not R3 then PC := 50
 45 [-]: JMP       50           ; PC := 50
 46 [-]: ADD       R16 R11 R8   ; R16 := R11 + R8
 47 [-]: ADD       R16 R16 R7   ; R16 := R16 + R7
 48 [-]: TEST      R16 1        ; if R16 then PC := 51
 49 [-]: JMP       51           ; PC := 51
 50 [-]: MOVE      R16 R7       ; R16 := R7
 51 [-]: SUB       R17 R12 R8   ; R17 := R12 - R8
 52 [-]: SUB       R12 R17 R7   ; R12 := R17 - R7
 53 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 54 [-]: MOVE      R19 R2       ; R19 := R2
 55 [-]: LOADK     R20 K20      ; R20 := "Label"
 56 [-]: LOADK     R21 K21      ; R21 := "_y"
 57 [-]: MOVE      R22 R14      ; R22 := R14
 58 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 59 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 60 [-]: MOVE      R19 R2       ; R19 := R2
 61 [-]: LOADK     R20 K22      ; R20 := "Desc"
 62 [-]: LOADK     R21 K21      ; R21 := "_y"
 63 [-]: MOVE      R22 R15      ; R22 := R15
 64 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 65 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 66 [-]: MOVE      R19 R2       ; R19 := R2
 67 [-]: LOADK     R20 K20      ; R20 := "Label"
 68 [-]: LOADK     R21 K23      ; R21 := "_x"
 69 [-]: MOVE      R22 R16      ; R22 := R16
 70 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 71 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 72 [-]: MOVE      R19 R2       ; R19 := R2
 73 [-]: LOADK     R20 K22      ; R20 := "Desc"
 74 [-]: LOADK     R21 K23      ; R21 := "_x"
 75 [-]: MOVE      R22 R16      ; R22 := R16
 76 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 77 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 78 [-]: MOVE      R19 R2       ; R19 := R2
 79 [-]: LOADK     R20 K20      ; R20 := "Label"
 80 [-]: LOADK     R21 K24      ; R21 := "_width"
 81 [-]: MOVE      R22 R12      ; R22 := R12
 82 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 83 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 84 [-]: MOVE      R19 R2       ; R19 := R2
 85 [-]: LOADK     R20 K22      ; R20 := "Desc"
 86 [-]: LOADK     R21 K24      ; R21 := "_width"
 87 [-]: MOVE      R22 R12      ; R22 := R12
 88 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 89 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 90 [-]: MOVE      R19 R2       ; R19 := R2
 91 [-]: LOADK     R20 K25      ; R20 := "Icon"
 92 [-]: LOADK     R21 K23      ; R21 := "_x"
 93 [-]: SUB       R22 R8 R9    ; R22 := R8 - R9
 94 [-]: DIV       R22 R22 K9   ; R22 := R22 / 2
 95 [-]: ADD       R22 R11 R22  ; R22 := R11 + R22
 96 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
 97 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
 98 [-]: MOVE      R19 R2       ; R19 := R2
 99 [-]: LOADK     R20 K25      ; R20 := "Icon"
100 [-]: LOADK     R21 K21      ; R21 := "_y"
101 [-]: SUB       R22 R8 R10   ; R22 := R8 - R10
102 [-]: DIV       R22 R22 K9   ; R22 := R22 / 2
103 [-]: ADD       R22 R6 R22   ; R22 := R6 + R22
104 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
105 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
106 [-]: MOVE      R19 R2       ; R19 := R2
107 [-]: LOADK     R20 K25      ; R20 := "Icon"
108 [-]: LOADK     R21 K24      ; R21 := "_width"
109 [-]: MOVE      R22 R9       ; R22 := R9
110 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
111 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
112 [-]: MOVE      R19 R2       ; R19 := R2
113 [-]: LOADK     R20 K25      ; R20 := "Icon"
114 [-]: LOADK     R21 K26      ; R21 := "_height"
115 [-]: MOVE      R22 R10      ; R22 := R10
116 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
117 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
118 [-]: MOVE      R19 R2       ; R19 := R2
119 [-]: LOADK     R20 K27      ; R20 := "IconMask"
120 [-]: LOADK     R21 K23      ; R21 := "_x"
121 [-]: MOVE      R22 R11      ; R22 := R11
122 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
123 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
124 [-]: MOVE      R19 R2       ; R19 := R2
125 [-]: LOADK     R20 K27      ; R20 := "IconMask"
126 [-]: LOADK     R21 K21      ; R21 := "_y"
127 [-]: MOVE      R22 R6       ; R22 := R6
128 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
129 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
130 [-]: MOVE      R19 R2       ; R19 := R2
131 [-]: LOADK     R20 K27      ; R20 := "IconMask"
132 [-]: LOADK     R21 K24      ; R21 := "_width"
133 [-]: MOVE      R22 R8       ; R22 := R8
134 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
135 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
136 [-]: MOVE      R19 R2       ; R19 := R2
137 [-]: LOADK     R20 K27      ; R20 := "IconMask"
138 [-]: LOADK     R21 K26      ; R21 := "_height"
139 [-]: MOVE      R22 R8       ; R22 := R8
140 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
141 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
142 [-]: MOVE      R19 R2       ; R19 := R2
143 [-]: LOADK     R20 K28      ; R20 := "Divider"
144 [-]: LOADK     R21 K23      ; R21 := "_x"
145 [-]: ADD       R22 R11 R8   ; R22 := R11 + R8
146 [-]: SUB       R22 R22 K29  ; R22 := R22 - 1
147 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
148 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
149 [-]: MOVE      R19 R2       ; R19 := R2
150 [-]: LOADK     R20 K28      ; R20 := "Divider"
151 [-]: LOADK     R21 K26      ; R21 := "_height"
152 [-]: SUB       R22 R5 K30   ; R22 := R5 - 10
153 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
154 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
155 [-]: MOVE      R19 R2       ; R19 := R2
156 [-]: LOADK     R20 K31      ; R20 := "HighlightMask"
157 [-]: LOADK     R21 K23      ; R21 := "_x"
158 [-]: SUB       R22 R11 R6   ; R22 := R11 - R6
159 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
160 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
161 [-]: MOVE      R19 R2       ; R19 := R2
162 [-]: LOADK     R20 K31      ; R20 := "HighlightMask"
163 [-]: LOADK     R21 K24      ; R21 := "_width"
164 [-]: ADD       R22 R8 R6    ; R22 := R8 + R6
165 [-]: SUB       R22 R22 K29  ; R22 := R22 - 1
166 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
167 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
168 [-]: MOVE      R19 R2       ; R19 := R2
169 [-]: LOADK     R20 K32      ; R20 := "Highlight"
170 [-]: LOADK     R21 K21      ; R21 := "_y"
171 [-]: MUL       R22 R6 K9    ; R22 := R6 * 2
172 [-]: ADD       R22 R8 R22   ; R22 := R8 + R22
173 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
174 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
175 [-]: MOVE      R19 R2       ; R19 := R2
176 [-]: LOADK     R20 K32      ; R20 := "Highlight"
177 [-]: LOADK     R21 K23      ; R21 := "_x"
178 [-]: DIV       R22 R8 K9    ; R22 := R8 / 2
179 [-]: ADD       R22 R11 R22  ; R22 := R11 + R22
180 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
181 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
182 [-]: MOVE      R19 R2       ; R19 := R2
183 [-]: LOADK     R20 K32      ; R20 := "Highlight"
184 [-]: LOADK     R21 K24      ; R21 := "_width"
185 [-]: LOADK     R22 K33      ; R22 := 250
186 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
187 [-]: SELF      R17 R1 K19   ; R18 := R1; R17 := R1["0x880196A7"]
188 [-]: MOVE      R19 R2       ; R19 := R2
189 [-]: LOADK     R20 K34      ; R20 := "ColorButtons"
190 [-]: LOADK     R21 K23      ; R21 := "_x"
191 [-]: MOVE      R22 R4       ; R22 := R4
192 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
...
; Max Stack Size:  5
 ...
 13 [-]: SELF      R3 R1 K4     ; R4 := R1; R3 := R1["0x3077BE70"]
 14 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 15 [-]: SETTABLE  R2 K3 R3     ; R2["Type"] := R3
 16 [-]: SETTABLE  R2 K5 R1     ; R2["StoreItem"] := R1
 17 [-]: MOVE      R1 R2        ; R1 := R2
 18 [-]: SELF      R2 R0 K6     ; R3 := R0; R2 := R0["0xF0B150AC"]
 19 [-]: MOVE      R4 R1        ; R4 := R1
 20 [-]: CALL      R2 3 1       ; R2(R3,R4)
 21 [-]: RETURN    R0 1         ; return 
