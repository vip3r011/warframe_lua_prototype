...
; Command line was: -dis C:\war2\raw\Lotus\Interface\SyndicateUtilities.lua 
...
; Max Stack Size:  24
 ...
 28 [-]: TEST      R7 1         ; if R7 then PC := 473
 29 [-]: JMP       473          ; PC := 473
 ...
 54 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
 55 [-]: SETTABLE  R7 K16 R8    ; R7["MOD"] := R8
 56 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 57 [-]: SETTABLE  R8 K10 K20   ; R8["Id"] := 3
 58 [-]: NEWTABLE  R9 1 0       ; R9 := {}
 59 [-]: GETGLOBAL R10 K21      ; R10 := gLotusWeaponBladeType
 60 [-]: SETLIST   R9 1 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
 61 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
 62 [-]: SETTABLE  R7 K19 R8    ; R7["STRIKE"] := R8
 63 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 64 [-]: SETTABLE  R8 K10 K23   ; R8["Id"] := 4
 65 [-]: NEWTABLE  R9 1 0       ; R9 := {}
 66 [-]: GETGLOBAL R10 K24      ; R10 := gLotusWeaponHiltType
 67 [-]: SETLIST   R9 1 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
 68 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
 69 [-]: SETTABLE  R7 K22 R8    ; R7["GRIP"] := R8
 70 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 71 [-]: SETTABLE  R8 K10 K26   ; R8["Id"] := 5
 72 [-]: NEWTABLE  R9 0 0       ; R9 := {}
 73 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
 74 [-]: LOADK     R11 K28      ; R11 := "/Lotus/Types/Weapon/LotusWeaponWeight"
 75 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
 76 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
 77 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
 78 [-]: SETTABLE  R7 K25 R8    ; R7["LINK"] := R8
 79 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 80 [-]: SETTABLE  R8 K10 K30   ; R8["Id"] := 6
 81 [-]: NEWTABLE  R9 0 0       ; R9 := {}
 82 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
 83 [-]: LOADK     R11 K31      ; R11 := "/Lotus/Types/Game/BaseCosmeticEnhancer"
 84 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
 85 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
 86 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
 87 [-]: SETTABLE  R7 K29 R8    ; R7["ARCANE"] := R8
 88 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 89 [-]: SETTABLE  R8 K10 K33   ; R8["Id"] := 7
 90 [-]: NEWTABLE  R9 3 0       ; R9 := {}
 91 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
 92 [-]: LOADK     R11 K34      ; R11 := "/Lotus/Weapons/Sentients/OperatorAmplifiers/OperatorAmpWeapon"
 93 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 94 [-]: GETGLOBAL R11 K27      ; R11 := 0x2C00D429
 95 [-]: LOADK     R12 K35      ; R12 := "/Lotus/Types/Weapon/LotusWeaponAmpOculus"
 96 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 97 [-]: GETGLOBAL R12 K27      ; R12 := 0x2C00D429
 98 [-]: LOADK     R13 K36      ; R13 := "/Lotus/Types/Weapon/LotusWeaponAmpCore"
 99 [-]: CALL      R12 2 2      ; R12 := R12(R13)
100 [-]: GETGLOBAL R13 K27      ; R13 := 0x2C00D429
101 [-]: LOADK     R14 K37      ; R14 := "/Lotus/Types/Weapon/LotusWeaponAmpBrace"
102 [-]: CALL      R13 2 0      ; R13,... := R13(R14)
103 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
104 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
105 [-]: SETTABLE  R7 K32 R8    ; R7["AMPS"] := R8
106 [-]: NEWTABLE  R8 0 2       ; R8 := {}
107 [-]: SETTABLE  R8 K10 K39   ; R8["Id"] := 8
108 [-]: NEWTABLE  R9 1 0       ; R9 := {}
109 [-]: GETGLOBAL R10 K40      ; R10 := gLotusSuitCustomizationType
110 [-]: SETLIST   R9 1 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
111 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
112 [-]: SETTABLE  R7 K38 R8    ; R7["APPEARANCE"] := R8
113 [-]: NEWTABLE  R8 0 2       ; R8 := {}
114 [-]: SETTABLE  R8 K10 K42   ; R8["Id"] := 9
115 [-]: NEWTABLE  R9 0 0       ; R9 := {}
116 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
117 [-]: SETTABLE  R7 K41 R8    ; R7["WEAPON"] := R8
118 [-]: NEWTABLE  R8 0 2       ; R8 := {}
119 [-]: SETTABLE  R8 K10 K44   ; R8["Id"] := 10
120 [-]: NEWTABLE  R9 0 0       ; R9 := {}
121 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
122 [-]: LOADK     R11 K45      ; R11 := "/Lotus/Types/Weapon/LotusGunBarrel"
123 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
124 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
125 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
126 [-]: SETTABLE  R7 K43 R8    ; R7["CHAMBER"] := R8
127 [-]: NEWTABLE  R8 0 2       ; R8 := {}
128 [-]: SETTABLE  R8 K10 K47   ; R8["Id"] := 11
129 [-]: NEWTABLE  R9 0 0       ; R9 := {}
130 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
131 [-]: LOADK     R11 K48      ; R11 := "/Lotus/Types/Weapon/LotusGunSecondaryHandle"
132 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
133 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
134 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
135 [-]: SETTABLE  R7 K46 R8    ; R7["HANDLE"] := R8
136 [-]: NEWTABLE  R8 0 2       ; R8 := {}
137 [-]: SETTABLE  R8 K10 K50   ; R8["Id"] := 12
138 [-]: NEWTABLE  R9 0 0       ; R9 := {}
139 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
140 [-]: LOADK     R11 K51      ; R11 := "/Lotus/Types/Weapon/LotusGunClip"
141 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
142 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
143 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
144 [-]: SETTABLE  R7 K49 R8    ; R7["LOADER"] := R8
145 [-]: NEWTABLE  R8 0 2       ; R8 := {}
146 [-]: SETTABLE  R8 K10 K53   ; R8["Id"] := 13
147 [-]: NEWTABLE  R9 0 0       ; R9 := {}
148 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
149 [-]: LOADK     R11 K54      ; R11 := "/Lotus/Types/Game/MoaPetParts/LotusMoaPetHead"
150 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
151 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
152 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
153 [-]: SETTABLE  R7 K52 R8    ; R7["MODEL"] := R8
154 [-]: NEWTABLE  R8 0 2       ; R8 := {}
155 [-]: SETTABLE  R8 K10 K56   ; R8["Id"] := 14
156 [-]: NEWTABLE  R9 0 0       ; R9 := {}
157 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
158 [-]: LOADK     R11 K57      ; R11 := "/Lotus/Types/Game/MoaPetParts/LotusMoaPetEngine"
159 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
160 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
161 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
162 [-]: SETTABLE  R7 K55 R8    ; R7["CORE"] := R8
163 [-]: NEWTABLE  R8 0 2       ; R8 := {}
164 [-]: SETTABLE  R8 K10 K59   ; R8["Id"] := 15
165 [-]: NEWTABLE  R9 0 0       ; R9 := {}
166 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
167 [-]: LOADK     R11 K60      ; R11 := "/Lotus/Types/Game/MoaPetParts/LotusMoaPetPayload"
168 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
169 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
170 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
171 [-]: SETTABLE  R7 K58 R8    ; R7["GYRO"] := R8
172 [-]: NEWTABLE  R8 0 2       ; R8 := {}
173 [-]: SETTABLE  R8 K10 K62   ; R8["Id"] := 16
174 [-]: NEWTABLE  R9 0 0       ; R9 := {}
175 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
176 [-]: LOADK     R11 K63      ; R11 := "/Lotus/Types/Game/MoaPetParts/LotusMoaPetLeg"
177 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
178 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
179 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
180 [-]: SETTABLE  R7 K61 R8    ; R7["BRACKET"] := R8
181 [-]: NEWTABLE  R8 0 2       ; R8 := {}
182 [-]: SETTABLE  R8 K10 K65   ; R8["Id"] := 17
183 [-]: NEWTABLE  R9 0 0       ; R9 := {}
184 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
185 [-]: LOADK     R11 K66      ; R11 := "/Lotus/Types/Game/HoverboardParts/LotusHoverboardDeck"
186 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
187 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
188 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
189 [-]: SETTABLE  R7 K64 R8    ; R7["BOARD"] := R8
190 [-]: NEWTABLE  R8 0 2       ; R8 := {}
191 [-]: SETTABLE  R8 K10 K68   ; R8["Id"] := 18
192 [-]: NEWTABLE  R9 0 0       ; R9 := {}
193 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
194 [-]: LOADK     R11 K69      ; R11 := "/Lotus/Types/Game/HoverboardParts/LotusHoverboardEngine"
195 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
196 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
197 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
198 [-]: SETTABLE  R7 K67 R8    ; R7["REACTOR"] := R8
199 [-]: NEWTABLE  R8 0 2       ; R8 := {}
200 [-]: SETTABLE  R8 K10 K71   ; R8["Id"] := 19
201 [-]: NEWTABLE  R9 0 0       ; R9 := {}
202 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
203 [-]: LOADK     R11 K72      ; R11 := "/Lotus/Types/Game/HoverboardParts/LotusHoverboardFront"
204 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
205 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
206 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
207 [-]: SETTABLE  R7 K70 R8    ; R7["NOSE"] := R8
208 [-]: NEWTABLE  R8 0 2       ; R8 := {}
209 [-]: SETTABLE  R8 K10 K74   ; R8["Id"] := 20
210 [-]: NEWTABLE  R9 0 0       ; R9 := {}
211 [-]: GETGLOBAL R10 K27      ; R10 := 0x2C00D429
212 [-]: LOADK     R11 K75      ; R11 := "/Lotus/Types/Game/HoverboardParts/LotusHoverboardJet"
213 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
214 [-]: SETLIST   R9 0 1       ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 0
215 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
216 [-]: SETTABLE  R7 K73 R8    ; R7["JET"] := R8
217 [-]: NEWTABLE  R8 0 2       ; R8 := {}
218 [-]: SETTABLE  R8 K10 K77   ; R8["Id"] := 21
219 [-]: NEWTABLE  R9 0 0       ; R9 := {}
220 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
221 [-]: SETTABLE  R7 K76 R8    ; R7["MISC"] := R8
222 [-]: NEWTABLE  R8 0 2       ; R8 := {}
223 [-]: SETTABLE  R8 K10 K79   ; R8["Id"] := 22
224 [-]: NEWTABLE  R9 0 0       ; R9 := {}
225 [-]: SETTABLE  R8 K12 R9    ; R8["Types"] := R9
226 [-]: SETTABLE  R7 K78 R8    ; R7["RECOVERED"] := R8
227 [-]: GETTABLE  R8 R3 K80    ; R8 := R3["Syndicate"]
228 [-]: SELF      R8 R8 K81    ; R9 := R8; R8 := R8["0xE6F0FF83"]
229 [-]: CALL      R8 2 2       ; R8 := R8(R9)
230 [-]: GETGLOBAL R9 K82       ; R9 := 0xEC274B1A
231 [-]: LOADK     R10 K83      ; R10 := "CetusSyndicate"
232 [-]: CALL      R9 2 2       ; R9 := R9(R10)
233 [-]: EQ        1 R8 R9      ; if R8 == R9 then PC := 236
234 [-]: JMP       236          ; PC := 236
235 [-]: MOVE      R9 R0        ; R9 := R0
236 [-]: MOVE      R9 R1        ; R9 := R1
237 [-]: GETGLOBAL R10 K82      ; R10 := 0xEC274B1A
238 [-]: LOADK     R11 K84      ; R11 := "QuillsSyndicate"
239 [-]: CALL      R10 2 2      ; R10 := R10(R11)
240 [-]: EQ        1 R8 R10     ; if R8 == R10 then PC := 243
241 [-]: JMP       243          ; PC := 243
242 [-]: MOVE      R10 R0       ; R10 := R0
243 [-]: MOVE      R10 R1       ; R10 := R1
244 [-]: GETGLOBAL R11 K82      ; R11 := 0xEC274B1A
245 [-]: LOADK     R12 K85      ; R12 := "SolarisSyndicate"
246 [-]: CALL      R11 2 2      ; R11 := R11(R12)
247 [-]: EQ        1 R8 R11     ; if R8 == R11 then PC := 250
248 [-]: JMP       250          ; PC := 250
249 [-]: MOVE      R11 R0       ; R11 := R0
250 [-]: MOVE      R11 R1       ; R11 := R1
251 [-]: GETGLOBAL R12 K82      ; R12 := 0xEC274B1A
252 [-]: LOADK     R13 K86      ; R13 := "VoxSyndicate"
253 [-]: CALL      R12 2 2      ; R12 := R12(R13)
254 [-]: EQ        1 R8 R12     ; if R8 == R12 then PC := 257
255 [-]: JMP       257          ; PC := 257
256 [-]: MOVE      R12 R0       ; R12 := R0
257 [-]: MOVE      R12 R1       ; R12 := R1
258 [-]: LOADNIL   R13 R13      ; R13 := nil
259 [-]: TEST      R9 1         ; if R9 then PC := 267
260 [-]: JMP       267          ; PC := 267
261 [-]: TEST      R10 1        ; if R10 then PC := 267
262 [-]: JMP       267          ; PC := 267
263 [-]: TEST      R11 1        ; if R11 then PC := 267
264 [-]: JMP       267          ; PC := 267
265 [-]: TEST      R12 0        ; if not R12 then PC := 339
266 [-]: JMP       339          ; PC := 339
267 [-]: NEWTABLE  R14 0 5      ; R14 := {}
268 [-]: GETTABLE  R15 R7 K9    ; R15 := R7["ALL"]
269 [-]: GETTABLE  R15 R15 K10  ; R15 := R15["Id"]
270 [-]: SETTABLE  R14 K9 R15   ; R14["ALL"] := R15
271 [-]: GETTABLE  R15 R7 K29   ; R15 := R7["ARCANE"]
272 [-]: GETTABLE  R15 R15 K10  ; R15 := R15["Id"]
273 [-]: SETTABLE  R14 K29 R15  ; R14["ARCANE"] := R15
274 [-]: GETTABLE  R15 R7 K32   ; R15 := R7["AMPS"]
275 [-]: GETTABLE  R15 R15 K10  ; R15 := R15["Id"]
276 [-]: SETTABLE  R14 K32 R15  ; R14["AMPS"] := R15
277 [-]: GETTABLE  R15 R7 K38   ; R15 := R7["APPEARANCE"]
278 [-]: GETTABLE  R15 R15 K10  ; R15 := R15["Id"]
279 [-]: SETTABLE  R14 K38 R15  ; R14["APPEARANCE"] := R15
280 [-]: GETTABLE  R15 R7 K76   ; R15 := R7["MISC"]
281 [-]: GETTABLE  R15 R15 K10  ; R15 := R15["Id"]
282 [-]: SETTABLE  R14 K76 R15  ; R14["MISC"] := R15
283 [-]: MOVE      R13 R14      ; R13 := R14
284 [-]: GETGLOBAL R14 K87      ; R14 := _T
285 [-]: GETTABLE  R14 R14 K88  ; R14 := R14["SyndicateFavorsTag"]
286 [-]: GETGLOBAL R15 K82      ; R15 := 0xEC274B1A
287 [-]: LOADK     R16 K89      ; R16 := "Weaponsmith"
288 [-]: CALL      R15 2 2      ; R15 := R15(R16)
289 [-]: EQ        1 R14 R15    ; if R14 == R15 then PC := 292
290 [-]: JMP       292          ; PC := 292
291 [-]: MOVE      R15 R0       ; R15 := R0
292 [-]: MOVE      R15 R1       ; R15 := R1
293 [-]: GETGLOBAL R16 K82      ; R16 := 0xEC274B1A
294 [-]: LOADK     R17 K90      ; R17 := "MoaVendor"
295 [-]: CALL      R16 2 2      ; R16 := R16(R17)
296 [-]: EQ        1 R14 R16    ; if R14 == R16 then PC := 299
297 [-]: JMP       299          ; PC := 299
298 [-]: MOVE      R16 R0       ; R16 := R0
299 [-]: MOVE      R16 R1       ; R16 := R1
300 [-]: TEST      R15 0        ; if not R15 then PC := 324
301 [-]: JMP       324          ; PC := 324
302 [-]: TEST      R11 0        ; if not R11 then PC := 314
303 [-]: JMP       314          ; PC := 314
304 [-]: GETTABLE  R17 R7 K43   ; R17 := R7["CHAMBER"]
305 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
306 [-]: SETTABLE  R13 K43 R17  ; R13["CHAMBER"] := R17
307 [-]: GETTABLE  R17 R7 K46   ; R17 := R7["HANDLE"]
308 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
309 [-]: SETTABLE  R13 K46 R17  ; R13["HANDLE"] := R17
310 [-]: GETTABLE  R17 R7 K49   ; R17 := R7["LOADER"]
311 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
312 [-]: SETTABLE  R13 K49 R17  ; R13["LOADER"] := R17
313 [-]: JMP       390          ; PC := 390
314 [-]: GETTABLE  R17 R7 K19   ; R17 := R7["STRIKE"]
315 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
316 [-]: SETTABLE  R13 K19 R17  ; R13["STRIKE"] := R17
317 [-]: GETTABLE  R17 R7 K22   ; R17 := R7["GRIP"]
318 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
319 [-]: SETTABLE  R13 K22 R17  ; R13["GRIP"] := R17
320 [-]: GETTABLE  R17 R7 K25   ; R17 := R7["LINK"]
321 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
322 [-]: SETTABLE  R13 K25 R17  ; R13["LINK"] := R17
323 [-]: JMP       390          ; PC := 390
324 [-]: TEST      R16 0        ; if not R16 then PC := 390
325 [-]: JMP       390          ; PC := 390
326 [-]: GETTABLE  R17 R7 K52   ; R17 := R7["MODEL"]
327 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
328 [-]: SETTABLE  R13 K52 R17  ; R13["MODEL"] := R17
329 [-]: GETTABLE  R17 R7 K55   ; R17 := R7["CORE"]
330 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
331 [-]: SETTABLE  R13 K55 R17  ; R13["CORE"] := R17
332 [-]: GETTABLE  R17 R7 K58   ; R17 := R7["GYRO"]
333 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
334 [-]: SETTABLE  R13 K58 R17  ; R13["GYRO"] := R17
335 [-]: GETTABLE  R17 R7 K61   ; R17 := R7["BRACKET"]
336 [-]: GETTABLE  R17 R17 K10  ; R17 := R17["Id"]
337 [-]: SETTABLE  R13 K61 R17  ; R13["BRACKET"] := R17
338 [-]: JMP       390          ; PC := 390
339 [-]: GETGLOBAL R17 K87      ; R17 := _T
340 [-]: GETTABLE  R17 R17 K88  ; R17 := R17["SyndicateFavorsTag"]
341 [-]: GETGLOBAL R18 K82      ; R18 := 0xEC274B1A
342 [-]: LOADK     R19 K91      ; R19 := "SupplyDrop"
343 [-]: CALL      R18 2 2      ; R18 := R18(R19)
344 [-]: EQ        0 R17 R18    ; if R17 ~= R18 then PC := 352
345 [-]: JMP       352          ; PC := 352
346 [-]: NEWTABLE  R17 0 1      ; R17 := {}
347 [-]: GETTABLE  R18 R7 K9    ; R18 := R7["ALL"]
348 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
349 [-]: SETTABLE  R17 K9 R18   ; R17["ALL"] := R18
350 [-]: MOVE      R13 R17      ; R13 := R17
351 [-]: JMP       390          ; PC := 390
352 [-]: NEWTABLE  R17 0 5      ; R17 := {}
353 [-]: GETTABLE  R18 R7 K9    ; R18 := R7["ALL"]
354 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
355 [-]: SETTABLE  R17 K9 R18   ; R17["ALL"] := R18
356 [-]: GETTABLE  R18 R7 K13   ; R18 := R7["SIGIL"]
357 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
358 [-]: SETTABLE  R17 K13 R18  ; R17["SIGIL"] := R18
359 [-]: GETTABLE  R18 R7 K16   ; R18 := R7["MOD"]
360 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
361 [-]: SETTABLE  R17 K16 R18  ; R17["MOD"] := R18
362 [-]: GETTABLE  R18 R7 K76   ; R18 := R7["MISC"]
363 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
364 [-]: SETTABLE  R17 K76 R18  ; R17["MISC"] := R18
365 [-]: GETTABLE  R18 R7 K78   ; R18 := R7["RECOVERED"]
366 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
367 [-]: SETTABLE  R17 K78 R18  ; R17["RECOVERED"] := R18
368 [-]: MOVE      R13 R17      ; R13 := R17
369 [-]: GETGLOBAL R17 K82      ; R17 := 0xEC274B1A
370 [-]: LOADK     R18 K92      ; R18 := "VentKidsSyndicate"
371 [-]: CALL      R17 2 2      ; R17 := R17(R18)
372 [-]: EQ        1 R8 R17     ; if R8 == R17 then PC := 375
373 [-]: JMP       375          ; PC := 375
374 [-]: MOVE      R17 R0       ; R17 := R0
375 [-]: MOVE      R17 R1       ; R17 := R1
376 [-]: TEST      R17 0        ; if not R17 then PC := 390
377 [-]: JMP       390          ; PC := 390
378 [-]: GETTABLE  R18 R7 K64   ; R18 := R7["BOARD"]
379 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
380 [-]: SETTABLE  R13 K64 R18  ; R13["BOARD"] := R18
381 [-]: GETTABLE  R18 R7 K67   ; R18 := R7["REACTOR"]
382 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
383 [-]: SETTABLE  R13 K67 R18  ; R13["REACTOR"] := R18
384 [-]: GETTABLE  R18 R7 K70   ; R18 := R7["NOSE"]
385 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
386 [-]: SETTABLE  R13 K70 R18  ; R13["NOSE"] := R18
387 [-]: GETTABLE  R18 R7 K73   ; R18 := R7["JET"]
388 [-]: GETTABLE  R18 R18 K10  ; R18 := R18["Id"]
389 [-]: SETTABLE  R13 K73 R18  ; R13["JET"] := R18
390 [-]: GETGLOBAL R18 K87      ; R18 := _T
391 [-]: SETTABLE  R18 K93 R13  ; R18["FavorCategories"] := R13
392 [-]: SELF      R18 R6 K6    ; R19 := R6; R18 := R6["0x458F27A9"]
393 [-]: LOADK     R20 K94      ; R20 := "SetVendorCategories"
394 [-]: LOADK     R21 K93      ; R21 := "FavorCategories"
395 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
396 [-]: GETGLOBAL R18 K87      ; R18 := _T
397 [-]: CLOSURE   R19 0        ; R19 := closure(Function #13.1)
398 [-]: SETTABLE  R18 K95 R19  ; R18["GetFavorsSort"] := R19
399 [-]: SELF      R18 R6 K6    ; R19 := R6; R18 := R6["0x458F27A9"]
400 [-]: LOADK     R20 K96      ; R20 := "SetVendorSortBys"
401 [-]: LOADK     R21 K95      ; R21 := "GetFavorsSort"
402 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
403 [-]: GETTABLE  R18 R3 K80   ; R18 := R3["Syndicate"]
404 [-]: SELF      R18 R18 K97  ; R19 := R18; R18 := R18["0xBCEA843D"]
405 [-]: CALL      R18 2 2      ; R18 := R18(R19)
406 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
407 [-]: LOADK     R21 K98      ; R21 := "LoadVendorManifest"
408 [-]: SELF      R22 R18 K99  ; R23 := R18; R22 := R18["0x1B252E3C"]
409 [-]: CALL      R22 2 0      ; R22,... := R22(R23)
410 [-]: CALL      R19 0 1      ; R19(R20,...)
411 [-]: GETGLOBAL R19 K87      ; R19 := _T
412 [-]: CLOSURE   R20 1        ; R20 := closure(Function #13.2)
413 [-]: MOVE      R0 R3        ; R0 := R3
414 [-]: MOVE      R0 R18       ; R0 := R18
415 [-]: MOVE      R0 R5        ; R0 := R5
416 [-]: GETUPVAL  R0 U0        ; R0 := U0
417 [-]: MOVE      R0 R2        ; R0 := R2
418 [-]: MOVE      R0 R8        ; R0 := R8
419 [-]: MOVE      R0 R7        ; R0 := R7
420 [-]: GETUPVAL  R0 U1        ; R0 := U1
421 [-]: SETTABLE  R19 K100 R20 ; R19["GetFavorsInfo"] := R20
422 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
423 [-]: LOADK     R21 K101     ; R21 := "SetVendorInfoFunction"
424 [-]: LOADK     R22 K100     ; R22 := "GetFavorsInfo"
425 [-]: CALL      R19 4 1      ; R19(R20,R21,R22)
426 [-]: GETGLOBAL R19 K87      ; R19 := _T
427 [-]: CLOSURE   R20 2        ; R20 := closure(Function #13.3)
428 [-]: MOVE      R0 R3        ; R0 := R3
429 [-]: GETUPVAL  R0 U2        ; R0 := U2
430 [-]: GETUPVAL  R0 U0        ; R0 := U0
431 [-]: GETUPVAL  R0 U3        ; R0 := U3
432 [-]: SETTABLE  R19 K102 R20 ; R19["UpdateInfoPanel"] := R20
433 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
434 [-]: LOADK     R21 K103     ; R21 := "SetInfoPanelUpdateFunction"
435 [-]: LOADK     R22 K102     ; R22 := "UpdateInfoPanel"
436 [-]: CALL      R19 4 1      ; R19(R20,R21,R22)
437 [-]: GETGLOBAL R19 K87      ; R19 := _T
438 [-]: CLOSURE   R20 3        ; R20 := closure(Function #13.4)
439 [-]: MOVE      R0 R3        ; R0 := R3
440 [-]: GETUPVAL  R0 U0        ; R0 := U0
441 [-]: MOVE      R0 R2        ; R0 := R2
442 [-]: SETTABLE  R19 K104 R20 ; R19["BuyVendorItem"] := R20
443 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
444 [-]: LOADK     R21 K105     ; R21 := "SetBuyItemFunction"
445 [-]: LOADK     R22 K104     ; R22 := "BuyVendorItem"
446 [-]: CALL      R19 4 1      ; R19(R20,R21,R22)
447 [-]: GETGLOBAL R19 K87      ; R19 := _T
448 [-]: SETTABLE  R19 K106 K107; R19["SyndStoreMadePurchase"] := "0x0"
449 [-]: GETGLOBAL R19 K87      ; R19 := _T
450 [-]: CLOSURE   R20 4        ; R20 := closure(Function #13.5)
451 [-]: MOVE      R0 R2        ; R0 := R2
452 [-]: GETUPVAL  R0 U4        ; R0 := U4
453 [-]: MOVE      R0 R3        ; R0 := R3
454 [-]: MOVE      R0 R4        ; R0 := R4
455 [-]: MOVE      R0 R6        ; R0 := R6
456 [-]: SETTABLE  R19 K108 R20 ; R19["OnBuyVendorItem"] := R20
457 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
458 [-]: LOADK     R21 K109     ; R21 := "SetOnBuyItemFunction"
459 [-]: LOADK     R22 K108     ; R22 := "OnBuyVendorItem"
460 [-]: CALL      R19 4 1      ; R19(R20,R21,R22)
461 [-]: GETGLOBAL R19 K87      ; R19 := _T
462 [-]: CLOSURE   R20 5        ; R20 := closure(Function #13.6)
463 [-]: MOVE      R0 R2        ; R0 := R2
464 [-]: GETUPVAL  R0 U4        ; R0 := U4
465 [-]: MOVE      R0 R3        ; R0 := R3
466 [-]: MOVE      R0 R4        ; R0 := R4
467 [-]: SETTABLE  R19 K110 R20 ; R19["OnCloseFunction"] := R20
468 [-]: SELF      R19 R6 K6    ; R20 := R6; R19 := R6["0x458F27A9"]
469 [-]: LOADK     R21 K111     ; R21 := "SetOnCloseFunction"
470 [-]: LOADK     R22 K110     ; R22 := "OnCloseFunction"
471 [-]: CALL      R19 4 1      ; R19(R20,R21,R22)
472 [-]: CLOSE     R7           ; SAVE R7,...
473 [-]: RETURN    R6 2         ; return R6
