...
; Command line was: -dis C:\war2\raw\Lotus\Interface\ResourceDrone.lua 
...
158 [-]: SETGLOBAL R48 K33      ; DeployResourceDrone := R48
159 [-]: SETGLOBAL R48 K34      ; 0xA4D1C31C := R48
160 [-]: CLOSURE   R48 21       ; R48 := closure(Function #22)
...
170 [-]: CLOSURE   R50 23       ; R50 := closure(Function #24)
...
180 [-]: SETGLOBAL R51 K35      ; OnCollectNextActiveDrone := R51
181 [-]: SETGLOBAL R51 K36      ; 0xA01D0538 := R51
...
188 [-]: SETGLOBAL R51 K37      ; OnResourceManifestConfirmed := R51
189 [-]: SETGLOBAL R51 K38      ; 0x8D587E6D := R51
190 [-]: CLOSURE   R51 26       ; R51 := closure(Function #27)
191 [-]: MOVE      R0 R28       ; R0 := R28
192 [-]: MOVE      R0 R1        ; R0 := R1
193 [-]: MOVE      R0 R26       ; R0 := R26
194 [-]: MOVE      R0 R30       ; R0 := R30
195 [-]: CLOSURE   R52 27       ; R52 := closure(Function #28)
196 [-]: MOVE      R0 R28       ; R0 := R28
197 [-]: MOVE      R0 R27       ; R0 := R27
198 [-]: MOVE      R0 R51       ; R0 := R51
199 [-]: CLOSURE   R53 28       ; R53 := closure(Function #29)
...
213 [-]: SETGLOBAL R53 K39      ; OnDeployResourceDronePressed := R53
214 [-]: SETGLOBAL R53 K40      ; 0x5E9ABEC6 := R53
215 [-]: CLOSURE   R53 29       ; R53 := closure(Function #30)
216 [-]: CLOSURE   R54 30       ; R54 := closure(Function #31)
217 [-]: MOVE      R0 R22       ; R0 := R22
218 [-]: MOVE      R0 R4        ; R0 := R4
219 [-]: CLOSURE   R35 31       ; R35 := closure(Function #32)
...
229 [-]: CLOSURE   R55 32       ; R55 := closure(Function #33)
230 [-]: MOVE      R0 R22       ; R0 := R22
231 [-]: MOVE      R0 R4        ; R0 := R4
232 [-]: CLOSURE   R56 33       ; R56 := closure(Function #34)
...
239 [-]: CLOSURE   R57 34       ; R57 := closure(Function #35)
240 [-]: MOVE      R0 R35       ; R0 := R35
241 [-]: SETGLOBAL R57 K41      ; OnRegionZoomIn := R57
242 [-]: SETGLOBAL R57 K42      ; 0xA3271454 := R57
243 [-]: CLOSURE   R57 35       ; R57 := closure(Function #36)
244 [-]: MOVE      R0 R56       ; R0 := R56
245 [-]: SETGLOBAL R57 K43      ; OnRegionZoomOut := R57
246 [-]: SETGLOBAL R57 K44      ; 0x7D2562ED := R57
247 [-]: CLOSURE   R57 36       ; R57 := closure(Function #37)
248 [-]: SETGLOBAL R57 K45      ; IsInputBlocked := R57
249 [-]: SETGLOBAL R57 K46      ; 0x6FE7E740 := R57
250 [-]: CLOSURE   R57 37       ; R57 := closure(Function #38)
251 [-]: MOVE      R0 R11       ; R0 := R11
252 [-]: MOVE      R0 R12       ; R0 := R12
253 [-]: MOVE      R0 R32       ; R0 := R32
254 [-]: MOVE      R0 R1        ; R0 := R1
255 [-]: MOVE      R0 R8        ; R0 := R8
256 [-]: SETGLOBAL R57 K47      ; RollOverShowDrone := R57
257 [-]: SETGLOBAL R57 K48      ; 0xFFD5E83A := R57
258 [-]: CLOSURE   R57 38       ; R57 := closure(Function #39)
259 [-]: SETGLOBAL R57 K49      ; RollOutShowDrone := R57
260 [-]: SETGLOBAL R57 K50      ; 0x3A822322 := R57
261 [-]: CLOSURE   R33 39       ; R33 := closure(Function #40)
...
269 [-]: CLOSURE   R57 40       ; R57 := closure(Function #41)
270 [-]: MOVE      R0 R18       ; R0 := R18
271 [-]: MOVE      R0 R21       ; R0 := R21
272 [-]: MOVE      R0 R23       ; R0 := R23
273 [-]: MOVE      R0 R24       ; R0 := R24
274 [-]: CLOSURE   R34 41       ; R34 := closure(Function #42)
275 [-]: MOVE      R0 R23       ; R0 := R23
276 [-]: MOVE      R0 R24       ; R0 := R24
277 [-]: MOVE      R0 R3        ; R0 := R3
278 [-]: CLOSURE   R58 42       ; R58 := closure(Function #43)
279 [-]: MOVE      R0 R33       ; R0 := R33
280 [-]: SETGLOBAL R58 K51      ; DroneIconFocused := R58
281 [-]: SETGLOBAL R58 K52      ; 0xD6B19348 := R58
282 [-]: CLOSURE   R58 43       ; R58 := closure(Function #44)
283 [-]: MOVE      R0 R34       ; R0 := R34
284 [-]: SETGLOBAL R58 K53      ; DroneIconUnfocused := R58
285 [-]: SETGLOBAL R58 K54      ; 0xACBE5125 := R58
286 [-]: CLOSURE   R36 44       ; R36 := closure(Function #45)
287 [-]: MOVE      R0 R20       ; R0 := R20
288 [-]: MOVE      R0 R33       ; R0 := R33
289 [-]: CLOSURE   R58 45       ; R58 := closure(Function #46)
290 [-]: MOVE      R0 R36       ; R0 := R36
291 [-]: SETGLOBAL R58 K55      ; DroneInfoFocused := R58
292 [-]: SETGLOBAL R58 K56      ; 0x7034CCAD := R58
293 [-]: CLOSURE   R58 46       ; R58 := closure(Function #47)
294 [-]: MOVE      R0 R34       ; R0 := R34
295 [-]: SETGLOBAL R58 K57      ; DroneInfoUnfocused := R58
296 [-]: SETGLOBAL R58 K58      ; 0x2E6A8585 := R58
297 [-]: CLOSURE   R58 47       ; R58 := closure(Function #48)
298 [-]: MOVE      R0 R4        ; R0 := R4
299 [-]: MOVE      R0 R23       ; R0 := R23
300 [-]: CLOSURE   R59 48       ; R59 := closure(Function #49)
301 [-]: MOVE      R0 R58       ; R0 := R58
302 [-]: SETGLOBAL R59 K59      ; IconCacheFlushed := R59
303 [-]: SETGLOBAL R59 K60      ; 0x5C92AF6F := R59
304 [-]: CLOSURE   R59 49       ; R59 := closure(Function #50)
305 [-]: MOVE      R0 R58       ; R0 := R58
306 [-]: SETGLOBAL R59 K61      ; OnGamepadTransition := R59
307 [-]: SETGLOBAL R59 K62      ; 0x98E4F633 := R59
308 [-]: CLOSURE   R59 50       ; R59 := closure(Function #51)
...
319 [-]: CLOSURE   R60 51       ; R60 := closure(Function #52)
...
335 [-]: SETGLOBAL R60 K63      ; Update := R60
336 [-]: SETGLOBAL R60 K64      ; 0x8C7099E9 := R60
337 [-]: CLOSURE   R60 52       ; R60 := closure(Function #53)
338 [-]: MOVE      R0 R25       ; R0 := R25
339 [-]: MOVE      R0 R23       ; R0 := R23
340 [-]: MOVE      R0 R33       ; R0 := R33
341 [-]: MOVE      R0 R4        ; R0 := R4
342 [-]: SETGLOBAL R60 K65      ; onKeyDown_MENU_RTHUMB := R60
343 [-]: SETGLOBAL R60 K66      ; 0x53C99C27 := R60
344 [-]: CLOSURE   R60 53       ; R60 := closure(Function #54)
345 [-]: MOVE      R0 R25       ; R0 := R25
346 [-]: MOVE      R0 R23       ; R0 := R23
347 [-]: MOVE      R0 R24       ; R0 := R24
348 [-]: MOVE      R0 R34       ; R0 := R34
349 [-]: SETGLOBAL R60 K67      ; WorldStateWindowVisChanged := R60
350 [-]: SETGLOBAL R60 K68      ; 0x6E3DB508 := R60
...
; Max Stack Size:  7
 ...
 15 [-]: SELF      R1 R1 K4     ; R2 := R1; R1 := R1["0x3951B288"]
 ...
 21 [-]: LOADK     R5 K8        ; R5 := -1
 22 [-]: LOADK     R6 K9        ; R6 := "OnCollectResourceDrone"
...
; Max Stack Size:  5
  ...
  1 [-]: GETUPVAL  R0 U0        ; R0 := U0
  2 [-]: LE        0 K0 R0      ; if 0 > R0 then PC := 24
  3 [-]: JMP       24           ; PC := 24
