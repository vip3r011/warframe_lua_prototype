...
; Command line was: -dis C:\war2\raw\Lotus\Interface\CardUtilitiesRedux.lua 
...
; Max Stack Size:  21
 ...
 71 [-]: SELF      R10 R9 K15   ; R11 := R9; R10 := R9["0x458F27A9"]
 72 [-]: LOADK     R12 K22      ; R12 := "SetRequiredSelections"
 73 [-]: GETGLOBAL R13 K23      ; R13 := 0x9FAED6BC
 74 [-]: MOVE      R14 R8       ; R14 := R8
 75 [-]: CALL      R13 2 0      ; R13,... := R13(R14)
 76 [-]: CALL      R10 0 1      ; R10(R11,...)
 77 [-]: SELF      R10 R9 K15   ; R11 := R9; R10 := R9["0x458F27A9"]
 78 [-]: LOADK     R12 K24      ; R12 := "SetCancelCallout"
 79 [-]: LOADK     R13 K25      ; R13 := "/Lotus/Language/Menu/OmegaLimit_Cancel"
 80 [-]: CALL      R10 4 1      ; R10(R11,R12,R13)
 81 [-]: SELF      R10 R9 K15   ; R11 := R9; R10 := R9["0x458F27A9"]
 82 [-]: LOADK     R12 K26      ; R12 := "SetCancelConfirmText"
 83 [-]: LOADK     R13 K27      ; R13 := "/Lotus/Language/Menu/OmegaLimit_CancelConfirm"
 84 [-]: CALL      R10 4 1      ; R10(R11,R12,R13)
 85 [-]: NEWTABLE  R10 0 0      ; R10 := {}
 86 [-]: LOADK     R11 K28      ; R11 := 1
 87 [-]: LEN       R12 R4       ; R12 := # R4
 88 [-]: LOADK     R13 K28      ; R13 := 1
 89 [-]: FORPREP   R11 109      ; R11 -= R13; PC := 109
 90 [-]: GETUPVAL  R15 U2       ; R15 := U2
 91 [-]: MOVE      R16 R0       ; R16 := R0
 92 [-]: GETTABLE  R17 R4 R14   ; R17 := R4[R14]
 93 [-]: MOVE      R18 R14      ; R18 := R14
 94 [-]: CALL      R15 4 2      ; R15 := R15(R16,R17,R18)
 95 [-]: NEWTABLE  R16 0 4      ; R16 := {}
 96 [-]: SETTABLE  R16 K29 R15  ; R16["Card"] := R15
 97 [-]: SETTABLE  R16 K30 R14  ; R16["mCardIndex"] := R14
 98 [-]: SETTABLE  R16 K31 K28  ; R16["Count"] := 1
 99 [-]: GETTABLE  R17 R15 K33  ; R17 := R15["mRating"]
100 [-]: SETTABLE  R16 K32 R17  ; R16["SellingPrice"] := R17
101 [-]: NEWTABLE  R17 0 1      ; R17 := {}
102 [-]: SETTABLE  R17 K35 K36  ; R17["LabelType"] := 10
103 [-]: SETTABLE  R16 K34 R17  ; R16["SellInfo"] := R17
104 [-]: GETGLOBAL R17 K37      ; R17 := table
105 [-]: GETTABLE  R17 R17 K38  ; R17 := R17["0xE6450C9D"]
106 [-]: MOVE      R18 R10      ; R18 := R10
107 [-]: MOVE      R19 R16      ; R19 := R16
108 [-]: CALL      R17 3 1      ; R17(R18,R19)
109 [-]: FORLOOP   R11 90       ; R11 += R13; if R11 <= R12 then begin PC := 90; R14 := R11 end
110 [-]: CLOSURE   R17 0        ; R17 := closure(Function #52.1)
111 [-]: GETUPVAL  R0 U1        ; R0 := U1
112 [-]: SETTABLE  R0 K39 R17   ; R0["OnOmegaSellCompleted"] := R17
113 [-]: CLOSURE   R17 1        ; R17 := closure(Function #52.2)
114 [-]: MOVE      R0 R2        ; R0 := R2
115 [-]: MOVE      R0 R6        ; R0 := R6
116 [-]: SETTABLE  R0 K40 R17   ; R0["SellExcessOmegas"] := R17
117 [-]: GETGLOBAL R17 K12      ; R17 := _T
118 [-]: CLOSURE   R18 2        ; R18 := closure(Function #52.3)
119 [-]: MOVE      R0 R6        ; R0 := R6
120 [-]: MOVE      R0 R7        ; R0 := R7
121 [-]: MOVE      R0 R0        ; R0 := R0
122 [-]: SETTABLE  R17 K41 R18  ; R17["OmegaSelectionDone"] := R18
123 [-]: SELF      R17 R9 K15   ; R18 := R9; R17 := R9["0x458F27A9"]
124 [-]: LOADK     R19 K42      ; R19 := "SetCallBack"
125 [-]: LOADK     R20 K41      ; R20 := "OmegaSelectionDone"
126 [-]: CALL      R17 4 1      ; R17(R18,R19,R20)
127 [-]: GETGLOBAL R17 K12      ; R17 := _T
128 [-]: CLOSURE   R18 3        ; R18 := closure(Function #52.4)
129 [-]: MOVE      R0 R7        ; R0 := R7
130 [-]: MOVE      R0 R9        ; R0 := R9
131 [-]: GETUPVAL  R0 U1        ; R0 := U1
132 [-]: SETTABLE  R17 K43 R18  ; R17["GetMeltConfirmText"] := R18
133 [-]: SELF      R17 R9 K15   ; R18 := R9; R17 := R9["0x458F27A9"]
134 [-]: LOADK     R19 K44      ; R19 := "SetConfirmTextFunction"
135 [-]: LOADK     R20 K43      ; R20 := "GetMeltConfirmText"
136 [-]: CALL      R17 4 1      ; R17(R18,R19,R20)
137 [-]: GETGLOBAL R17 K12      ; R17 := _T
138 [-]: CLOSURE   R18 4        ; R18 := closure(Function #52.5)
139 [-]: MOVE      R0 R10       ; R0 := R10
140 [-]: SETTABLE  R17 K45 R18  ; R17["GetAllOmegaMods"] := R18
141 [-]: SELF      R17 R9 K15   ; R18 := R9; R17 := R9["0x458F27A9"]
142 [-]: LOADK     R19 K46      ; R19 := "SetElementsFunction"
143 [-]: LOADK     R20 K45      ; R20 := "GetAllOmegaMods"
