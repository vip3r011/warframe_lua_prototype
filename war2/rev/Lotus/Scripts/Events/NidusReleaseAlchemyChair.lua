...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Events\NidusReleaseAlchemyChair.lua 
...
; Max Stack Size:  26
 ...
 63 [-]: LT        0 K14 R13    ; if 100 >= R13 then PC := 72
 64 [-]: JMP       72           ; PC := 72
 65 [-]: GETTABLE  R13 R2 R6    ; R13 := R2[R6]
 66 [-]: SELF      R14 R8 K15   ; R15 := R8; R14 := R8["0x9FB1775E"]
 67 [-]: GETUPVAL  R16 U1       ; R16 := U1
 68 [-]: GETTABLE  R16 R16 R12  ; R16 := R16[R12]
 69 [-]: LOADK     R17 K1       ; R17 := 1
 70 [-]: CALL      R14 4 2      ; R14 := R14(R15,R16,R17)
 71 [-]: SETTABLE  R13 R12 R14  ; R13[R12] := R14
 72 [-]: SELF      R13 R7 K16   ; R14 := R7; R13 := R7["0xD124E361"]
 73 [-]: GETUPVAL  R15 U1       ; R15 := U1
 74 [-]: GETTABLE  R15 R15 R12  ; R15 := R15[R12]
 75 [-]: LOADK     R16 K4       ; R16 := 0
 76 [-]: CALL      R13 4 1      ; R13(R14,R15,R16)
 77 [-]: FORLOOP   R9 54        ; R9 += R11; if R9 <= R10 then begin PC := 54; R12 := R9 end
 78 [-]: FORLOOP   R3 33        ; R3 += R5; if R3 <= R4 then begin PC := 33; R6 := R3 end
 79 [-]: GETGLOBAL R13 K6       ; R13 := 0x400E7765
 80 [-]: GETGLOBAL R14 K7       ; R14 := _T
 81 [-]: GETTABLE  R14 R14 K8   ; R14 := R14["InfestedAlchemyActive"]
 82 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 83 [-]: TEST      R13 1        ; if R13 then PC := 90
 84 [-]: JMP       90           ; PC := 90
 85 [-]: GETGLOBAL R13 K7       ; R13 := _T
 86 [-]: GETTABLE  R13 R13 K8   ; R13 := R13["InfestedAlchemyActive"]
 87 [-]: TEST      R13 0        ; if not R13 then PC := 90
 88 [-]: JMP       90           ; PC := 90
 89 [-]: JMP       94           ; PC := 94
 90 [-]: GETGLOBAL R13 K0       ; R13 := 0x201191EA
 91 [-]: LOADK     R14 K4       ; R14 := 0
 92 [-]: CALL      R13 2 1      ; R13(R14)
 93 [-]: JMP       79           ; PC := 79
 94 [-]: LOADK     R13 K1       ; R13 := 1
 95 [-]: LEN       R14 R1       ; R14 := # R1
 96 [-]: LOADK     R15 K1       ; R15 := 1
 97 [-]: FORPREP   R13 122      ; R13 -= R15; PC := 122
 98 [-]: GETTABLE  R17 R1 R16   ; R17 := R1[R16]
 99 [-]: GETGLOBAL R18 K6       ; R18 := 0x400E7765
100 [-]: MOVE      R19 R17      ; R19 := R17
101 [-]: CALL      R18 2 2      ; R18 := R18(R19)
102 [-]: TEST      R18 1        ; if R18 then PC := 122
103 [-]: JMP       122          ; PC := 122
104 [-]: LOADK     R18 K1       ; R18 := 1
105 [-]: GETUPVAL  R19 U1       ; R19 := U1
106 [-]: LEN       R19 R19      ; R19 := # R19
107 [-]: LOADK     R20 K1       ; R20 := 1
108 [-]: FORPREP   R18 121      ; R18 -= R20; PC := 121
109 [-]: GETGLOBAL R22 K6       ; R22 := 0x400E7765
110 [-]: GETTABLE  R23 R2 R16   ; R23 := R2[R16]
111 [-]: GETTABLE  R23 R23 R21  ; R23 := R23[R21]
112 [-]: CALL      R22 2 2      ; R22 := R22(R23)
113 [-]: TEST      R22 1        ; if R22 then PC := 121
114 [-]: JMP       121          ; PC := 121
115 [-]: SELF      R22 R17 K16  ; R23 := R17; R22 := R17["0xD124E361"]
116 [-]: GETUPVAL  R24 U1       ; R24 := U1
117 [-]: GETTABLE  R24 R24 R21  ; R24 := R24[R21]
118 [-]: GETTABLE  R25 R2 R16   ; R25 := R2[R16]
119 [-]: GETTABLE  R25 R25 R21  ; R25 := R25[R21]
120 [-]: CALL      R22 4 1      ; R22(R23,R24,R25)
121 [-]: FORLOOP   R18 109      ; R18 += R20; if R18 <= R19 then begin PC := 109; R21 := R18 end
122 [-]: FORLOOP   R13 98       ; R13 += R15; if R13 <= R14 then begin PC := 98; R16 := R13 end
