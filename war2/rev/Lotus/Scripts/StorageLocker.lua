...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\StorageLocker.lua 
...
; Max Stack Size:  18
 ...
 21 [-]: TEST      R3 0         ; if not R3 then PC := 172
 22 [-]: JMP       172          ; PC := 172
...
113 [-]: EQ        0 R10 R11    ; if R10 ~= R11 then PC := 150
114 [-]: JMP       150          ; PC := 150
115 [-]: GETGLOBAL R11 K17      ; R11 := 0x400E7765
116 [-]: GETGLOBAL R12 K40      ; R12 := dropTable
117 [-]: CALL      R11 2 2      ; R11 := R11(R12)
118 [-]: TEST      R11 1        ; if R11 then PC := 150
119 [-]: JMP       150          ; PC := 150
120 [-]: GETGLOBAL R11 K17      ; R11 := 0x400E7765
121 [-]: GETGLOBAL R12 K41      ; R12 := survivalDropTable
122 [-]: CALL      R11 2 2      ; R11 := R11(R12)
123 [-]: TEST      R11 1        ; if R11 then PC := 150
124 [-]: JMP       150          ; PC := 150
125 [-]: SELF      R11 R9 K42   ; R12 := R9; R11 := R9["0xED0EE7FB"]
126 [-]: GETGLOBAL R13 K3       ; R13 := 0xEC274B1A
127 [-]: LOADK     R14 K43      ; R14 := "SurvivalMissionState"
128 [-]: CALL      R13 2 0      ; R13,... := R13(R14)
129 [-]: CALL      R11 0 2      ; R11 := R11(R12,...)
130 [-]: EQ        1 R11 K44    ; if R11 == 2 then PC := 134
131 [-]: JMP       134          ; PC := 134
132 [-]: EQ        0 R11 K45    ; if R11 ~= 3 then PC := 142
133 [-]: JMP       142          ; PC := 142
134 [-]: GETGLOBAL R12 K41      ; R12 := survivalDropTable
135 [-]: SELF      R12 R12 K33  ; R13 := R12; R12 := R12["0xD0393696"]
136 [-]: MOVE      R14 R0       ; R14 := R0
137 [-]: MOVE      R15 R5       ; R15 := R5
138 [-]: MOVE      R16 R8       ; R16 := R8
139 [-]: GETGLOBAL R17 K34      ; R17 := placement
140 [-]: CALL      R12 6 1      ; R12(R13,R14,R15,R16,R17)
141 [-]: JMP       162          ; PC := 162
142 [-]: GETGLOBAL R12 K40      ; R12 := dropTable
143 [-]: SELF      R12 R12 K33  ; R13 := R12; R12 := R12["0xD0393696"]
144 [-]: MOVE      R14 R0       ; R14 := R0
145 [-]: MOVE      R15 R5       ; R15 := R5
146 [-]: MOVE      R16 R8       ; R16 := R8
147 [-]: GETGLOBAL R17 K34      ; R17 := placement
148 [-]: CALL      R12 6 1      ; R12(R13,R14,R15,R16,R17)
149 [-]: JMP       162          ; PC := 162
150 [-]: GETGLOBAL R12 K17      ; R12 := 0x400E7765
151 [-]: GETGLOBAL R13 K40      ; R13 := dropTable
152 [-]: CALL      R12 2 2      ; R12 := R12(R13)
153 [-]: TEST      R12 1        ; if R12 then PC := 162
154 [-]: JMP       162          ; PC := 162
155 [-]: GETGLOBAL R12 K40      ; R12 := dropTable
156 [-]: SELF      R12 R12 K33  ; R13 := R12; R12 := R12["0xD0393696"]
157 [-]: MOVE      R14 R0       ; R14 := R0
158 [-]: MOVE      R15 R5       ; R15 := R5
159 [-]: MOVE      R16 R8       ; R16 := R8
160 [-]: GETGLOBAL R17 K34      ; R17 := placement
161 [-]: CALL      R12 6 1      ; R12(R13,R14,R15,R16,R17)
162 [-]: GETGLOBAL R12 K29      ; R12 := _T
163 [-]: SETTABLE  R12 K46 K47  ; R12["idleTimoutReset"] := "0x1"
164 [-]: GETGLOBAL R12 K29      ; R12 := _T
165 [-]: GETTABLE  R12 R12 K48  ; R12 := R12["StorageLockerOpenCallback"]
166 [-]: TEST      R12 0        ; if not R12 then PC := 172
167 [-]: JMP       172          ; PC := 172
168 [-]: GETGLOBAL R12 K29      ; R12 := _T
169 [-]: GETTABLE  R12 R12 K49  ; R12 := R12["0x8E3C5BD7"]
