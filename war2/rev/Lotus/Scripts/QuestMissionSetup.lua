...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\QuestMissionSetup.lua 
...
; Max Stack Size:  16
 ...
 30 [-]: TEST      R5 0         ; if not R5 then PC := 55
 31 [-]: JMP       55           ; PC := 55
 32 [-]: GETGLOBAL R5 K2        ; R5 := gGameRules
 33 [-]: SELF      R5 R5 K11    ; R6 := R5; R5 := R5["0x8B598ED4"]
 34 [-]: GETGLOBAL R7 K12       ; R7 := gLotusHubGameRulesType
 35 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
 36 [-]: TEST      R5 0         ; if not R5 then PC := 126
 37 [-]: JMP       126          ; PC := 126
 38 [-]: GETGLOBAL R5 K2        ; R5 := gGameRules
 ...
 43 [-]: LOADK     R10 K16      ; R10 := "OnRepairTechProjectStarted"
 44 [-]: CALL      R5 6 1       ; R5(R6,R7,R8,R9,R10)
 45 [-]: GETUPVAL  R5 U0        ; R5 := U0
 46 [-]: TEST      R5 1         ; if R5 then PC := 52
 47 [-]: JMP       52           ; PC := 52
 48 [-]: GETGLOBAL R5 K3        ; R5 := 0x201191EA
 49 [-]: LOADK     R6 K4        ; R6 := 0.10000000149012
 50 [-]: CALL      R5 2 1       ; R5(R6)
 51 [-]: JMP       45           ; PC := 45
 52 [-]: MOVE      R5 R0        ; R5 := R0
 53 [-]: MOVE      R5 R0        ; R5 := R0
 54 [-]: JMP       126          ; PC := 126
 55 [-]: GETTABLE  R5 R4 K17    ; R5 := R4["mState"]
 56 [-]: EQ        0 R5 K18     ; if R5 ~= 1 then PC := 126
 57 [-]: JMP       126          ; PC := 126
 58 [-]: GETGLOBAL R5 K19       ; R5 := Engine
 59 [-]: GETTABLE  R5 R5 K20    ; R5 := R5["0xD09D7910"]
 60 [-]: GETTABLE  R6 R4 K21    ; R6 := R4["mCompletionDate"]
 61 [-]: SELF      R6 R6 K22    ; R7 := R6; R6 := R6["0xA4269DBC"]
 62 [-]: CALL      R6 2 0       ; R6,... := R6(R7)
 63 [-]: CALL      R5 0 2       ; R5 := R5(R6,...)
 64 [-]: LE        0 R5 K23     ; if R5 > 0 then PC := 80
 65 [-]: JMP       80           ; PC := 80
 66 [-]: GETGLOBAL R6 K5        ; R6 := gRegion
 67 [-]: SELF      R6 R6 K6     ; R7 := R6; R6 := R6["0x90391273"]
 68 [-]: GETGLOBAL R8 K24       ; R8 := entityTag
 69 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 70 [-]: GETGLOBAL R7 K0        ; R7 := 0x400E7765
 71 [-]: MOVE      R8 R6        ; R8 := R6
 72 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 73 [-]: TEST      R7 1         ; if R7 then PC := 130
 74 [-]: JMP       130          ; PC := 130
 75 [-]: SELF      R7 R6 K25    ; R8 := R6; R7 := R6["0x8D5886B7"]
 76 [-]: LOADK     R9 K26       ; R9 := "Execute"
 77 [-]: CALL      R7 3 1       ; R7(R8,R9)
 78 [-]: JMP       130          ; PC := 130
 79 [-]: JMP       126          ; PC := 126
 80 [-]: EQ        0 R2 K27     ; if R2 ~= nil then PC := 125
 81 [-]: JMP       125          ; PC := 125
 82 [-]: GETGLOBAL R7 K0        ; R7 := 0x400E7765
 83 [-]: MOVE      R8 R1        ; R8 := R1
 84 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 85 [-]: TEST      R7 1         ; if R7 then PC := 125
 86 [-]: JMP       125          ; PC := 125
 87 [-]: GETGLOBAL R7 K0        ; R7 := 0x400E7765
 88 [-]: GETGLOBAL R8 K28       ; R8 := progressMovieType
 89 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 90 [-]: TEST      R7 1         ; if R7 then PC := 125
 91 [-]: JMP       125          ; PC := 125
 92 [-]: GETGLOBAL R7 K29       ; R7 := _T
 93 [-]: NEWTABLE  R8 0 2       ; R8 := {}
 94 [-]: GETTABLE  R9 R4 K32    ; R9 := R4["mItemType"]
 95 [-]: SELF      R9 R9 K33    ; R10 := R9; R9 := R9["0x5EB2789B"]
 96 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 97 [-]: SETTABLE  R8 K31 R9    ; R8["Total"] := R9
 98 [-]: SETTABLE  R8 K34 R5    ; R8["Left"] := R5
 99 [-]: SETTABLE  R7 K30 R8    ; R7["ProgressMovie_Time"] := R8
100 [-]: GETGLOBAL R7 K35       ; R7 := gFlashMgr
101 [-]: SELF      R7 R7 K36    ; R8 := R7; R7 := R7["0x24FF386"]
102 [-]: GETGLOBAL R9 K28       ; R9 := progressMovieType
...
108 [-]: TEST      R7 1         ; if R7 then PC := 125
109 [-]: JMP       125          ; PC := 125
110 [-]: SELF      R7 R2 K37    ; R8 := R2; R7 := R2["0x619FE9B4"]
111 [-]: MOVE      R9 R1        ; R9 := R1
112 [-]: GETGLOBAL R10 K38      ; R10 := 0x221C9700
113 [-]: LOADK     R11 K23      ; R11 := 0
114 [-]: LOADK     R12 K39      ; R12 := 1.25
115 [-]: LOADK     R13 K40      ; R13 := 0.40000000596046
116 [-]: CALL      R10 4 2      ; R10 := R10(R11,R12,R13)
117 [-]: GETGLOBAL R11 K41      ; R11 := 0x1E4F6281
118 [-]: CALL      R11 1 2      ; R11 := R11()
119 [-]: GETGLOBAL R12 K38      ; R12 := 0x221C9700
120 [-]: LOADK     R13 K18      ; R13 := 1
121 [-]: LOADK     R14 K18      ; R14 := 1
122 [-]: LOADK     R15 K18      ; R15 := 1
123 [-]: CALL      R12 4 0      ; R12,... := R12(R13,R14,R15)
124 [-]: CALL      R7 0 1       ; R7(R8,...)
125 [-]: MOVE      R3 R5        ; R3 := R5
126 [-]: GETGLOBAL R7 K3        ; R7 := 0x201191EA
127 [-]: MOVE      R8 R3        ; R8 := R3
128 [-]: CALL      R7 2 1       ; R7(R8)
129 [-]: JMP       24           ; PC := 24
130 [-]: GETUPVAL  R7 U1        ; R7 := U1
131 [-]: GETGLOBAL R8 K1        ; R8 := gGameData
...
137 [-]: JMP       140          ; PC := 140
138 [-]: SELF      R7 R2 K42    ; R8 := R2; R7 := R2["0xA58BB96C"]
139 [-]: CALL      R7 2 1       ; R7(R8)
140 [-]: GETGLOBAL R7 K5        ; R7 := gRegion
141 [-]: SELF      R7 R7 K6     ; R8 := R7; R7 := R7["0x90391273"]
142 [-]: GETGLOBAL R9 K7        ; R9 := 0xEC274B1A
143 [-]: LOADK     R10 K43      ; R10 := "InstallCyMarker"
...
150 [-]: JMP       153          ; PC := 153
151 [-]: SELF      R8 R7 K44    ; R9 := R7; R8 := R7["0x2DB1272F"]
152 [-]: CALL      R8 2 1       ; R8(R9)
153 [-]: GETGLOBAL R8 K45       ; R8 := markDojoExit
154 [-]: TEST      R8 0         ; if not R8 then PC := 184
155 [-]: JMP       184          ; PC := 184
156 [-]: GETGLOBAL R8 K5        ; R8 := gRegion
157 [-]: SELF      R8 R8 K6     ; R9 := R8; R8 := R8["0x90391273"]
158 [-]: GETGLOBAL R10 K7       ; R10 := 0xEC274B1A
159 [-]: LOADK     R11 K46      ; R11 := "LeaveDojoMarker"
...
165 [-]: TEST      R9 1         ; if R9 then PC := 187
166 [-]: JMP       187          ; PC := 187
167 [-]: SELF      R9 R8 K47    ; R10 := R8; R9 := R8["0xC5E91BA6"]
168 [-]: CALL      R9 2 1       ; R9(R10)
169 [-]: GETUPVAL  R9 U2        ; R9 := U2
170 [-]: GETTABLE  R9 R9 K48    ; R9 := R9["0xD69A3D49"]
171 [-]: LOADK     R10 K49      ; R10 := "/Lotus/Language/Menu/RetunToShipUpperCase"
172 [-]: GETUPVAL  R11 U2       ; R11 := U2
173 [-]: GETTABLE  R11 R11 K50  ; R11 := R11["EXTRACT_ICON"]
174 [-]: CALL      R9 3 1       ; R9(R10,R11)
175 [-]: GETGLOBAL R9 K5        ; R9 := gRegion
176 [-]: SELF      R9 R9 K6     ; R10 := R9; R9 := R9["0x90391273"]
177 [-]: GETGLOBAL R11 K7       ; R11 := 0xEC274B1A
178 [-]: LOADK     R12 K8       ; R12 := "RailjackRepairConsole"
179 [-]: CALL      R11 2 0      ; R11,... := R11(R12)
180 [-]: CALL      R9 0 2       ; R9 := R9(R10,...)
181 [-]: SELF      R10 R9 K44   ; R11 := R9; R10 := R9["0x2DB1272F"]
182 [-]: CALL      R10 2 1      ; R10(R11)
183 [-]: JMP       187          ; PC := 187
184 [-]: GETUPVAL  R10 U2       ; R10 := U2
185 [-]: GETTABLE  R10 R10 K51  ; R10 := R10["0xE3C15456"]
186 [-]: CALL      R10 1 1      ; R10()
