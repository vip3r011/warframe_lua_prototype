...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\OverrideMaterials.lua 
...
; Max Stack Size:  3
 ...
 42 [-]: SETGLOBAL R2 K22       ; OsillateUnlit := R2
 43 [-]: SETGLOBAL R2 K23       ; 0xACA8B30D := R2
 44 [-]: CLOSURE   R2 14        ; R2 := closure(Function #15)
 45 [-]: SETGLOBAL R2 K24       ; SetupCapDoorFrames := R2
 46 [-]: SETGLOBAL R2 K25       ; 0xB7CD557A := R2
 47 [-]: CLOSURE   R2 15        ; R2 := closure(Function #16)
 48 [-]: SETGLOBAL R2 K26       ; HackDoorFrameSwitch := R2
 49 [-]: SETGLOBAL R2 K27       ; 0x926C1ACC := R2
...
; Max Stack Size:  18
 ...
 19 [-]: SELF      R3 R2 K4     ; R4 := R2; R3 := R2["0x3387B9CD"]
 20 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 21 [-]: EQ        1 R3 R1      ; if R3 == R1 then PC := 149
 22 [-]: JMP       149          ; PC := 149
 23 [-]: GETGLOBAL R4 K5        ; R4 := doorIcons
 24 [-]: LEN       R4 R4        ; R4 := # R4
 25 [-]: LT        0 K6 R4      ; if 0 >= R4 then PC := 31
 ...
 33 [-]: EQ        0 R3 R4      ; if R3 ~= R4 then PC := 131
 34 [-]: JMP       131          ; PC := 131
...
100 [-]: GETGLOBAL R6 K16       ; R6 := 0xB5A59043
101 [-]: GETTABLE  R7 R4 K9     ; R7 := R4["red"]
102 [-]: GETTABLE  R8 R4 K10    ; R8 := R4["green"]
103 [-]: GETTABLE  R9 R4 K11    ; R9 := R4["blue"]
104 [-]: CALL      R6 4 2       ; R6 := R6(R7,R8,R9)
105 [-]: LOADK     R7 K17       ; R7 := 1
106 [-]: GETGLOBAL R8 K18       ; R8 := decorations
107 [-]: LEN       R8 R8        ; R8 := # R8
108 [-]: LOADK     R9 K17       ; R9 := 1
109 [-]: FORPREP   R7 129       ; R7 -= R9; PC := 129
110 [-]: GETGLOBAL R11 K0       ; R11 := 0x400E7765
111 [-]: GETGLOBAL R12 K18      ; R12 := decorations
112 [-]: GETTABLE  R12 R12 R10  ; R12 := R12[R10]
113 [-]: CALL      R11 2 2      ; R11 := R11(R12)
114 [-]: TEST      R11 1        ; if R11 then PC := 129
115 [-]: JMP       129          ; PC := 129
116 [-]: GETGLOBAL R11 K18      ; R11 := decorations
117 [-]: GETTABLE  R11 R11 R10  ; R11 := R11[R10]
118 [-]: SELF      R11 R11 K19  ; R12 := R11; R11 := R11["0xD124E361"]
119 [-]: GETGLOBAL R13 K20      ; R13 := Lotus_Game
120 [-]: GETTABLE  R13 R13 K21  ; R13 := R13["EMISSIVE_TINT_COLOR"]
121 [-]: GETTABLE  R14 R4 K9    ; R14 := R4["red"]
122 [-]: DIV       R14 R14 K15  ; R14 := R14 / 255
123 [-]: GETTABLE  R15 R4 K10   ; R15 := R4["green"]
124 [-]: DIV       R15 R15 K15  ; R15 := R15 / 255
125 [-]: GETTABLE  R16 R4 K11   ; R16 := R4["blue"]
126 [-]: DIV       R16 R16 K15  ; R16 := R16 / 255
127 [-]: LOADK     R17 K17      ; R17 := 1
128 [-]: CALL      R11 7 1      ; R11(R12,R13,R14,R15,R16,R17)
129 [-]: FORLOOP   R7 110       ; R7 += R9; if R7 <= R8 then begin PC := 110; R10 := R7 end
130 [-]: JMP       149          ; PC := 149
131 [-]: LOADK     R11 K17      ; R11 := 1
132 [-]: GETGLOBAL R12 K18      ; R12 := decorations
133 [-]: LEN       R12 R12      ; R12 := # R12
134 [-]: LOADK     R13 K17      ; R13 := 1
135 [-]: FORPREP   R11 148      ; R11 -= R13; PC := 148
136 [-]: GETGLOBAL R15 K0       ; R15 := 0x400E7765
137 [-]: GETGLOBAL R16 K18      ; R16 := decorations
138 [-]: GETTABLE  R16 R16 R14  ; R16 := R16[R14]
139 [-]: CALL      R15 2 2      ; R15 := R15(R16)
140 [-]: TEST      R15 1        ; if R15 then PC := 148
141 [-]: JMP       148          ; PC := 148
142 [-]: GETGLOBAL R15 K18      ; R15 := decorations
143 [-]: GETTABLE  R15 R15 R14  ; R15 := R15[R14]
144 [-]: SELF      R15 R15 K22  ; R16 := R15; R15 := R15["0xBF1BDD58"]
145 [-]: GETGLOBAL R17 K20      ; R17 := Lotus_Game
146 [-]: GETTABLE  R17 R17 K21  ; R17 := R17["EMISSIVE_TINT_COLOR"]
147 [-]: CALL      R15 3 1      ; R15(R16,R17)
148 [-]: FORLOOP   R11 136      ; R11 += R13; if R11 <= R12 then begin PC := 136; R14 := R11 end
...
; Max Stack Size:  10
  ...
  2 [-]: LOADK     R1 K1        ; R1 := 0
  3 [-]: MOVE      R2 R1        ; R2 := R1
  4 [-]: GETGLOBAL R3 K2        ; R3 := delay
  5 [-]: LE        0 R1 R3      ; if R1 > R3 then PC := 37
  6 [-]: JMP       37           ; PC := 37
  7 [-]: GETGLOBAL R3 K3        ; R3 := decoration
  8 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0xD124E361"]
  9 [-]: GETGLOBAL R5 K5        ; R5 := Lotus_Game
 10 [-]: GETTABLE  R5 R5 K6     ; R5 := R5["EMISSIVE_MAP_ATTEN"]
 11 [-]: MOVE      R6 R0        ; R6 := R0
 12 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
 13 [-]: LE        0 K7 R0      ; if 10 > R0 then PC := 16
 14 [-]: JMP       16           ; PC := 16
 15 [-]: MOVE      R2 R0        ; R2 := R0
 16 [-]: LE        0 R0 K1      ; if R0 > 0 then PC := 19
 17 [-]: JMP       19           ; PC := 19
 18 [-]: MOVE      R2 R1        ; R2 := R1
 ...
 23 [-]: MUL       R3 R3 K9     ; R3 := R3 * 20
 24 [-]: ADD       R0 R0 R3     ; R0 := R0 + R3
 25 [-]: JMP       30           ; PC := 30
 26 [-]: GETGLOBAL R3 K8        ; R3 := 0x4CDEF9FF
 27 [-]: CALL      R3 1 2       ; R3 := R3()
 28 [-]: MUL       R3 R3 K9     ; R3 := R3 * 20
 29 [-]: SUB       R0 R0 R3     ; R0 := R0 - R3
 30 [-]: GETGLOBAL R3 K8        ; R3 := 0x4CDEF9FF
 ...
 36 [-]: JMP       4            ; PC := 4
 37 [-]: GETGLOBAL R3 K3        ; R3 := decoration
 38 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0xD124E361"]
 39 [-]: GETGLOBAL R5 K5        ; R5 := Lotus_Game
 40 [-]: GETTABLE  R5 R5 K11    ; R5 := R5["EMISSIVE_TINT_COLOR"]
 41 [-]: LOADK     R6 K12       ; R6 := 0.34000000357628
 42 [-]: LOADK     R7 K13       ; R7 := 0.87999999523163
 43 [-]: LOADK     R8 K14       ; R8 := 0.065999999642372
 44 [-]: LOADK     R9 K0        ; R9 := 1
 45 [-]: CALL      R3 7 1       ; R3(R4,R5,R6,R7,R8,R9)
 46 [-]: GETGLOBAL R3 K3        ; R3 := decoration
 47 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0xD124E361"]
 48 [-]: GETGLOBAL R5 K5        ; R5 := Lotus_Game
 49 [-]: GETTABLE  R5 R5 K6     ; R5 := R5["EMISSIVE_MAP_ATTEN"]
 50 [-]: LOADK     R6 K15       ; R6 := 5
