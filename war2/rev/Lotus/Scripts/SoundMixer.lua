...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\SoundMixer.lua 
...
; Max Stack Size:  10
  ...
  1 [-]: LOADK     R5 K0        ; R5 := 1
  2 [-]: LT        0 K1 R5      ; if 0 >= R5 then PC := 21
  3 [-]: JMP       21           ; PC := 21
  4 [-]: GETGLOBAL R6 K2        ; R6 := 0x93034B55
  5 [-]: MOVE      R7 R3        ; R7 := R3
  6 [-]: MOVE      R8 R2        ; R8 := R2
  7 [-]: MOVE      R9 R5        ; R9 := R5
 ...
 13 [-]: GETGLOBAL R7 K3        ; R7 := 0x6306558E
 14 [-]: CALL      R7 1 2       ; R7 := R7()
 15 [-]: DIV       R7 R7 R4     ; R7 := R7 / R4
 16 [-]: SUB       R5 R5 R7     ; R5 := R5 - R7
...
; Max Stack Size:  18
  ...
  1 [-]: LEN       R5 R0        ; R5 := # R0
  2 [-]: LEN       R6 R3        ; R6 := # R3
  3 [-]: EQ        0 R5 R6      ; if R5 ~= R6 then PC := 44
  4 [-]: JMP       44           ; PC := 44
  5 [-]: LEN       R5 R0        ; R5 := # R0
  6 [-]: LEN       R6 R2        ; R6 := # R2
  7 [-]: EQ        0 R5 R6      ; if R5 ~= R6 then PC := 44
  8 [-]: JMP       44           ; PC := 44
  9 [-]: LOADK     R5 K0        ; R5 := 1
 10 [-]: LT        0 K1 R5      ; if 0 >= R5 then PC := 34
 11 [-]: JMP       34           ; PC := 34
 12 [-]: LOADK     R6 K0        ; R6 := 1
 13 [-]: LEN       R7 R0        ; R7 := # R0
 14 [-]: LOADK     R8 K0        ; R8 := 1
 15 [-]: FORPREP   R6 25        ; R6 -= R8; PC := 25
 16 [-]: GETGLOBAL R10 K2       ; R10 := 0x93034B55
 17 [-]: GETTABLE  R11 R3 R9    ; R11 := R3[R9]
 18 [-]: GETTABLE  R12 R2 R9    ; R12 := R2[R9]
 19 [-]: MOVE      R13 R5       ; R13 := R5
 20 [-]: CALL      R10 4 2      ; R10 := R10(R11,R12,R13)
 21 [-]: MOVE      R11 R1       ; R11 := R1
 22 [-]: GETTABLE  R12 R0 R9    ; R12 := R0[R9]
 23 [-]: MOVE      R13 R10      ; R13 := R10
 24 [-]: CALL      R11 3 1      ; R11(R12,R13)
 25 [-]: FORLOOP   R6 16        ; R6 += R8; if R6 <= R7 then begin PC := 16; R9 := R6 end
 26 [-]: GETGLOBAL R11 K3       ; R11 := 0x6306558E
 27 [-]: CALL      R11 1 2      ; R11 := R11()
 28 [-]: DIV       R11 R11 R4   ; R11 := R11 / R4
 29 [-]: SUB       R5 R5 R11    ; R5 := R5 - R11
 30 [-]: GETGLOBAL R11 K4       ; R11 := 0x201191EA
 31 [-]: LOADK     R12 K1       ; R12 := 0
 32 [-]: CALL      R11 2 1      ; R11(R12)
 33 [-]: JMP       10           ; PC := 10
 34 [-]: LOADK     R11 K0       ; R11 := 1
 35 [-]: LEN       R12 R0       ; R12 := # R0
 36 [-]: LOADK     R13 K0       ; R13 := 1
 37 [-]: FORPREP   R11 42       ; R11 -= R13; PC := 42
 38 [-]: MOVE      R15 R1       ; R15 := R1
 39 [-]: GETTABLE  R16 R0 R14   ; R16 := R0[R14]
 40 [-]: GETTABLE  R17 R3 R14   ; R17 := R3[R14]
 41 [-]: CALL      R15 3 1      ; R15(R16,R17)
 42 [-]: FORLOOP   R11 38       ; R11 += R13; if R11 <= R12 then begin PC := 38; R14 := R11 end
 43 [-]: JMP       47           ; PC := 47
 44 [-]: GETGLOBAL R15 K5       ; R15 := 0x93B1256B
 45 [-]: LOADK     R16 K6       ; R16 := "Mixer Update failed: #Mixers does not match #AdjustmentValues"
