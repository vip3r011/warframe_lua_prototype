...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Challenges\MatchMissionInfo.lua 
...
; Max Stack Size:  4
  ...
  7 [-]: SELF      R2 R2 K2     ; R3 := R2; R2 := R2["0xB8637349"]
  8 [-]: CALL      R2 2 2       ; R2 := R2(R3)
  9 [-]: GETTABLE  R2 R2 K3     ; R2 := R2["periodicMissionTag"]
 10 [-]: GETGLOBAL R3 K3        ; R3 := periodicMissionTag
