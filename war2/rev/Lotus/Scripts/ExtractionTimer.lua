...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\ExtractionTimer.lua 
...
; Max Stack Size:  19
  ...
  7 [-]: EQ        0 R3 R4      ; if R3 ~= R4 then PC := 19
  8 [-]: JMP       19           ; PC := 19
  9 [-]: GETGLOBAL R3 K0        ; R3 := gGameRules
 10 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0xED0EE7FB"]
 11 [-]: GETGLOBAL R5 K5        ; R5 := 0xEC274B1A
 12 [-]: LOADK     R6 K6        ; R6 := "SurvivalMissionState"
 13 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 14 [-]: CALL      R3 0 2       ; R3 := R3(R4,...)
 15 [-]: EQ        0 R3 K7      ; if R3 ~= 4 then PC := 19
 16 [-]: JMP       19           ; PC := 19
 17 [-]: MOVE      R2 R1        ; R2 := R1
 18 [-]: JMP       46           ; PC := 46
 19 [-]: GETGLOBAL R3 K8        ; R3 := 0x63B09107
 20 [-]: MOVE      R4 R0        ; R4 := R0
 21 [-]: CALL      R3 2 4       ; R3,R4,R5 := R3(R4)
 22 [-]: JMP       44           ; PC := 44
 23 [-]: SELF      R8 R7 K9     ; R9 := R7; R8 := R7["0x80B14403"]
 24 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 25 [-]: SELF      R9 R8 K10    ; R10 := R8; R9 := R8["0xD0BC8584"]
 26 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 27 [-]: SELF      R10 R8 K11   ; R11 := R8; R10 := R8["0x676FE79F"]
 28 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 29 [-]: SUB       R9 R9 R10    ; R9 := R9 - R10
 30 [-]: EQ        1 R9 K12     ; if R9 == 0 then PC := 40
 31 [-]: JMP       40           ; PC := 40
 32 [-]: SELF      R10 R8 K13   ; R11 := R8; R10 := R8["0xA56CD0BB"]
 33 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 34 [-]: TEST      R10 1        ; if R10 then PC := 41
 35 [-]: JMP       41           ; PC := 41
 36 [-]: SELF      R10 R8 K14   ; R11 := R8; R10 := R8["0x5A115A02"]
 37 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 38 [-]: JMP       41           ; PC := 41
 39 [-]: MOVE      R10 R0       ; R10 := R0
 40 [-]: MOVE      R10 R1       ; R10 := R1
 41 [-]: TEST      R10 1        ; if R10 then PC := 44
 42 [-]: JMP       44           ; PC := 44
 43 [-]: MOVE      R2 R0        ; R2 := R0
 44 [-]: TFORLOOP  R3 2         ; R6,R7 :=  R3(R4,R5); if R6 ~= nil then begin PC = 23; R5 := R6 end
 45 [-]: JMP       23           ; PC := 23
 46 [-]: TEST      R2 0         ; if not R2 then PC := 59
 47 [-]: JMP       59           ; PC := 59
 48 [-]: GETGLOBAL R11 K8       ; R11 := 0x63B09107
 49 [-]: MOVE      R12 R0       ; R12 := R0
 50 [-]: CALL      R11 2 4      ; R11,R12,R13 := R11(R12)
 51 [-]: JMP       57           ; PC := 57
 52 [-]: GETGLOBAL R16 K15      ; R16 := table
 53 [-]: GETTABLE  R16 R16 K16  ; R16 := R16["0xE6450C9D"]
 54 [-]: MOVE      R17 R1       ; R17 := R1
 55 [-]: MOVE      R18 R15      ; R18 := R15
 56 [-]: CALL      R16 3 1      ; R16(R17,R18)
 57 [-]: TFORLOOP  R11 2        ; R14,R15 :=  R11(R12,R13); if R14 ~= nil then begin PC = 52; R13 := R14 end
 58 [-]: JMP       52           ; PC := 52
...
; Max Stack Size:  5
 ...
 28 [-]: SELF      R1 R0 K9     ; R2 := R0; R1 := R0["0x393A0736"]
 29 [-]: GETGLOBAL R3 K10       ; R3 := Lotus_Game
 30 [-]: GETTABLE  R3 R3 K11    ; R3 := R3["MAX_Interrupt"]
