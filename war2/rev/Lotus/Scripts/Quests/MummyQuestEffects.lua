...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Quests\MummyQuestEffects.lua 
...
; Max Stack Size:  12
 ...
 59 [-]: GETTABLE  R5 R5 K13    ; R5 := R5["0x52C8784B"]
 60 [-]: MOVE      R6 R4        ; R6 := R4
 ...
 66 [-]: JMP       83           ; PC := 83
 67 [-]: GETGLOBAL R8 K14       ; R8 := MummyQuest
 68 [-]: EQ        0 R5 R8      ; if R5 ~= R8 then PC := 83
 69 [-]: JMP       83           ; PC := 83
 70 [-]: LT        0 K15 R6     ; if 2 >= R6 then PC := 83
 71 [-]: JMP       83           ; PC := 83
 72 [-]: LT        0 R6 K16     ; if R6 >= 12 then PC := 83
 73 [-]: JMP       83           ; PC := 83
 74 [-]: GETGLOBAL R8 K17       ; R8 := jarDeco
 75 [-]: SELF      R8 R8 K18    ; R9 := R8; R8 := R8["0x7DBDDA0B"]
 76 [-]: MOVE      R10 R1       ; R10 := R1
 77 [-]: MOVE      R11 R1       ; R11 := R1
 78 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
 79 [-]: GETGLOBAL R8 K19       ; R8 := jarAction
 80 [-]: SELF      R8 R8 K20    ; R9 := R8; R8 := R8["0xC5E91BA6"]
 81 [-]: CALL      R8 2 1       ; R8(R9)
 82 [-]: JMP       91           ; PC := 91
 83 [-]: GETGLOBAL R8 K17       ; R8 := jarDeco
 84 [-]: SELF      R8 R8 K18    ; R9 := R8; R8 := R8["0x7DBDDA0B"]
 85 [-]: MOVE      R10 R0       ; R10 := R0
 86 [-]: MOVE      R11 R1       ; R11 := R1
 87 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
 88 [-]: GETGLOBAL R8 K19       ; R8 := jarAction
 89 [-]: SELF      R8 R8 K21    ; R9 := R8; R8 := R8["0x2DB1272F"]
