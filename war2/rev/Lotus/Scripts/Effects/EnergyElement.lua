...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Effects\EnergyElement.lua 
...
; Max Stack Size:  9
 ...
 21 [-]: TEST      R5 0         ; if not R5 then PC := 44
 22 [-]: JMP       44           ; PC := 44
 ...
 34 [-]: JMP       37           ; PC := 37
 35 [-]: GETTABLE  R5 R4 K13    ; R5 := R4["mEmissiveColor0"]
 36 [-]: JMP       40           ; PC := 40
 37 [-]: SELF      R6 R0 K14    ; R7 := R0; R6 := R0["0x94A099AD"]
