...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Effects\AttachFX.lua 
...
; Max Stack Size:  3
 ...
 23 [-]: SETGLOBAL R2 K14       ; KillThisAttachedToParentOnBone := R2
 24 [-]: SETGLOBAL R2 K15       ; 0x24AC0D2F := R2
 25 [-]: CLOSURE   R2 6         ; R2 := closure(Function #7)
 26 [-]: SETGLOBAL R2 K16       ; KillAttachedArray := R2
 27 [-]: SETGLOBAL R2 K17       ; 0x759CC6FA := R2
 28 [-]: CLOSURE   R2 7         ; R2 := closure(Function #8)
 29 [-]: SETGLOBAL R2 K18       ; Attach := R2
 30 [-]: SETGLOBAL R2 K19       ; 0xAB436EF2 := R2
 31 [-]: CLOSURE   R2 8         ; R2 := closure(Function #9)
 32 [-]: SETGLOBAL R2 K20       ; AttachArray := R2
 33 [-]: SETGLOBAL R2 K21       ; 0x177A570E := R2
 34 [-]: CLOSURE   R2 9         ; R2 := closure(Function #10)
 35 [-]: SETGLOBAL R2 K22       ; AttachProjector := R2
 36 [-]: SETGLOBAL R2 K23       ; 0x2661DA9 := R2
 37 [-]: CLOSURE   R2 10        ; R2 := closure(Function #11)
 38 [-]: SETGLOBAL R2 K24       ; KillParent := R2
 39 [-]: SETGLOBAL R2 K25       ; 0xDDF06CAB := R2
 40 [-]: CLOSURE   R2 11        ; R2 := closure(Function #12)
 41 [-]: SETGLOBAL R2 K26       ; AttachToMe := R2
 42 [-]: SETGLOBAL R2 K27       ; 0xA9584F28 := R2
 43 [-]: CLOSURE   R2 12        ; R2 := closure(Function #13)
 44 [-]: SETGLOBAL R2 K28       ; AttachToTouchingAvatar := R2
 45 [-]: SETGLOBAL R2 K29       ; 0xA527D004 := R2
 46 [-]: CLOSURE   R2 13        ; R2 := closure(Function #14)
 47 [-]: SETGLOBAL R2 K30       ; AttachToAvatarFromBehavior := R2
 48 [-]: SETGLOBAL R2 K31       ; 0xAC0B4919 := R2
 49 [-]: CLOSURE   R2 14        ; R2 := closure(Function #15)
 50 [-]: MOVE      R0 R0        ; R0 := R0
 51 [-]: SETGLOBAL R2 K32       ; KillParticleCenterTypeIfIllusionAvatar := R2
 52 [-]: SETGLOBAL R2 K33       ; 0xA0B058AA := R2
 53 [-]: CLOSURE   R2 15        ; R2 := closure(Function #16)
 54 [-]: SETGLOBAL R2 K34       ; EnableDisableAttachment := R2
 55 [-]: SETGLOBAL R2 K35       ; 0x77AB1F70 := R2
 56 [-]: CLOSURE   R2 16        ; R2 := closure(Function #17)
 57 [-]: SETGLOBAL R2 K36       ; EnableDisableAttachmentOnParent := R2
 58 [-]: SETGLOBAL R2 K37       ; 0x6BC2E191 := R2
 59 [-]: CLOSURE   R2 17        ; R2 := closure(Function #18)
 60 [-]: SETGLOBAL R2 K38       ; SwapParentMesh := R2
 61 [-]: SETGLOBAL R2 K39       ; 0xD9DC6D3E := R2
 62 [-]: CLOSURE   R2 18        ; R2 := closure(Function #19)
 63 [-]: MOVE      R0 R1        ; R0 := R1
 64 [-]: SETGLOBAL R2 K40       ; ProjUpdateWorldPos := R2
 65 [-]: SETGLOBAL R2 K41       ; 0x2798347F := R2
 66 [-]: CLOSURE   R2 19        ; R2 := closure(Function #20)
 67 [-]: SETGLOBAL R2 K42       ; SleepToDisable := R2
 68 [-]: SETGLOBAL R2 K43       ; 0xE720271A := R2
 69 [-]: CLOSURE   R2 20        ; R2 := closure(Function #21)
 70 [-]: SETGLOBAL R2 K44       ; ApplyToParentIfLocal := R2
 71 [-]: SETGLOBAL R2 K45       ; 0xF6512456 := R2
 72 [-]: CLOSURE   R2 21        ; R2 := closure(Function #22)
 73 [-]: SETGLOBAL R2 K46       ; AttachBeamsToThis := R2
 74 [-]: SETGLOBAL R2 K47       ; 0x998D5DF := R2
 75 [-]: CLOSURE   R2 22        ; R2 := closure(Function #23)
 76 [-]: SETGLOBAL R2 K48       ; BeamEndPoint := R2
 77 [-]: SETGLOBAL R2 K49       ; 0x8EA236E7 := R2
