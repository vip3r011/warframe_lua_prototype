...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Effects\SimpleDecoFuntions.lua 
...
; Max Stack Size:  2
 ...
 46 [-]: SETGLOBAL R1 K28       ; HideShowTargets := R1
 47 [-]: SETGLOBAL R1 K29       ; 0x83DE389E := R1
 48 [-]: CLOSURE   R1 14        ; R1 := closure(Function #15)
 49 [-]: SETGLOBAL R1 K30       ; EnableMoveNoiseTarget := R1
 50 [-]: SETGLOBAL R1 K31       ; 0x622861BA := R1
 51 [-]: CLOSURE   R1 15        ; R1 := closure(Function #16)
 52 [-]: SETGLOBAL R1 K32       ; EnableMoveNoiseTargets := R1
 53 [-]: SETGLOBAL R1 K33       ; 0x6AD58EE5 := R1
 54 [-]: CLOSURE   R1 16        ; R1 := closure(Function #17)
 55 [-]: SETGLOBAL R1 K34       ; FreezeFxMaterials := R1
 56 [-]: SETGLOBAL R1 K35       ; 0x83594931 := R1
 57 [-]: CLOSURE   R1 17        ; R1 := closure(Function #18)
 58 [-]: SETGLOBAL R1 K36       ; CloakVectorFromCenter := R1
 59 [-]: SETGLOBAL R1 K37       ; 0x83E81767 := R1
