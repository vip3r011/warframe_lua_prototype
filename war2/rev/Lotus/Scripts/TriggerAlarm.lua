...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\TriggerAlarm.lua 
...
; Max Stack Size:  27
 ...
 62 [-]: TEST      R12 1        ; if R12 then PC := 93
 63 [-]: JMP       93           ; PC := 93
 64 [-]: TEST      R6 1         ; if R6 then PC := 93
 65 [-]: JMP       93           ; PC := 93
 ...
 85 [-]: EQ        0 R18 R5     ; if R18 ~= R5 then PC := 92
 86 [-]: JMP       92           ; PC := 92
 87 [-]: SELF      R19 R7 K15   ; R20 := R7; R19 := R7["0x8D5886B7"]
 88 [-]: LOADK     R21 K16      ; R21 := "StartPlaying"
 89 [-]: CALL      R19 3 1      ; R19(R20,R21)
 90 [-]: MOVE      R6 R1        ; R6 := R1
 91 [-]: JMP       93           ; PC := 93
 92 [-]: FORLOOP   R13 77       ; R13 += R15; if R13 <= R14 then begin PC := 77; R16 := R13 end
 93 [-]: FORLOOP   R8 57        ; R8 += R10; if R8 <= R9 then begin PC := 57; R11 := R8 end
 94 [-]: TEST      R6 0         ; if not R6 then PC := 118
 95 [-]: JMP       118          ; PC := 118
 96 [-]: GETGLOBAL R19 K17      ; R19 := gGameRules
 97 [-]: SELF      R19 R19 K18  ; R20 := R19; R19 := R19["0xD015CBDC"]
 98 [-]: GETGLOBAL R21 K19      ; R21 := 0xEC274B1A
 99 [-]: LOADK     R22 K20      ; R22 := "BossIntroMovieDelay"
100 [-]: CALL      R21 2 2      ; R21 := R21(R22)
101 [-]: GETGLOBAL R22 K21      ; R22 := math
102 [-]: GETTABLE  R22 R22 K22  ; R22 := R22["0xF7005A7B"]
103 [-]: GETGLOBAL R23 K23      ; R23 := bossIntroMovieDelay
104 [-]: MUL       R23 R23 K24  ; R23 := R23 * 1000
105 [-]: CALL      R22 2 0      ; R22,... := R22(R23)
106 [-]: CALL      R19 0 1      ; R19(R20,...)
107 [-]: GETGLOBAL R19 K25      ; R19 := gRegion
108 [-]: SELF      R19 R19 K26  ; R20 := R19; R19 := R19["0xBDD34CC6"]
109 [-]: GETGLOBAL R21 K27      ; R21 := bossCinNameType
110 [-]: SELF      R22 R1 K28   ; R23 := R1; R22 := R1["0xBBAF192"]
111 [-]: CALL      R22 2 2      ; R22 := R22(R23)
112 [-]: GETGLOBAL R23 K29      ; R23 := ZERO_ROTATION
113 [-]: MOVE      R24 R1       ; R24 := R1
114 [-]: LOADNIL   R25 R25      ; R25 := nil
115 [-]: LOADK     R26 K5       ; R26 := 1
116 [-]: CALL      R19 8 1      ; R19(R20,R21,R22,R23,R24,R25,R26)
117 [-]: JMP       121          ; PC := 121
118 [-]: GETGLOBAL R19 K9       ; R19 := 0x93B1256B
119 [-]: LOADK     R20 K30      ; R20 := "Could not find boss in cinematics for ChooseBossIntroCinematic"
120 [-]: CALL      R19 2 1      ; R19(R20)
121 [-]: GETGLOBAL R19 K17      ; R19 := gGameRules
122 [-]: GETGLOBAL R20 K2       ; R20 := 0x400E7765
123 [-]: MOVE      R21 R19      ; R21 := R19
124 [-]: CALL      R20 2 2      ; R20 := R20(R21)
125 [-]: TEST      R20 1        ; if R20 then PC := 130
126 [-]: JMP       130          ; PC := 130
127 [-]: SELF      R20 R19 K31  ; R21 := R19; R20 := R19["0x38C26D14"]
128 [-]: MOVE      R22 R1       ; R22 := R1
129 [-]: CALL      R20 3 1      ; R20(R21,R22)
130 [-]: GETGLOBAL R20 K25      ; R20 := gRegion
131 [-]: SELF      R20 R20 K32  ; R21 := R20; R20 := R20["0xD1CEF990"]
132 [-]: CALL      R20 2 2      ; R20 := R20(R21)
133 [-]: SELF      R20 R20 K33  ; R21 := R20; R20 := R20["0x20092973"]
134 [-]: CALL      R20 2 2      ; R20 := R20(R21)
135 [-]: GETGLOBAL R21 K2       ; R21 := 0x400E7765
136 [-]: MOVE      R22 R20      ; R22 := R20
137 [-]: CALL      R21 2 2      ; R21 := R21(R22)
138 [-]: TEST      R21 1        ; if R21 then PC := 154
139 [-]: JMP       154          ; PC := 154
140 [-]: SELF      R21 R20 K34  ; R22 := R20; R21 := R20["0x5259D5EB"]
141 [-]: MOVE      R23 R1       ; R23 := R1
142 [-]: CALL      R21 3 1      ; R21(R22,R23)
143 [-]: SELF      R21 R7 K35   ; R22 := R7; R21 := R7["0x55C40852"]
144 [-]: CALL      R21 2 2      ; R21 := R21(R22)
145 [-]: TEST      R21 0        ; if not R21 then PC := 151
146 [-]: JMP       151          ; PC := 151
147 [-]: GETGLOBAL R21 K36      ; R21 := 0x201191EA
148 [-]: LOADK     R22 K37      ; R22 := 0
149 [-]: CALL      R21 2 1      ; R21(R22)
150 [-]: JMP       143          ; PC := 143
151 [-]: SELF      R21 R20 K34  ; R22 := R20; R21 := R20["0x5259D5EB"]
