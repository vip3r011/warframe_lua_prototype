...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\NPC\CreateFabricator.lua 
...
109 [-]: GETGLOBAL R12 K26      ; R12 := maxLifeTime
110 [-]: LOADNIL   R13 R13      ; R13 := nil
111 [-]: GETGLOBAL R14 K10      ; R14 := gRegion
112 [-]: SELF      R14 R14 K27  ; R15 := R14; R14 := R14["0x9139A00"]
113 [-]: GETGLOBAL R16 K28      ; R16 := avatarType
114 [-]: MOVE      R17 R10      ; R17 := R10
115 [-]: LOADK     R18 K29      ; R18 := 0
116 [-]: LOADK     R19 K30      ; R19 := 100
117 [-]: CALL      R14 6 2      ; R14 := R14(R15,R16,R17,R18,R19)
118 [-]: GETGLOBAL R15 K10      ; R15 := gRegion
119 [-]: SELF      R15 R15 K31  ; R16 := R15; R15 := R15["0x848C9FE0"]
120 [-]: CALL      R15 2 2      ; R15 := R15(R16)
121 [-]: LEN       R16 R15      ; R16 := # R15
122 [-]: ADD       R16 R16 K32  ; R16 := R16 + 3
123 [-]: SELF      R17 R1 K33   ; R18 := R1; R17 := R1["0x9F13EC0B"]
124 [-]: MOVE      R19 R1       ; R19 := R1
125 [-]: CALL      R17 3 2      ; R17 := R17(R18,R19)
126 [-]: GETGLOBAL R18 K4       ; R18 := 0x400E7765
127 [-]: MOVE      R19 R6       ; R19 := R6
128 [-]: CALL      R18 2 2      ; R18 := R18(R19)
129 [-]: TEST      R18 1        ; if R18 then PC := 142
130 [-]: JMP       142          ; PC := 142
131 [-]: SELF      R18 R6 K34   ; R19 := R6; R18 := R6["0x8B598ED4"]
132 [-]: GETGLOBAL R20 K35      ; R20 := gLotusNpcAvatarType
133 [-]: CALL      R18 3 2      ; R18 := R18(R19,R20)
134 [-]: TEST      R18 0        ; if not R18 then PC := 143
135 [-]: JMP       143          ; PC := 143
136 [-]: GETGLOBAL R18 K4       ; R18 := 0x400E7765
137 [-]: SELF      R19 R6 K36   ; R20 := R6; R19 := R6["0xC000CE2E"]
138 [-]: CALL      R19 2 0      ; R19,... := R19(R20)
139 [-]: CALL      R18 0 2      ; R18 := R18(R19,...)
140 [-]: MOVE      R18 R18      ; R18 := R18
141 [-]: JMP       144          ; PC := 144
142 [-]: MOVE      R18 R0       ; R18 := R0
143 [-]: MOVE      R18 R1       ; R18 := R1
144 [-]: GETGLOBAL R19 K4       ; R19 := 0x400E7765
145 [-]: MOVE      R20 R0       ; R20 := R0
146 [-]: CALL      R19 2 2      ; R19 := R19(R20)
147 [-]: TEST      R19 1        ; if R19 then PC := 205
148 [-]: JMP       205          ; PC := 205
149 [-]: LT        0 K29 R12    ; if 0 >= R12 then PC := 205
150 [-]: JMP       205          ; PC := 205
151 [-]: TEST      R18 0        ; if not R18 then PC := 162
152 [-]: JMP       162          ; PC := 162
153 [-]: GETGLOBAL R19 K4       ; R19 := 0x400E7765
154 [-]: MOVE      R20 R6       ; R20 := R6
155 [-]: CALL      R19 2 2      ; R19 := R19(R20)
156 [-]: TEST      R19 1        ; if R19 then PC := 205
157 [-]: JMP       205          ; PC := 205
158 [-]: SELF      R19 R6 K37   ; R20 := R6; R19 := R6["0x5A115A02"]
159 [-]: CALL      R19 2 2      ; R19 := R19(R20)
160 [-]: TEST      R19 1        ; if R19 then PC := 205
161 [-]: JMP       205          ; PC := 205
162 [-]: GETGLOBAL R19 K10      ; R19 := gRegion
163 [-]: SELF      R19 R19 K27  ; R20 := R19; R19 := R19["0x9139A00"]
164 [-]: GETGLOBAL R21 K28      ; R21 := avatarType
165 [-]: MOVE      R22 R10      ; R22 := R10
166 [-]: LOADK     R23 K29      ; R23 := 0
167 [-]: LOADK     R24 K30      ; R24 := 100
168 [-]: CALL      R19 6 2      ; R19 := R19(R20,R21,R22,R23,R24)
169 [-]: MOVE      R14 R19      ; R14 := R19
170 [-]: SELF      R19 R1 K33   ; R20 := R1; R19 := R1["0x9F13EC0B"]
171 [-]: MOVE      R21 R1       ; R21 := R1
172 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
173 [-]: MOVE      R17 R19      ; R17 := R19
174 [-]: LEN       R19 R14      ; R19 := # R14
175 [-]: LT        0 R19 R16    ; if R19 >= R16 then PC := 192
176 [-]: JMP       192          ; PC := 192
177 [-]: SELF      R19 R1 K38   ; R20 := R1; R19 := R1["0x985D3E6E"]
178 [-]: CALL      R19 2 2      ; R19 := R19(R20)
179 [-]: LT        0 R17 R19    ; if R17 >= R19 then PC := 192
180 [-]: JMP       192          ; PC := 192
181 [-]: GETUPVAL  R19 U2       ; R19 := U2
182 [-]: MOVE      R20 R0       ; R20 := R0
183 [-]: MOVE      R21 R10      ; R21 := R10
184 [-]: MOVE      R22 R11      ; R22 := R11
185 [-]: MOVE      R23 R3       ; R23 := R3
186 [-]: MOVE      R24 R4       ; R24 := R4
187 [-]: MOVE      R25 R5       ; R25 := R5
188 [-]: MOVE      R26 R2       ; R26 := R2
189 [-]: MOVE      R27 R1       ; R27 := R1
190 [-]: MOVE      R28 R6       ; R28 := R6
191 [-]: CALL      R19 10 1     ; R19(R20,R21,R22,R23,R24,R25,R26,R27,R28)
192 [-]: GETGLOBAL R19 K39      ; R19 := 0x8C4A6742
193 [-]: GETGLOBAL R20 K40      ; R20 := minSpawnDelay
194 [-]: GETGLOBAL R21 K41      ; R21 := maxSpawnDelay
195 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
196 [-]: MOVE      R13 R19      ; R13 := R19
197 [-]: SUB       R19 R12 R13  ; R19 := R12 - R13
198 [-]: GETGLOBAL R20 K42      ; R20 := 0x4CDEF9FF
199 [-]: CALL      R20 1 2      ; R20 := R20()
200 [-]: SUB       R12 R19 R20  ; R12 := R19 - R20
201 [-]: GETGLOBAL R19 K24      ; R19 := 0x201191EA
202 [-]: MOVE      R20 R13      ; R20 := R13
203 [-]: CALL      R19 2 1      ; R19(R20)
204 [-]: JMP       144          ; PC := 144
205 [-]: GETGLOBAL R19 K43      ; R19 := _T
206 [-]: GETTABLE  R19 R19 K44  ; R19 := R19["fabricatorInstances"]
207 [-]: EQ        1 R19 K45    ; if R19 == nil then PC := 236
208 [-]: JMP       236          ; PC := 236
209 [-]: GETGLOBAL R19 K43      ; R19 := _T
210 [-]: GETTABLE  R19 R19 K44  ; R19 := R19["fabricatorInstances"]
211 [-]: LEN       R19 R19      ; R19 := # R19
212 [-]: LOADK     R20 K46      ; R20 := 1
213 [-]: LOADK     R21 K47      ; R21 := -1
214 [-]: FORPREP   R19 227      ; R19 -= R21; PC := 227
215 [-]: GETGLOBAL R23 K43      ; R23 := _T
216 [-]: GETTABLE  R23 R23 K44  ; R23 := R23["fabricatorInstances"]
217 [-]: GETTABLE  R23 R23 R22  ; R23 := R23[R22]
218 [-]: EQ        0 R23 R0     ; if R23 ~= R0 then PC := 227
219 [-]: JMP       227          ; PC := 227
220 [-]: GETGLOBAL R23 K48      ; R23 := table
221 [-]: GETTABLE  R23 R23 K49  ; R23 := R23["0xCDB1FD5E"]
222 [-]: GETGLOBAL R24 K43      ; R24 := _T
223 [-]: GETTABLE  R24 R24 K44  ; R24 := R24["fabricatorInstances"]
224 [-]: MOVE      R25 R22      ; R25 := R22
225 [-]: CALL      R23 3 1      ; R23(R24,R25)
226 [-]: JMP       228          ; PC := 228
227 [-]: FORLOOP   R19 215      ; R19 += R21; if R19 <= R20 then begin PC := 215; R22 := R19 end
228 [-]: GETGLOBAL R23 K50      ; R23 := 0xAA09E79D
229 [-]: GETGLOBAL R24 K43      ; R24 := _T
230 [-]: GETTABLE  R24 R24 K44  ; R24 := R24["fabricatorInstances"]
231 [-]: CALL      R23 2 2      ; R23 := R23(R24)
232 [-]: EQ        0 R23 K45    ; if R23 ~= nil then PC := 236
233 [-]: JMP       236          ; PC := 236
234 [-]: GETGLOBAL R23 K43      ; R23 := _T
235 [-]: SETTABLE  R23 K44 K45  ; R23["fabricatorInstances"] := nil
236 [-]: GETGLOBAL R23 K4       ; R23 := 0x400E7765
237 [-]: MOVE      R24 R0       ; R24 := R0
238 [-]: CALL      R23 2 2      ; R23 := R23(R24)
239 [-]: TEST      R23 1        ; if R23 then PC := 243
240 [-]: JMP       243          ; PC := 243
241 [-]: SELF      R23 R0 K8    ; R24 := R0; R23 := R0["0xD4C2743F"]
