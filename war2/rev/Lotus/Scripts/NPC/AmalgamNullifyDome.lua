...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\NPC\AmalgamNullifyDome.lua 
...
; Max Stack Size:  29
 ...
 61 [-]: JMP       65           ; PC := 65
 62 [-]: SELF      R3 R1 K10    ; R4 := R1; R3 := R1["0x13CAF481"]
...
; Max Stack Size:  17
 ...
 26 [-]: SELF      R3 R2 K7     ; R4 := R2; R3 := R2["0x13CAF481"]
