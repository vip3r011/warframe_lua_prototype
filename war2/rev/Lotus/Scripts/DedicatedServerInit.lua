...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\DedicatedServerInit.lua 
...
; Max Stack Size:  2
  ...
  3 [-]: SETTABLE  R0 K1 R1     ; R0["InitializeTerritoryHUDElements"] := R1
  4 [-]: GETGLOBAL R0 K0        ; R0 := _T
  5 [-]: CLOSURE   R1 1         ; R1 := closure(Function #2.2)
  6 [-]: SETTABLE  R0 K2 R1     ; R0["UpdateTerritoryProgress"] := R1
  7 [-]: GETGLOBAL R0 K0        ; R0 := _T
  8 [-]: CLOSURE   R1 2         ; R1 := closure(Function #2.3)
  9 [-]: SETTABLE  R0 K3 R1     ; R0["UpdateTerritoryScores"] := R1
 10 [-]: GETGLOBAL R0 K0        ; R0 := _T
 11 [-]: CLOSURE   R1 3         ; R1 := closure(Function #2.4)
 12 [-]: SETTABLE  R0 K4 R1     ; R0["HideTerritoryHUDElements"] := R1
 13 [-]: GETGLOBAL R0 K0        ; R0 := _T
 14 [-]: CLOSURE   R1 4         ; R1 := closure(Function #2.5)
 15 [-]: SETTABLE  R0 K5 R1     ; R0["InitializePvpHUDElements"] := R1
 16 [-]: GETGLOBAL R0 K0        ; R0 := _T
 17 [-]: CLOSURE   R1 5         ; R1 := closure(Function #2.6)
 18 [-]: SETTABLE  R0 K6 R1     ; R0["UpdatePvpXP"] := R1
 19 [-]: GETGLOBAL R0 K0        ; R0 := _T
 20 [-]: CLOSURE   R1 6         ; R1 := closure(Function #2.7)
 21 [-]: SETTABLE  R0 K7 R1     ; R0["ShowWeaponPanel"] := R1
 22 [-]: GETGLOBAL R0 K0        ; R0 := _T
 23 [-]: CLOSURE   R1 7         ; R1 := closure(Function #2.8)
 24 [-]: SETTABLE  R0 K8 R1     ; R0["HideWeaponPanel"] := R1
 25 [-]: GETGLOBAL R0 K0        ; R0 := _T
 26 [-]: CLOSURE   R1 8         ; R1 := closure(Function #2.9)
 27 [-]: SETTABLE  R0 K9 R1     ; R0["ShowAbilityPanel"] := R1
 28 [-]: GETGLOBAL R0 K0        ; R0 := _T
 29 [-]: CLOSURE   R1 9         ; R1 := closure(Function #2.10)
 30 [-]: SETTABLE  R0 K10 R1    ; R0["HideAbilityPanel"] := R1
 31 [-]: GETGLOBAL R0 K0        ; R0 := _T
 32 [-]: CLOSURE   R1 10        ; R1 := closure(Function #2.11)
 33 [-]: SETTABLE  R0 K11 R1    ; R0["SetAbilityTimer"] := R1
 34 [-]: GETGLOBAL R0 K0        ; R0 := _T
 35 [-]: CLOSURE   R1 11        ; R1 := closure(Function #2.12)
 36 [-]: SETTABLE  R0 K12 R1    ; R0["AddAbilityTimer"] := R1
 37 [-]: GETGLOBAL R0 K0        ; R0 := _T
 38 [-]: CLOSURE   R1 12        ; R1 := closure(Function #2.13)
 39 [-]: SETTABLE  R0 K13 R1    ; R0["SetFocusTimer"] := R1
 40 [-]: GETGLOBAL R0 K0        ; R0 := _T
 41 [-]: CLOSURE   R1 13        ; R1 := closure(Function #2.14)
 42 [-]: SETTABLE  R0 K14 R1    ; R0["AddLogMessage"] := R1
 43 [-]: GETGLOBAL R0 K0        ; R0 := _T
 44 [-]: CLOSURE   R1 14        ; R1 := closure(Function #2.15)
 45 [-]: SETTABLE  R0 K15 R1    ; R0["AddPvpKillMessage"] := R1
 46 [-]: GETGLOBAL R0 K0        ; R0 := _T
 47 [-]: CLOSURE   R1 15        ; R1 := closure(Function #2.16)
 48 [-]: SETTABLE  R0 K16 R1    ; R0["ShowImpactMessage"] := R1
 49 [-]: GETGLOBAL R0 K0        ; R0 := _T
 50 [-]: CLOSURE   R1 16        ; R1 := closure(Function #2.17)
 51 [-]: SETTABLE  R0 K17 R1    ; R0["HideImpactMessage"] := R1
 52 [-]: GETUPVAL  R0 U0        ; R0 := U0
 53 [-]: GETGLOBAL R1 K0        ; R1 := _T
 54 [-]: CALL      R0 2 1       ; R0(R1)
 55 [-]: GETUPVAL  R0 U0        ; R0 := U0
 56 [-]: GETGLOBAL R1 K18       ; R1 := _G
