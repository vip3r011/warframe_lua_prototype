...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Gameplay\GasCityAudioLogPuzzle.lua 
...
; Max Stack Size:  6
  ...
  4 [-]: SELF      R2 R1 K2     ; R3 := R1; R2 := R1["0x72E5DB62"]
 ...
 10 [-]: JMP       22           ; PC := 22
 11 [-]: SELF      R3 R2 K4     ; R4 := R2; R3 := R2["0x828F05DE"]
 ...
 17 [-]: JMP       22           ; PC := 22
 18 [-]: EQ        0 R3 R0      ; if R3 ~= R0 then PC := 22
 19 [-]: JMP       22           ; PC := 22
 20 [-]: MOVE      R4 R1        ; R4 := R1
