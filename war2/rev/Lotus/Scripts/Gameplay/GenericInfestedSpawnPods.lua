...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Gameplay\GenericInfestedSpawnPods.lua 
...
; Max Stack Size:  6
 ...
 18 [-]: MOVE      R0 R0        ; R0 := R0
 19 [-]: MOVE      R0 R1        ; R0 := R1
 20 [-]: SETGLOBAL R3 K7        ; EnemySpecTierSpawnPod := R3
 21 [-]: SETGLOBAL R3 K8        ; 0x23B8167D := R3
 22 [-]: CLOSURE   R3 4         ; R3 := closure(Function #5)
 23 [-]: MOVE      R0 R1        ; R0 := R1
 24 [-]: SETGLOBAL R3 K9        ; PodSpawnAgentType := R3
 25 [-]: SETGLOBAL R3 K10       ; 0xADD4D3FF := R3
 26 [-]: CLOSURE   R3 5         ; R3 := closure(Function #6)
 27 [-]: CLOSURE   R4 6         ; R4 := closure(Function #7)
 28 [-]: MOVE      R0 R3        ; R0 := R3
 29 [-]: MOVE      R0 R1        ; R0 := R1
 30 [-]: SETGLOBAL R4 K11       ; PodSpawnAgentFromSpec := R4
 31 [-]: SETGLOBAL R4 K12       ; 0x67C3C5AA := R4
 32 [-]: CLOSURE   R4 7         ; R4 := closure(Function #8)
 33 [-]: CLOSURE   R5 8         ; R5 := closure(Function #9)
 34 [-]: MOVE      R0 R3        ; R0 := R3
 35 [-]: MOVE      R0 R1        ; R0 := R1
 36 [-]: MOVE      R0 R4        ; R0 := R4
 37 [-]: SETGLOBAL R5 K13       ; EndlessLampPumpkin := R5
 38 [-]: SETGLOBAL R5 K14       ; 0x3FBDA58A := R5
 39 [-]: CLOSURE   R5 9         ; R5 := closure(Function #10)
 40 [-]: MOVE      R0 R4        ; R0 := R4
 41 [-]: SETGLOBAL R5 K15       ; EndlessLampExplodingPumpkinTotem := R5
 42 [-]: SETGLOBAL R5 K16       ; 0xDDBCFDF3 := R5
 43 [-]: CLOSURE   R5 10        ; R5 := closure(Function #11)
 44 [-]: MOVE      R0 R3        ; R0 := R3
 45 [-]: SETGLOBAL R5 K17       ; PodDestroyTrigger := R5
 46 [-]: SETGLOBAL R5 K18       ; 0xAFD00318 := R5
...
; Max Stack Size:  22
 ...
 11 [-]: TEST      R1 0         ; if not R1 then PC := 108
 12 [-]: JMP       108          ; PC := 108
 13 [-]: LOADK     R1 K5        ; R1 := 0
 ...
 22 [-]: SELF      R5 R0 K11    ; R6 := R0; R5 := R0["0x6DA72501"]
 23 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 24 [-]: SELF      R6 R0 K12    ; R7 := R0; R6 := R0["0xF23A7849"]
 25 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 26 [-]: GETUPVAL  R7 U1        ; R7 := U1
 27 [-]: GETTABLE  R7 R7 K13    ; R7 := R7["0xAFDC233F"]
 28 [-]: GETGLOBAL R8 K14       ; R8 := enemySpecTier
 29 [-]: MOVE      R9 R1        ; R9 := R1
 ...
 36 [-]: JMP       40           ; PC := 40
 37 [-]: SELF      R8 R3 K16    ; R9 := R3; R8 := R3["0xEAE3D1F0"]
 38 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 39 [-]: MOVE      R4 R8        ; R4 := R8
 40 [-]: GETGLOBAL R8 K17       ; R8 := math
 41 [-]: GETTABLE  R8 R8 K18    ; R8 := R8["0x865961F7"]
 42 [-]: CALL      R8 1 2       ; R8 := R8()
 43 [-]: GETGLOBAL R9 K19       ; R9 := minEximusSpawnLevel
 44 [-]: LE        0 R9 R4      ; if R9 > R4 then PC := 59
 45 [-]: JMP       59           ; PC := 59
 46 [-]: GETGLOBAL R9 K15       ; R9 := 0x400E7765
 47 [-]: GETGLOBAL R10 K9       ; R10 := _T
 48 [-]: GETTABLE  R10 R10 K20  ; R10 := R10["eximusChance"]
 49 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 50 [-]: TEST      R9 1         ; if R9 then PC := 59
 51 [-]: JMP       59           ; PC := 59
 52 [-]: GETGLOBAL R9 K9        ; R9 := _T
 53 [-]: GETTABLE  R9 R9 K20    ; R9 := R9["eximusChance"]
 54 [-]: LE        0 R8 R9      ; if R8 > R9 then PC := 59
 55 [-]: JMP       59           ; PC := 59
 56 [-]: MOVE      R9 R1        ; R9 := R1
 57 [-]: SETGLOBAL R9 K21       ; isEximus := R9
 58 [-]: JMP       61           ; PC := 61
 59 [-]: GETGLOBAL R9 K22       ; R9 := nonEximusLevelMult
 60 [-]: MUL       R4 R4 R9     ; R4 := R4 * R9
 61 [-]: LOADNIL   R9 R9        ; R9 := nil
 62 [-]: GETGLOBAL R10 K23      ; R10 := timeToLive
 63 [-]: LE        0 R1 R10     ; if R1 > R10 then PC := 105
 64 [-]: JMP       105          ; PC := 105
 65 [-]: GETGLOBAL R10 K15      ; R10 := 0x400E7765
 66 [-]: MOVE      R11 R9       ; R11 := R9
 67 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 68 [-]: TEST      R10 0        ; if not R10 then PC := 105
 69 [-]: JMP       105          ; PC := 105
 70 [-]: SELF      R10 R3 K24   ; R11 := R3; R10 := R3["0x1A0125F1"]
 71 [-]: MOVE      R12 R7       ; R12 := R7
 72 [-]: MOVE      R13 R5       ; R13 := R5
 73 [-]: MOVE      R14 R6       ; R14 := R6
 74 [-]: GETGLOBAL R15 K25      ; R15 := 0xEC274B1A
 75 [-]: LOADK     R16 K26      ; R16 := "RandomTeam"
 76 [-]: CALL      R15 2 2      ; R15 := R15(R16)
 77 [-]: MOVE      R16 R4       ; R16 := R4
 78 [-]: GETGLOBAL R17 K27      ; R17 := spawnAnim
 79 [-]: GETUPVAL  R18 U2       ; R18 := U2
 80 [-]: GETTABLE  R18 R18 K28  ; R18 := R18["0xF81722A2"]
 81 [-]: GETGLOBAL R19 K21      ; R19 := isEximus
 82 [-]: GETGLOBAL R20 K29      ; R20 := Engine
 83 [-]: GETTABLE  R20 R20 K30  ; R20 := R20["EXIMUS"]
 84 [-]: GETGLOBAL R21 K29      ; R21 := Engine
 85 [-]: GETTABLE  R21 R21 K31  ; R21 := R21["STANDARD"]
 86 [-]: CALL      R18 4 0      ; R18,... := R18(R19,R20,R21)
 87 [-]: CALL      R10 0 2      ; R10 := R10(R11,...)
 88 [-]: MOVE      R9 R10       ; R9 := R10
 89 [-]: GETGLOBAL R10 K15      ; R10 := 0x400E7765
 90 [-]: MOVE      R11 R9       ; R11 := R9
 91 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 92 [-]: TEST      R10 1        ; if R10 then PC := 100
 93 [-]: JMP       100          ; PC := 100
 94 [-]: SELF      R10 R9 K32   ; R11 := R9; R10 := R9["0x91ACEF1D"]
 95 [-]: CALL      R10 2 1      ; R10(R11)
 96 [-]: GETGLOBAL R10 K33      ; R10 := 0x201191EA
 97 [-]: LOADK     R11 K34      ; R11 := 2
 98 [-]: CALL      R10 2 1      ; R10(R11)
 99 [-]: JMP       105          ; PC := 105
100 [-]: ADD       R1 R1 R2     ; R1 := R1 + R2
101 [-]: GETGLOBAL R10 K33      ; R10 := 0x201191EA
102 [-]: MOVE      R11 R2       ; R11 := R2
103 [-]: CALL      R10 2 1      ; R10(R11)
104 [-]: JMP       62           ; PC := 62
105 [-]: SELF      R10 R0 K35   ; R11 := R0; R10 := R0["0xD4C2743F"]
