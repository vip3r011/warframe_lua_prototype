...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Restoratives\HunterTrap.lua 
...
; Max Stack Size:  18
 ...
 44 [-]: LT        0 R9 R10     ; if R9 >= R10 then PC := 88
 45 [-]: JMP       88           ; PC := 88
 46 [-]: GETGLOBAL R10 K13      ; R10 := 0x400E7765
 47 [-]: MOVE      R11 R0       ; R11 := R0
 48 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 49 [-]: TEST      R10 1        ; if R10 then PC := 88
 50 [-]: JMP       88           ; PC := 88
 51 [-]: SELF      R10 R0 K18   ; R11 := R0; R10 := R0["0x5A115A02"]
 52 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 53 [-]: TEST      R10 1        ; if R10 then PC := 88
 54 [-]: JMP       88           ; PC := 88
 55 [-]: GETGLOBAL R10 K13      ; R10 := 0x400E7765
 56 [-]: MOVE      R11 R1       ; R11 := R1
 57 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 58 [-]: TEST      R10 1        ; if R10 then PC := 88
 59 [-]: JMP       88           ; PC := 88
 60 [-]: GETGLOBAL R10 K19      ; R10 := 0x4CDEF9FF
 61 [-]: CALL      R10 1 2      ; R10 := R10()
 62 [-]: ADD       R9 R9 R10    ; R9 := R9 + R10
 63 [-]: GETGLOBAL R10 K13      ; R10 := 0x400E7765
 64 [-]: MOVE      R11 R0       ; R11 := R0
 65 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 66 [-]: TEST      R10 1        ; if R10 then PC := 84
 67 [-]: JMP       84           ; PC := 84
 68 [-]: SELF      R10 R0 K20   ; R11 := R0; R10 := R0["0x3F5B8C5E"]
 69 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 70 [-]: TEST      R10 1        ; if R10 then PC := 84
 71 [-]: JMP       84           ; PC := 84
 72 [-]: SELF      R10 R0 K1    ; R11 := R0; R10 := R0["0xBA0051C5"]
 73 [-]: GETGLOBAL R12 K2       ; R12 := 0xEC274B1A
 74 [-]: LOADK     R13 K21      ; R13 := "STASIS_LOOP"
 75 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 76 [-]: MOVE      R13 R0       ; R13 := R0
 77 [-]: GETGLOBAL R14 K4       ; R14 := Engine
 78 [-]: GETTABLE  R14 R14 K5   ; R14 := R14["ATMM_ANIMATION_DRIVEN"]
 79 [-]: GETGLOBAL R15 K4       ; R15 := Engine
 80 [-]: GETTABLE  R15 R15 K22  ; R15 := R15["PRT_LOOP"]
 ...
 85 [-]: LOADK     R11 K16      ; R11 := 0
 86 [-]: CALL      R10 2 1      ; R10(R11)
 87 [-]: JMP       43           ; PC := 43
 88 [-]: GETGLOBAL R10 K13      ; R10 := 0x400E7765
 89 [-]: MOVE      R11 R0       ; R11 := R0
 90 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 91 [-]: TEST      R10 0        ; if not R10 then PC := 103
 92 [-]: JMP       103          ; PC := 103
 93 [-]: SELF      R10 R0 K24   ; R11 := R0; R10 := R0["0xF18FC6E4"]
 94 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 95 [-]: TEST      R10 1        ; if R10 then PC := 103
 96 [-]: JMP       103          ; PC := 103
 97 [-]: SELF      R10 R0 K25   ; R11 := R0; R10 := R0["0x495F554F"]
 98 [-]: GETGLOBAL R12 K26      ; R12 := Lotus_Game
 99 [-]: GETTABLE  R12 R12 K27  ; R12 := R12["AR_IMMUNE_ALL"]
100 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
101 [-]: TEST      R10 0        ; if not R10 then PC := 122
102 [-]: JMP       122          ; PC := 122
103 [-]: SELF      R10 R0 K20   ; R11 := R0; R10 := R0["0x3F5B8C5E"]
104 [-]: CALL      R10 2 2      ; R10 := R10(R11)
105 [-]: TEST      R10 0        ; if not R10 then PC := 119
106 [-]: JMP       119          ; PC := 119
107 [-]: SELF      R10 R0 K1    ; R11 := R0; R10 := R0["0xBA0051C5"]
108 [-]: GETGLOBAL R12 K2       ; R12 := 0xEC274B1A
109 [-]: LOADK     R13 K28      ; R13 := "STASIS_END"
110 [-]: CALL      R12 2 2      ; R12 := R12(R13)
111 [-]: MOVE      R13 R0       ; R13 := R0
112 [-]: GETGLOBAL R14 K4       ; R14 := Engine
113 [-]: GETTABLE  R14 R14 K5   ; R14 := R14["ATMM_ANIMATION_DRIVEN"]
114 [-]: GETGLOBAL R15 K4       ; R15 := Engine
115 [-]: GETTABLE  R15 R15 K6   ; R15 := R15["PRT_ONCE"]
...
122 [-]: GETGLOBAL R10 K13      ; R10 := 0x400E7765
123 [-]: SELF      R11 R0 K14   ; R12 := R0; R11 := R0["0xABD9DD93"]
124 [-]: CALL      R11 2 0      ; R11,... := R11(R12)
125 [-]: CALL      R10 0 2      ; R10 := R10(R11,...)
126 [-]: TEST      R10 1        ; if R10 then PC := 140
127 [-]: JMP       140          ; PC := 140
128 [-]: SELF      R10 R0 K14   ; R11 := R0; R10 := R0["0xABD9DD93"]
129 [-]: CALL      R10 2 2      ; R10 := R10(R11)
130 [-]: SELF      R10 R10 K29  ; R11 := R10; R10 := R10["0x6498BCED"]
131 [-]: CALL      R10 2 2      ; R10 := R10(R11)
132 [-]: TEST      R10 0        ; if not R10 then PC := 140
133 [-]: JMP       140          ; PC := 140
134 [-]: SELF      R10 R0 K14   ; R11 := R0; R10 := R0["0xABD9DD93"]
135 [-]: CALL      R10 2 2      ; R10 := R10(R11)
136 [-]: SELF      R10 R10 K15  ; R11 := R10; R10 := R10["0x3DE5CD9B"]
137 [-]: MOVE      R12 R0       ; R12 := R0
138 [-]: GETUPVAL  R13 U0       ; R13 := U0
139 [-]: CALL      R10 4 1      ; R10(R11,R12,R13)
140 [-]: SELF      R10 R1 K30   ; R11 := R1; R10 := R1["0xD4C2743F"]
