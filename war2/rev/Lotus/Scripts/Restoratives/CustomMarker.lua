...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Restoratives\CustomMarker.lua 
...
; Max Stack Size:  7
 ...
 25 [-]: SELF      R4 R2 K2     ; R5 := R2; R4 := R2["0x4DC1D041"]
 26 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 27 [-]: MOVE      R3 R4        ; R3 := R4
 28 [-]: JMP       17           ; PC := 17
 ...
 33 [-]: JMP       41           ; PC := 41
 34 [-]: GETGLOBAL R4 K5        ; R4 := gRegion
 35 [-]: SELF      R4 R4 K6     ; R5 := R4; R4 := R4["0x372CB914"]
 36 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 37 [-]: EQ        0 R3 R4      ; if R3 ~= R4 then PC := 41
 38 [-]: JMP       41           ; PC := 41
 39 [-]: SELF      R4 R0 K7     ; R5 := R0; R4 := R0["0xC5E91BA6"]
