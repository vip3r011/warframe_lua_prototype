...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Libs\SquadLink.lua 
...
; Max Stack Size:  4
  ...
  1 [-]: GETGLOBAL R0 K0        ; R0 := gGameRules
  2 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0["0xD4E81DA5"]
  3 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  ...
  9 [-]: LOADK     R3 K4        ; R3 := "SquadLink_AcceptingLinks"
 10 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 11 [-]: LOADK     R3 K5        ; R3 := 0
 12 [-]: CALL      R0 4 2       ; R0 := R0(R1,R2,R3)
 13 [-]: LT        1 K5 R0      ; if 0 < R0 then PC := 16
 14 [-]: JMP       16           ; PC := 16
 15 [-]: MOVE      R0 R0        ; R0 := R0
 16 [-]: MOVE      R0 R1        ; R0 := R1
