...
; Command line was: -dis C:\war2\raw\Lotus\Scripts\Libs\CommonGamemodeFunctions.lua 
...
145 [-]: SETGLOBAL R5 K87       ; GetRandomEnemySpecType := R5
146 [-]: SETGLOBAL R5 K88       ; 0xAFDC233F := R5
147 [-]: CLOSURE   R5 46        ; R5 := closure(Function #47)
148 [-]: SETGLOBAL R5 K89       ; HasExtraEnemyTier := R5
149 [-]: SETGLOBAL R5 K90       ; 0xC3DD7E20 := R5
150 [-]: CLOSURE   R5 47        ; R5 := closure(Function #48)
151 [-]: SETGLOBAL R5 K91       ; SoloRemoveEnemies := R5
152 [-]: SETGLOBAL R5 K92       ; 0xC150BE34 := R5
153 [-]: CLOSURE   R5 48        ; R5 := closure(Function #49)
154 [-]: MOVE      R0 R0        ; R0 := R0
155 [-]: SETGLOBAL R5 K93       ; PulseMarker := R5
156 [-]: SETGLOBAL R5 K94       ; 0xB4EF7E99 := R5
157 [-]: CLOSURE   R5 49        ; R5 := closure(Function #50)
158 [-]: SETGLOBAL R5 K95       ; FormatTime := R5
159 [-]: SETGLOBAL R5 K96       ; 0x60B8E0BF := R5
160 [-]: LOADK     R5 K98       ; R5 := 1
161 [-]: SETGLOBAL R5 K97       ; MODE_START := R5
162 [-]: LOADK     R5 K100      ; R5 := 2
163 [-]: SETGLOBAL R5 K99       ; ROUND_STARTED := R5
164 [-]: LOADK     R5 K102      ; R5 := 3
165 [-]: SETGLOBAL R5 K101      ; ROUND_ENDED := R5
166 [-]: LOADK     R5 K104      ; R5 := 4
167 [-]: SETGLOBAL R5 K103      ; INTERMISSION := R5
168 [-]: LOADK     R5 K106      ; R5 := 5
169 [-]: SETGLOBAL R5 K105      ; MODE_FAILED := R5
170 [-]: LOADK     R5 K108      ; R5 := 6
171 [-]: SETGLOBAL R5 K107      ; MODE_COMPLETE := R5
172 [-]: CLOSURE   R5 50        ; R5 := closure(Function #51)
173 [-]: SETGLOBAL R5 K109      ; CreateModeMgr := R5
174 [-]: SETGLOBAL R5 K110      ; 0x9CFBD10A := R5
175 [-]: CLOSURE   R5 51        ; R5 := closure(Function #52)
176 [-]: MOVE      R0 R3        ; R0 := R3
177 [-]: SETGLOBAL R5 K111      ; GenerateOrokinLockHints := R5
178 [-]: SETGLOBAL R5 K112      ; 0xA9531AD5 := R5
...
; Max Stack Size:  14
  ...
  2 [-]: SELF      R4 R3 K1     ; R5 := R3; R4 := R3["0xB8637349"]
  3 [-]: CALL      R4 2 2       ; R4 := R4(R5)
  4 [-]: LOADK     R5 K2        ; R5 := 0
  5 [-]: LOADNIL   R6 R6        ; R6 := nil
  6 [-]: TEST      R2 0         ; if not R2 then PC := 12
  7 [-]: JMP       12           ; PC := 12
  8 [-]: SELF      R7 R4 K3     ; R8 := R4; R7 := R4["0x25B6E3D"]
  9 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 10 [-]: MOVE      R6 R7        ; R6 := R7
 11 [-]: JMP       15           ; PC := 15
 12 [-]: SELF      R7 R4 K4     ; R8 := R4; R7 := R4["0x70C51B59"]
 13 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 14 [-]: MOVE      R6 R7        ; R6 := R7
 15 [-]: GETGLOBAL R7 K5        ; R7 := 0x400E7765
 16 [-]: MOVE      R8 R6        ; R8 := R6
 17 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 18 [-]: TEST      R7 1         ; if R7 then PC := 54
 19 [-]: JMP       54           ; PC := 54
 20 [-]: LEN       R7 R6        ; R7 := # R6
 21 [-]: LT        0 K2 R7      ; if 0 >= R7 then PC := 54
 22 [-]: JMP       54           ; PC := 54
 23 [-]: LE        0 R5 K6      ; if R5 > 10 then PC := 51
 24 [-]: JMP       51           ; PC := 51
 25 [-]: GETGLOBAL R7 K7        ; R7 := 0x7FD4B57D
 26 [-]: LOADK     R8 K8        ; R8 := 1
 27 [-]: LEN       R9 R6        ; R9 := # R6
 28 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 29 [-]: GETTABLE  R8 R6 R7     ; R8 := R6[R7]
 30 [-]: GETTABLE  R9 R8 K9     ; R9 := R8["tier"]
 31 [-]: TEST      R1 0         ; if not R1 then PC := 35
 32 [-]: JMP       35           ; PC := 35
 33 [-]: EQ        1 R9 R0      ; if R9 == R0 then PC := 39
 34 [-]: JMP       39           ; PC := 39
 35 [-]: TEST      R1 1         ; if R1 then PC := 44
 36 [-]: JMP       44           ; PC := 44
 37 [-]: LE        0 R9 R0      ; if R9 > R0 then PC := 44
 38 [-]: JMP       44           ; PC := 44
 39 [-]: GETTABLE  R10 R8 K10   ; R10 := R8["agent"]
 40 [-]: GETGLOBAL R11 K11      ; R11 := 0xCAA43ABB
 41 [-]: MOVE      R12 R10      ; R12 := R10
 42 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 43 [-]: RETURN    R11 2        ; return R11
 44 [-]: GETGLOBAL R12 K12      ; R12 := 0x4CDEF9FF
 45 [-]: CALL      R12 1 2      ; R12 := R12()
 46 [-]: ADD       R9 R9 R12    ; R9 := R9 + R12
 47 [-]: GETGLOBAL R12 K13      ; R12 := 0x201191EA
 48 [-]: LOADK     R13 K2       ; R13 := 0
 49 [-]: CALL      R12 2 1      ; R12(R13)
 50 [-]: JMP       23           ; PC := 23
 51 [-]: GETGLOBAL R12 K14      ; R12 := 0x93B1256B
 52 [-]: LOADK     R13 K15      ; R13 := "GetRandomEnemySpecType timed out!"
...
; Max Stack Size:  4
  ...
  7 [-]: CLOSURE   R2 0         ; R2 := closure(Function #51.1)
  8 [-]: SETTABLE  R1 K4 R2     ; R1["GetHumanReadableState"] := R2
  9 [-]: CLOSURE   R2 1         ; R2 := closure(Function #51.2)
 10 [-]: SETTABLE  R1 K5 R2     ; R1["SetModeState"] := R2
 11 [-]: CLOSURE   R2 2         ; R2 := closure(Function #51.3)
