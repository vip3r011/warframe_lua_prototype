...
; Command line was: -dis C:\war2\raw\Lotus\Powersuits\PowersuitAbilities\RangerSteal.lua 
...
; Max Stack Size:  26
 ...
 20 [-]: TEST      R2 0         ; if not R2 then PC := 85
 21 [-]: JMP       85           ; PC := 85
 ...
 44 [-]: GETGLOBAL R9 K15       ; R9 := mOwner
 45 [-]: SELF      R9 R9 K16    ; R10 := R9; R9 := R9["0xD4EAD9FA"]
 46 [-]: GETGLOBAL R11 K10      ; R11 := 0xEC274B1A
 47 [-]: LOADK     R12 K17      ; R12 := "MeleeHit"
 48 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 49 [-]: MOVE      R12 R1       ; R12 := R1
 50 [-]: CALL      R9 4 1       ; R9(R10,R11,R12)
 51 [-]: TEST      R4 0         ; if not R4 then PC := 147
 52 [-]: JMP       147          ; PC := 147
 53 [-]: SELF      R9 R6 K18    ; R10 := R6; R9 := R6["0x87845AD6"]
 54 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 55 [-]: GETGLOBAL R10 K19      ; R10 := 0x63B09107
 56 [-]: GETUPVAL  R11 U2       ; R11 := U2
 57 [-]: CALL      R10 2 4      ; R10,R11,R12 := R10(R11)
 58 [-]: JMP       70           ; PC := 70
 59 [-]: SELF      R15 R1 K20   ; R16 := R1; R15 := R1["0x4223704F"]
 ...
 65 [-]: TEST      R15 1        ; if R15 then PC := 70
 66 [-]: JMP       70           ; PC := 70
 67 [-]: SELF      R15 R9 K20   ; R16 := R9; R15 := R9["0x4223704F"]
 68 [-]: MOVE      R17 R14      ; R17 := R14
 69 [-]: CALL      R15 3 1      ; R15(R16,R17)
 70 [-]: TFORLOOP  R10 2        ; R13,R14 :=  R10(R11,R12); if R13 ~= nil then begin PC = 59; R12 := R13 end
 71 [-]: JMP       59           ; PC := 59
 72 [-]: GETGLOBAL R15 K21      ; R15 := gRegion
 73 [-]: SELF      R15 R15 K22  ; R16 := R15; R15 := R15["0xA559F558"]
 74 [-]: CALL      R15 2 2      ; R15 := R15(R16)
 75 [-]: TEST      R15 0        ; if not R15 then PC := 147
 76 [-]: JMP       147          ; PC := 147
 77 [-]: SELF      R15 R6 K23   ; R16 := R6; R15 := R6["0x3B1B11B9"]
 ...
 86 [-]: GETTABLE  R15 R15 K27  ; R15 := R15["0x8A8F2154"]
 ...
 92 [-]: JMP       102          ; PC := 102
 93 [-]: SELF      R15 R1 K8    ; R16 := R1; R15 := R1["0xAB436EF2"]
 94 [-]: GETGLOBAL R17 K28      ; R17 := exitStealEffect
 95 [-]: GETGLOBAL R18 K10      ; R18 := 0xEC274B1A
 96 [-]: LOADK     R19 K11      ; R19 := "GAME_C1_HIP1"
 97 [-]: CALL      R18 2 2      ; R18 := R18(R19)
 98 [-]: GETGLOBAL R19 K12      ; R19 := ZERO_VECTOR
 99 [-]: GETGLOBAL R20 K13      ; R20 := ZERO_ROTATION
100 [-]: MOVE      R21 R1       ; R21 := R1
101 [-]: CALL      R15 7 1      ; R15(R16,R17,R18,R19,R20,R21)
102 [-]: TEST      R5 0         ; if not R5 then PC := 107
103 [-]: JMP       107          ; PC := 107
104 [-]: GETUPVAL  R15 U0       ; R15 := U0
105 [-]: GETTABLE  R15 R15 K29  ; R15 := R15["0x9C5E40D4"]
106 [-]: CALL      R15 1 1      ; R15()
107 [-]: GETGLOBAL R15 K15      ; R15 := mOwner
108 [-]: SELF      R15 R15 K16  ; R16 := R15; R15 := R15["0xD4EAD9FA"]
109 [-]: GETGLOBAL R17 K10      ; R17 := 0xEC274B1A
110 [-]: LOADK     R18 K17      ; R18 := "MeleeHit"
111 [-]: CALL      R17 2 2      ; R17 := R17(R18)
112 [-]: MOVE      R18 R0       ; R18 := R0
113 [-]: CALL      R15 4 1      ; R15(R16,R17,R18)
114 [-]: TEST      R4 0         ; if not R4 then PC := 147
115 [-]: JMP       147          ; PC := 147
116 [-]: SELF      R15 R6 K18   ; R16 := R6; R15 := R6["0x87845AD6"]
117 [-]: CALL      R15 2 2      ; R15 := R15(R16)
118 [-]: GETGLOBAL R16 K19      ; R16 := 0x63B09107
119 [-]: GETUPVAL  R17 U2       ; R17 := U2
120 [-]: CALL      R16 2 4      ; R16,R17,R18 := R16(R17)
121 [-]: JMP       133          ; PC := 133
122 [-]: SELF      R21 R1 K30   ; R22 := R1; R21 := R1["0x4100A6A2"]
123 [-]: MOVE      R23 R20      ; R23 := R20
124 [-]: CALL      R21 3 1      ; R21(R22,R23)
125 [-]: GETGLOBAL R21 K4       ; R21 := 0x400E7765
126 [-]: MOVE      R22 R15      ; R22 := R15
127 [-]: CALL      R21 2 2      ; R21 := R21(R22)
128 [-]: TEST      R21 1        ; if R21 then PC := 133
129 [-]: JMP       133          ; PC := 133
130 [-]: SELF      R21 R15 K30  ; R22 := R15; R21 := R15["0x4100A6A2"]
131 [-]: MOVE      R23 R20      ; R23 := R20
132 [-]: CALL      R21 3 1      ; R21(R22,R23)
133 [-]: TFORLOOP  R16 2        ; R19,R20 :=  R16(R17,R18); if R19 ~= nil then begin PC = 122; R18 := R19 end
134 [-]: JMP       122          ; PC := 122
135 [-]: GETGLOBAL R21 K21      ; R21 := gRegion
136 [-]: SELF      R21 R21 K22  ; R22 := R21; R21 := R21["0xA559F558"]
137 [-]: CALL      R21 2 2      ; R21 := R21(R22)
138 [-]: TEST      R21 0        ; if not R21 then PC := 147
139 [-]: JMP       147          ; PC := 147
140 [-]: SELF      R21 R6 K31   ; R22 := R6; R21 := R6["0xF21555A7"]
141 [-]: GETGLOBAL R23 K24      ; R23 := Game
142 [-]: GETTABLE  R23 R23 K25  ; R23 := R23["AVATAR_MOVEMENT_SPEED"]
143 [-]: GETGLOBAL R24 K24      ; R24 := Game
144 [-]: GETTABLE  R24 R24 K26  ; R24 := R24["STACKING_MULTIPLY"]
145 [-]: GETUPVAL  R25 U3       ; R25 := U3
146 [-]: CALL      R21 5 1      ; R21(R22,R23,R24,R25)
147 [-]: GETGLOBAL R21 K4       ; R21 := 0x400E7765
148 [-]: MOVE      R22 R8       ; R22 := R8
149 [-]: CALL      R21 2 2      ; R21 := R21(R22)
150 [-]: TEST      R21 1        ; if R21 then PC := 156
151 [-]: JMP       156          ; PC := 156
152 [-]: SELF      R21 R8 K32   ; R22 := R8; R21 := R8["0x677CA4B7"]
153 [-]: CALL      R21 2 2      ; R21 := R21(R22)
154 [-]: TEST      R21 1        ; if R21 then PC := 161
155 [-]: JMP       161          ; PC := 161
156 [-]: SELF      R21 R1 K33   ; R22 := R1; R21 := R1["0x4D09A963"]
157 [-]: CALL      R21 2 2      ; R21 := R21(R22)
158 [-]: SELF      R21 R21 K34  ; R22 := R21; R21 := R21["0x8AB620C1"]
159 [-]: MOVE      R23 R2       ; R23 := R2
160 [-]: CALL      R21 3 1      ; R21(R22,R23)
161 [-]: TEST      R2 0         ; if not R2 then PC := 169
162 [-]: JMP       169          ; PC := 169
163 [-]: TEST      R3 0         ; if not R3 then PC := 169
164 [-]: JMP       169          ; PC := 169
165 [-]: SELF      R21 R1 K35   ; R22 := R1; R21 := R1["0x53F87356"]
166 [-]: CALL      R21 2 2      ; R21 := R21(R22)
167 [-]: SELF      R21 R21 K36  ; R22 := R21; R21 := R21["0x132080D5"]
...
501 [-]: JMP       506          ; PC := 506
502 [-]: SELF      R59 R58 K106 ; R60 := R58; R59 := R58["0x13CAF481"]
