...
; Command line was: -dis C:\war2\raw\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\SpawnRushers.lua 
...
; Max Stack Size:  19
 ...
 11 [-]: JMP       15           ; PC := 15
 12 [-]: SELF      R1 R0 K4     ; R2 := R0; R1 := R0["0x13CAF481"]
 ...
 28 [-]: SELF      R4 R4 K11    ; R5 := R4; R4 := R4["0x20092973"]
 29 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 30 [-]: MOVE      R3 R4        ; R3 := R4
 31 [-]: GETGLOBAL R4 K12       ; R4 := 0x7FD4B57D
 32 [-]: GETGLOBAL R5 K13       ; R5 := minCount
 33 [-]: GETGLOBAL R6 K14       ; R6 := maxCount
 34 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
 35 [-]: SELF      R5 R0 K15    ; R6 := R0; R5 := R0["0xBF8DC153"]
 36 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 37 [-]: LOADK     R6 K16       ; R6 := 1
 38 [-]: MOVE      R7 R4        ; R7 := R4
 39 [-]: LOADK     R8 K16       ; R8 := 1
 40 [-]: FORPREP   R6 110       ; R6 -= R8; PC := 110
 41 [-]: GETGLOBAL R10 K17      ; R10 := 0xA0DB3B89
 42 [-]: MOVE      R11 R2       ; R11 := R2
 43 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 44 [-]: GETGLOBAL R11 K18      ; R11 := forwardSpawnOffset
 45 [-]: MUL       R11 R10 R11  ; R11 := R10 * R11
 46 [-]: ADD       R1 R1 R11    ; R1 := R1 + R11
 47 [-]: SELF      R11 R3 K19   ; R12 := R3; R11 := R3["0x40B7DF0F"]
 48 [-]: MOVE      R13 R1       ; R13 := R1
 49 [-]: CALL      R11 3 2      ; R11 := R11(R12,R13)
 50 [-]: MOVE      R1 R11       ; R1 := R11
 51 [-]: GETTABLE  R11 R1 K20   ; R11 := R1["y"]
 52 [-]: ADD       R11 R11 K21  ; R11 := R11 + 0.5
 53 [-]: SETTABLE  R1 K20 R11   ; R1["y"] := R11
 54 [-]: GETGLOBAL R11 K22      ; R11 := 0x93B1256B
 55 [-]: LOADK     R12 K23      ; R12 := "Spawning rusher at "
 56 [-]: GETGLOBAL R13 K24      ; R13 := 0x9FAED6BC
 57 [-]: GETTABLE  R14 R1 K25   ; R14 := R1["x"]
 58 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 59 [-]: LOADK     R14 K26      ; R14 := ", "
 60 [-]: GETGLOBAL R15 K24      ; R15 := 0x9FAED6BC
 61 [-]: GETTABLE  R16 R1 K20   ; R16 := R1["y"]
 62 [-]: CALL      R15 2 2      ; R15 := R15(R16)
 63 [-]: LOADK     R16 K26      ; R16 := ", "
 64 [-]: GETGLOBAL R17 K24      ; R17 := 0x9FAED6BC
 65 [-]: GETTABLE  R18 R1 K27   ; R18 := R1["z"]
 66 [-]: CALL      R17 2 2      ; R17 := R17(R18)
 67 [-]: CONCAT    R12 R12 R17  ; R12 := R12 .. R13 .. R14 .. R15 .. R16 .. R17
 68 [-]: CALL      R11 2 1      ; R11(R12)
 69 [-]: GETGLOBAL R11 K0       ; R11 := gRegion
 70 [-]: SELF      R11 R11 K28  ; R12 := R11; R11 := R11["0xBDD34CC6"]
 71 [-]: GETGLOBAL R13 K29      ; R13 := rusherAvatarType
 72 [-]: MOVE      R14 R1       ; R14 := R1
 73 [-]: MOVE      R15 R2       ; R15 := R2
 74 [-]: CALL      R11 5 2      ; R11 := R11(R12,R13,R14,R15)
 75 [-]: GETGLOBAL R12 K30      ; R12 := math
 76 [-]: GETTABLE  R12 R12 K31  ; R12 := R12["0x32396E6F"]
 77 [-]: MOVE      R13 R9       ; R13 := R9
 78 [-]: GETGLOBAL R14 K32      ; R14 := rotVar
 79 [-]: LEN       R14 R14      ; R14 := # R14
 80 [-]: CALL      R12 3 2      ; R12 := R12(R13,R14)
 81 [-]: ADD       R12 R12 K16  ; R12 := R12 + 1
 82 [-]: GETTABLE  R13 R2 K33   ; R13 := R2["heading"]
 83 [-]: GETGLOBAL R14 K32      ; R14 := rotVar
 84 [-]: GETTABLE  R14 R14 R12  ; R14 := R14[R12]
 85 [-]: ADD       R13 R13 R14  ; R13 := R13 + R14
 86 [-]: SETTABLE  R2 K33 R13   ; R2["heading"] := R13
 87 [-]: SELF      R13 R11 K34  ; R14 := R11; R13 := R11["0xB494811D"]
 88 [-]: GETGLOBAL R15 K35      ; R15 := rusherAgentType
 89 [-]: GETUPVAL  R16 U1       ; R16 := U1
 90 [-]: MOVE      R17 R5       ; R17 := R5
 91 [-]: MOVE      R18 R1       ; R18 := R1
 92 [-]: CALL      R13 6 1      ; R13(R14,R15,R16,R17,R18)
 93 [-]: SELF      R13 R11 K36  ; R14 := R11; R13 := R11["0xABD9DD93"]
 94 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 95 [-]: GETGLOBAL R14 K10      ; R14 := 0x400E7765
 96 [-]: MOVE      R15 R13      ; R15 := R13
 97 [-]: CALL      R14 2 2      ; R14 := R14(R15)
 98 [-]: TEST      R14 1        ; if R14 then PC := 102
 99 [-]: JMP       102          ; PC := 102
100 [-]: SELF      R14 R13 K37  ; R15 := R13; R14 := R13["0x91ACEF1D"]
101 [-]: CALL      R14 2 1      ; R14(R15)
102 [-]: GETUPVAL  R14 U2       ; R14 := U2
103 [-]: GETTABLE  R14 R14 K38  ; R14 := R14["0x1B227288"]
104 [-]: MOVE      R15 R0       ; R15 := R0
105 [-]: MOVE      R16 R11      ; R16 := R11
106 [-]: CALL      R14 3 1      ; R14(R15,R16)
107 [-]: GETGLOBAL R14 K39      ; R14 := 0x201191EA
108 [-]: LOADK     R15 K8       ; R15 := 0
109 [-]: CALL      R14 2 1      ; R14(R15)
110 [-]: FORLOOP   R6 41        ; R6 += R8; if R6 <= R7 then begin PC := 41; R9 := R6 end
