...
; Command line was: -dis C:\war2\raw\Lotus\Types\Enemies\AdvancedSpawners\AmalgamSpawnScript.lua 
...
; Max Stack Size:  34
  ...
  9 [-]: LOADK     R4 K5        ; R4 := "SurvivalMissionState"
...
; Max Stack Size:  19
 ...
 27 [-]: MOVE      R7 R8        ; R7 := R8
 28 [-]: LOADK     R8 K1        ; R8 := 0
 29 [-]: EQ        1 R8 K10     ; if R8 == 3 then PC := 40
 30 [-]: JMP       40           ; PC := 40
