...
; Command line was: -dis C:\war2\raw\Lotus\Types\Enemies\TennoReplicants\ReplicantEquipLoadout.lua 
...
; Max Stack Size:  8
 ...
 12 [-]: JMP       33           ; PC := 33
 13 [-]: SELF      R3 R2 K4     ; R4 := R2; R3 := R2["0xABD9DD93"]
 ...
 19 [-]: JMP       33           ; PC := 33
 20 [-]: SELF      R4 R3 K5     ; R5 := R3; R4 := R3["0x62D1FAB5"]
 21 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 22 [-]: TEST      R4 1         ; if R4 then PC := 29
 23 [-]: JMP       29           ; PC := 29
 24 [-]: SELF      R4 R3 K6     ; R5 := R3; R4 := R3["0x67C3BBD0"]
 25 [-]: GETGLOBAL R6 K7        ; R6 := stationaryBehavior
 26 [-]: MOVE      R7 R0        ; R7 := R0
 27 [-]: CALL      R4 4 1       ; R4(R5,R6,R7)
 28 [-]: JMP       33           ; PC := 33
 29 [-]: SELF      R4 R3 K8     ; R5 := R3; R4 := R3["0x91ACEF1D"]
 30 [-]: CALL      R4 2 1       ; R4(R5)
 31 [-]: SELF      R4 R3 K9     ; R5 := R3; R4 := R3["0x750771BC"]
 32 [-]: CALL      R4 2 1       ; R4(R5)
 33 [-]: GETGLOBAL R4 K0        ; R4 := gRegion
 34 [-]: SELF      R4 R4 K10    ; R5 := R4; R4 := R4["0x3E2F6BF"]
 35 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 36 [-]: EQ        0 R1 R4      ; if R1 ~= R4 then PC := 40
 37 [-]: JMP       40           ; PC := 40
 38 [-]: SELF      R5 R0 K11    ; R6 := R0; R5 := R0["0xAC27D7BA"]
 39 [-]: CALL      R5 2 1       ; R5(R6)
 40 [-]: GETGLOBAL R5 K0        ; R5 := gRegion
 41 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5["0xA559F558"]
 42 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 43 [-]: TEST      R5 0         ; if not R5 then PC := 54
 44 [-]: JMP       54           ; PC := 54
 45 [-]: SELF      R5 R0 K12    ; R6 := R0; R5 := R0["0x8D5886B7"]
 46 [-]: LOADK     R7 K13       ; R7 := "Disable"
 47 [-]: CALL      R5 3 1       ; R5(R6,R7)
 48 [-]: GETGLOBAL R5 K14       ; R5 := 0x201191EA
 49 [-]: LOADK     R6 K15       ; R6 := 2
 50 [-]: CALL      R5 2 1       ; R5(R6)
 51 [-]: SELF      R5 R0 K12    ; R6 := R0; R5 := R0["0x8D5886B7"]
 52 [-]: LOADK     R7 K16       ; R7 := "Enable"
